		...
		<BaseLayout previewText={previewText}>
			...
			<Card style={securityCard}>
				...
				<Text style={securityText}>
					If you didn't change your password, someone may have unauthorized access to your account. Please take the
			...
			<Text style={footerNote}>
				This is an automated security notification. If you made this change, you can safely ignore this email.
			</Text>
		</BaseLayout>
	);
}

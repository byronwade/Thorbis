	...
	return (
		<BaseLayout previewText={previewText}>
			...
			<Text style={paragraph}>
				Great news! You now have access to your {companyName} customer portal - a convenient online hub where you can
				manage your services, view invoices, and communicate with us anytime.
			</Text>
			...
			<Card style={invitationCard}>
				...
				<Text style={invitationText}>
					Click the button below to set up your account and access all your service information in one place.
				</Text>
			</Card>
			...
			<Card style={expiryCard}>
				<Text style={expiryText}>
					⏰ This invitation link will expire in <strong>{expiresInHours} hours</strong>. Please complete your account
					setup soon.
				</Text>
			</Card>
			...
			<Card style={featuresCard}>
				...
				<ul style={featuresList}>
					<li style={featureItem}>
						<strong>📅 View & Schedule Services:</strong> Book appointments and track upcoming service visits
					</li>
					<li style={featureItem}>
						<strong>📄 Manage Invoices:</strong> View billing history and pay invoices online securely
					</li>
					<li style={featureItem}>
			...
			<Card style={securityCard}>
				...
				<Text style={securityText}>
					Your portal is protected with industry-standard security. Only you can access your account information, and
			...
			<Card style={helpCard}>
				...
				<Text style={helpText}>
					If you have any questions about setting up your portal or need assistance, our support team is here to help.
				</Text>
			...
			<Text style={footerNote}>
				<strong>Note:</strong> If you didn't request portal access or believe you received this email in error, please
				contact us at{" "}

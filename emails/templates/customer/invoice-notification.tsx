			...
			{customBody ? (
				...
				<>
					...
					<Text style={paragraph}>
						We've prepared invoice <strong>#{invoiceNumber}</strong> for you. Please review the details below and click
						the button to view or pay online.
					</Text>
				</>
			)}
			...
			{customFooter ? (
				...
				<Card style={footerCard}>
					...
					<Text style={footerText}>
						If you have any questions about this invoice, reply to this email or contact our support team. We're happy
						to help!
					</Text>
				</Card>
			)}

	...
	return (
		<BaseLayout previewText={previewText}>
			...
			<Text style={paragraph}>
				We've prepared estimate <strong>#{estimateNumber}</strong> for you. Review the summary below and click the
				button to see the full details.
			</Text>
			...
			<Card style={footerCard}>
				...
				<Text style={footerText}>
					If you have any questions about this estimate, reply to this email or contact our support team. We're happy to
					help!
				</Text>
			</Card>
		</BaseLayout>

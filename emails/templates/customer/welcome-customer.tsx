	...
	return (
		<BaseLayout previewText={previewText}>
			...
			<Text style={paragraph}>
				Thank you for choosing Thorbis for your service needs! We're thrilled to have you as a
				customer and look forward to providing you with excellent service.
			</Text>
			...
			<Text style={thankYouText}>
				Once again, welcome to Thorbis! We're committed to providing you with exceptional service

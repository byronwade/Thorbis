	...
	return (
		<BaseLayout previewText={previewText}>
			...
			<Text style={paragraph}>
				We wanted to remind you that payment for the following invoice is now overdue. We understand that sometimes
				invoices can slip through the cracks, so we're sending this friendly reminder.
			</Text>
			...
			<Card style={helpCard}>
				...
				<Text style={helpText}>
					If you're experiencing financial difficulties or have questions about this invoice, please don't hesitate to
					reach out. We're here to work with you.
				</Text>

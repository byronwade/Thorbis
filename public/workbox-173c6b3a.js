define(["exports"], (t) => {
  ...
  class a {
    ...
    handleRequest({ request: t, event: e }) {
      ...
      let a = i?.handler;
      const o = t.method;
      if ((!a && this.i.has(o) && (a = this.i.get(o)), !a)) {
        return;
      }
      let c;
      try {
      ...
      return (
        c instanceof Promise &&
          ...
          (c = c.catch(async (n) => {
            ...
            if (this.o) {
              return this.o.handle({ url: s, request: t, event: e });
            }
            throw n;
          })),
        c
        ...
        if (a) {
          return (
            ...
            ((Array.isArray(r) && r.length === 0) ||
              (a.constructor === Object && Object.keys(a).length === 0) ||
              typeof a === "boolean") &&
              (r = void 0),
            { route: i, params: r }
          );
  ...
  class v {
    ...
    async fetch(t) {
      ...
      try {
        ...
        t = await fetch(
          n,
          n.mode === "navigate" ? void 0 : this.u.fetchOptions
        );
    ...
    async cachePut(t, e) {
      ...
      try {
        ...
        if (t instanceof Error) {
          throwt.name === "QuotaExceededError" &&
            (await (async () => {
              for (const t of m) {
                await t();
              }
  ...
  class b {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        s = typeof t.request === "string" ? new Request(t.request) : t.request,
  ...
  let k = {
    ...
    set: (t, e, s) => ((t[e] = s), !0),
    has: (t, e) =>
      (t instanceof IDBTransaction && (e === "done" || e === "store")) ||
      e in t,
  };
  function O(t) {
    return t !== IDBDatabase.prototype.transaction ||
      ...
      ? (
        ...
        ? function (...e) {
            return t.apply(P(this), e), T(E.get(this));
          }
        : function (...e) {
            return T(t.apply(P(this), e));
          }
      : function (e, ...s) {
          const n = t.call(P(this), e, ...s);
          return L.set(n, e.sort ? e.sort() : [e]), T(n);
        };
  }
  function B(t) {
    returntypeof;
  ...
  function T(t) {
    ...
    const e = B(t);
    return e !== t && (C.set(t, e), N.set(e, t)), e;
  }
  const P = (t) => N.get(t);
  ...
  function S(t, e) {
    ...
    const s = e.replace(/FromIndex$/, ""),
      ...
      r = W.includes(s);
    if (
      !(s in (n ? IDBIndex : IDBObjectStore).prototype && (r || M.includes(s)))
    ) {
      return;
    }
  ...
  class F {
    ...
    async expireEntries(t, e) {
      ...
      const a = [];
      for (const t of r) {
        await s.delete(K, t.id), a.push(t.url);
      }
      return a;
    }
    N(t) {
  ...
  class $ {
    ...
    async expireEntries() {
      ...
      for (const t of e) {
        await s.delete(t, this.P);
      }
      (this.k = !1), this.O && ((this.O = !1), q(this.expireEntries()));
    }
    ...
    async delete() {
      (this.O = !1), await this.M.expireEntries(1 / 0);
    }
  }
  function H(t, e) {
    const s = e();
  ...
  class J {
    constructor({ precacheController: t }) {
      (this.cacheKeyWillBeUsed = async ({ request: t, params: e }) => {
        const s =
          (e == null ? void 0 : e.cacheKey) || this.W.getCacheKeyForURL(t.url);
    ...
    async K(t, e) {
      ...
      }
      {
        const s = r.integrity,
          ...
          a = !i || i === s;
        (n = await e.fetch(
          new Request(t, { integrity: t.mode !== "no-cors" ? i || s : void 0 })
        )),
          s &&
            a &&
            t.mode !== "no-cors" &&
  ...
  class Z {
    ...
    addToCacheList(t) {
      ...
      for (const n of t) {
        ...
        if ((this.F.set(r, t), this.$.set(r, i), e.length > 0)) {
  ...
  (t.CacheFirst = class extends b {
    async U(t, e) {
      ...
      if (!r) {
        throw new s("no-response", { url: t.url, error: n });
      }
      return r;
    }
  }),
    (t.ExpirationPlugin = class {
      ...
      J(t) {
        ...
        let e = this.Y.get(t);
        return e || ((e = new $(t, this.X)), this.Y.set(t, e)), e;
      }
      V(t) {
        if (!this.T) {
          return !0;
    ...
    (t.NetworkOnly = class extends b {
      constructor(t = {}) {
        super(t), (this.tt = t.networkTimeoutSeconds || 0);
      }
      async U(t, e) {
        let n, r;
        try {
          const s = [e.fetch(t)];
          if (this.tt) {
            const t = g(1e3 * this.tt);
            s.push(t);
          }
          if (((r = await Promise.race(s)), !r)) {
            throw new Error(
              `Timed out the network response after ${this.tt} seconds.`
            );
          }
        } catch (t) {
          t instanceof Error && (n = t);
    ...
    (t.StaleWhileRevalidate = class extends b {
      ...
      async U(t, e) {
        ...
        if (!i) {
          throw new s("no-response", { url: t.url, error: r });
        }
        return i;
      }
    }),

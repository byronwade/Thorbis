			...
			<div className="relative">
				...
				{isOnHold && (
					<div className="bg-warning/10 border-warning/30 flex items-center justify-center gap-2 border-b px-4 py-2">
						...
						<Badge
							variant="outline"
							className="text-warning border-warning/50 font-mono text-xs"
						>
							{formatTimerDuration(holdDuration)}
						</Badge>
						<span className="text-warning/70 text-xs">Press H to resume</span>
					</div>
				)}
				...
				<div className="bg-card/50 flex items-center justify-between px-6 py-3 backdrop-blur-sm">
					...
					<div className="flex items-center justify-center gap-2">
						...
						<Tooltip>
							...
							<TooltipContent side="bottom">
								<p>
									{videoStatus === "connected" ? "End Video" : "Start Video"}
								</p>
							</TooltipContent>
						</Tooltip>

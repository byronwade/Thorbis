	...
	return (
		<div className="space-y-6">
			...
			{estimatedCompletionDate &&
				...
				status !== "rejected" && (
					<div className="rounded-lg bg-blue-500/10 p-4 space-y-2">
						...
						<p className="text-xs text-muted-foreground">
							Verification typically takes 3-7 business days. Complex cases may
							take longer.
						</p>
					</div>
				)}
			...
			{(status === "pending" || status === "in_review") && (
				<div className="rounded-lg bg-blue-500/10 p-4 space-y-3">
					...
					<div className="space-y-2 text-sm text-muted-foreground">
						<p>
							<strong className="text-foreground">Business identity:</strong>{" "}
							Legal name, address, tax ID
						</p>
						<p>
							<strong className="text-foreground">Ownership:</strong> Beneficial
							owners and control persons
						</p>
						<p>
							<strong className="text-foreground">Banking:</strong> Account
				...
				<div className="space-y-3">
					...
					<div className="space-y-3 text-sm text-muted-foreground">
						<div className="flex items-start gap-3">
							...
							<p>
								Adyen's compliance team is reviewing your business information
								and documentation
							</p>
						</div>
						<div className="flex items-start gap-3">
							...
							<p>
								They may request additional documents if needed. You'll receive
					...
					<div className="flex items-start gap-3">
						...
						<div>
							...
							<ul className="text-sm text-muted-foreground mt-2 space-y-1 list-disc ml-4">
								...
								<li>
									International businesses may require additional verification
								</li>
			...
			<div className="rounded-lg border border-muted p-4 space-y-2">
				...
				<p className="text-xs text-muted-foreground">
					Know Your Customer (KYC) verification is required by financial
					regulations to prevent fraud and money laundering. All payment
					processors require this for merchant accounts. Your information is
					securely encrypted and only used for verification purposes.
				</p>

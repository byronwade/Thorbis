			...
			: [
					{
						...
						sender: "No recent communications",
						subject: "Start sending messages to see them here",
						time: "",
						status: "info",
					},
				];
	...
	return (
		<div className="bg-card/50 border-border/50 backdrop-blur-sm rounded-xl border overflow-hidden">
			<div className="p-6 border-b border-border/50 flex items-center justify-between">
				...
				<Badge
					variant="secondary"
					className="bg-purple-500/10 text-purple-500 hover:bg-purple-500/20 border-0"
				>
						...
						>
							...
							<div className="text-right">
								{comm.status && comm.status !== "info" && (
									<Badge
										variant="outline"
										className="text-[10px] h-5 px-1.5 uppercase tracking-wider mb-1"
									>
										{comm.status}
									</Badge>
								)}
	...
	const displayThreads =
		threads.length > 0
			...
			: [
					{
						id: "1",
						customer: "No active threads",
						lastMessage: "Start conversations to see them here",
						time: "",
						unread: 0,
					},
				];
	...
	return (
		<div className="bg-card/50 border-border/50 backdrop-blur-sm rounded-xl border overflow-hidden">
			<div className="p-6 border-b border-border/50 flex items-center justify-between">
				...
				<Badge
					variant="secondary"
					className="bg-pink-500/10 text-pink-500 hover:bg-pink-500/20 border-0"
				>

...
const permissionModeLabels: Record<
	PermissionMode,
	...
	async function loadSettings() {
		...
		if (data) {
			setSettings({
				...
				...data,
				action_permissions:
					data.action_permissions || defaultSettings.action_permissions,
			});
		}
	...
	return (
		<div className="space-y-6 p-6 max-w-4xl">
			...
			<Alert>
				...
				<AlertDescription>
					The AI assistant can help manage customers, schedule appointments,
					send communications, and provide business insights. Configure
					permissions below to control what actions it can take.
				</AlertDescription>
			</Alert>
					...
					<Card>
						...
						<CardContent className="space-y-4">
							<div className="grid gap-3">
								{(
									Object.entries(permissionModeLabels) as [
										PermissionMode,
										(typeof permissionModeLabels)[PermissionMode],
									][]
								).map(([mode, info]) => (
									<div
										key={mode}
								...
								{[
									{
										...
										label: "Communication",
										icon: MessageSquare,
										desc: "Emails, SMS, calls to customers",
									},
									{
										key: "team",
										label: "Team Communication",
										icon: Building2,
										desc: "Emails, SMS to team members",
									},
									{
										key: "vendor",
										label: "Vendor Communication",
										icon: Truck,
										desc: "Emails, SMS to vendors",
									},
									{
										key: "financial",
										label: "Financial",
										icon: DollarSign,
										desc: "Invoices, payments, funds",
									},
									{
										key: "scheduling",
										label: "Scheduling",
										icon: Calendar,
										desc: "Appointments, jobs",
									},
									{
										key: "notification",
										label: "Reminders & Notifications",
										icon: Bell,
										desc: "Schedule and send reminders",
									},
									{
										key: "customer",
										label: "Customer Management",
										icon: Users,
										desc: "Create, update customers",
									},
									{
										key: "property",
									...
									},
									{
										...
										icon: Wrench,
										desc: "Search equipment, maintenance",
									},
									{
										key: "reporting",
										label: "Reporting",
										icon: BarChart3,
										desc: "Analytics, insights, reports",
									},
								].map((cat) => (
									<div
										key={cat.key}
									...
									>
										...
										<Select
											value={
												settings.action_permissions[cat.key] ||
												settings.permission_mode
											}
											onValueChange={(value) =>
												updateActionPermission(cat.key, value as PermissionMode)
											}
										>
											...
											<SelectContent>
												...
												<SelectItem value="ask_permission">
													Ask Permission
												</SelectItem>
						...
						<CardContent className="space-y-4">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(v) =>
										updateSetting("can_create_invoices", v)
									}
								/>
							</div>
							<Separator />
						...
						<CardContent className="space-y-4">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(v) =>
										updateSetting("can_create_appointments", v)
									}
								/>
							</div>
							<Separator />
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(v) =>
										updateSetting("can_schedule_reminders", v)
									}
								/>
							</div>
						</CardContent>
						...
						<CardContent className="space-y-4">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(v) =>
										updateSetting("can_create_customers", v)
									}
								/>
							</div>
							<Separator />
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(v) =>
										updateSetting("can_update_customers", v)
									}
								/>
							</div>
						</CardContent>
						...
						<CardContent className="space-y-4">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(v) =>
										updateSetting("can_access_detailed_reports", v)
									}
								/>
							</div>
							<Separator />
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(v) =>
										updateSetting("can_access_properties", v)
									}
								/>
							</div>
							<Separator />
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(v) =>
										updateSetting("can_access_equipment", v)
									}
								/>
							</div>
						</CardContent>
						...
						<CardContent className="space-y-4">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(v) =>
										updateSetting("proactive_customer_outreach", v)
									}
								/>
							</div>
							<Separator />
							<div className="flex items-center justify-between">
								<div className="space-y-0.5">
									...
									<p className="text-sm text-muted-foreground">
										Alert on overdue invoices, suggest collections, budget
										advice
									</p>
								</div>
								<Switch
									...
									onCheckedChange={(v) =>
										updateSetting("proactive_financial_advice", v)
									}
								/>
							</div>
							<Separator />
							<div className="flex items-center justify-between">
								<div className="space-y-0.5">
									...
									<p className="text-sm text-muted-foreground">
										Optimize routes, suggest appointment times, prevent
										conflicts
									</p>
								</div>
								<Switch
									...
									onCheckedChange={(v) =>
										updateSetting("proactive_scheduling_suggestions", v)
									}
								/>
							</div>
						</CardContent>
								...
								<>
									...
									<div className="space-y-2">
										...
										<Input
											...
											onChange={(e) =>
												updateSetting("notification_sms", e.target.value)
											}
										/>
									</div>
								</>
				...
				<TabsContent value="advanced" className="space-y-6">
					<Card>
						...
						<CardContent className="space-y-4">
							...
							<div className="space-y-2">
								<Label>
									Temperature (Creativity): {settings.model_temperature}
								</Label>
								<input
									type="range"
									min="0"
									...
									onChange={(e) =>
										updateSetting("model_temperature", Number(e.target.value))
									}
								/>
						...
						<CardContent className="space-y-4">
							<div className="space-y-2">
								...
								<Textarea
									...
									onChange={(e) =>
										updateSetting("company_context", e.target.value)
									}
								/>
							</div>
							<div className="space-y-2">
								...
								<Textarea
									...
									onChange={(e) =>
										updateSetting("custom_system_prompt", e.target.value)
									}
								/>
							</div>
						</CardContent>
							...
							<div className="grid gap-4 sm:grid-cols-2">
								<div className="space-y-2">
									...
									<Input
										...
										onChange={(e) =>
											updateSetting("active_hours_start", e.target.value)
										}
									/>
								</div>
								<div className="space-y-2">
									...
									<Input
										...
										onChange={(e) =>
											updateSetting("active_hours_end", e.target.value)
										}
									/>
								</div>
							</div>

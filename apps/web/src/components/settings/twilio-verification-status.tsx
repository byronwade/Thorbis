...
import { checkTwilioVerificationStatus } from "@/actions/ten-dlc-registration";
...
export function TwilioVerificationStatus() {
	...
	const fetchStatus = async () => {
		try {
			setError(null);
			const result = await checkTwilioVerificationStatus();

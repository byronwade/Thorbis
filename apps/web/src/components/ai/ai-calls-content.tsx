...
const DEMO_CALLS: AICall[] = [
	{
		...
		duration: 245,
		summary:
			"Customer inquired about service pricing. AI provided quotes and scheduled a follow-up appointment.",
		sentiment: "positive",
		actionsTaken: [
	...
	},
	{
		...
		duration: 180,
		summary:
			"Reminder call for scheduled maintenance. Customer confirmed appointment.",
		sentiment: "positive",
					...
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<CardDescription>
									Automatically handles inbound and outbound calls
								</CardDescription>
							</div>
						</div>
						<div className="flex items-center gap-3">
				...
				<div className="divide-y overflow-auto h-full">
					{calls.length === 0 ? (
						<div className="flex flex-col items-center justify-center h-40 text-muted-foreground">
							...
							<p className="text-xs">
								Calls will appear here when AI handles them
							</p>
						</div>
					) : (
						calls.map((call) => {
							...
							const TypeIcon =
								call.type === "inbound" ? PhoneIncoming : PhoneOutgoing;
									...
									<div className="flex-1 min-w-0">
										...
										{call.scheduledFor && (
											<div className="flex items-center gap-1 mt-2 text-xs text-purple-500">
												...
												Scheduled for{" "}
												{formatDistanceToNow(new Date(call.scheduledFor), {
													addSuffix: true,
												})}
											</div>
										)}

...
// Import chart components directly from recharts for proper tree-shaking
import {
	Area,
	Bar,
	CartesianGrid,
...
import { LazyAreaChart, LazyBarChart } from "@/components/ui/lazy-chart";
...
export function CommunicationOverviewReport({
	stats,
}: CommunicationOverviewReportProps) {
								...
								>
									<LazyBarChart
										data={[
											{
												name: "Email",
												value: Math.round(stats.avgEmailResponseTime),
											},
											{
												name: "SMS",
												value: Math.round(stats.avgSmsResponseTime),
											},
										]}
										margin={{ top: 5, right: 5, left: 0, bottom: 0 }}
									>

...
import { FileText, Loader2, Paperclip, Pin } from "lucide-react";
...
import { PinBoardFileUpload, type UploadedFile } from "./pin-board-file-upload";
...
export function PinBoardEditorDialog({
	...
	const successfulFilesCount = files.filter(
		(f) => f.status === "success",
	).length;
							...
							<div className="space-y-4">
								<div>
									...
									<p className="text-sm text-muted-foreground mb-4">
										Add PDFs, images, Word documents, or spreadsheets to this
										post. Files will be viewable and downloadable by all team
										members.
									</p>
								</div>

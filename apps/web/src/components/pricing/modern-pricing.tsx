...
const TESTIMONIALS = [
	{
		quote:
			"Switched from ServiceTitan and we're saving over $1,400 every month. Same features, fraction of the cost.",
		author: "Mike Johnson",
		role: "Owner",
	...
	{
		quote:
			"The pay-as-you-go model is perfect for our seasonal business. We're not locked into expensive contracts during slow months.",
		author: "Sarah Chen",
	...
	{
		quote:
			"We added 12 new techs last year and didn't pay a penny more in seat fees. That's $15,000+ saved annually.",
...
export function ModernPricing() {
	...
	const thorbisEstimate =
		200 + calculateTeamCost(TEAM_SIZE_EXAMPLES[1].expectedUsage);
							...
							<div className="space-y-6">
								<div className="space-y-2">
									<Label htmlFor="current-cost">
										What do you currently pay per month for field service
										software?
									</Label>
										...
										<div className="text-center">
											{breakEvenSavings > 0 ? (
												...
												<div className="text-muted-foreground">
													At ${breakEvenData.currentMonthlyCost}/month, you're
													already paying less than our typical estimate. Let's
													chat to see if Thorbis can still save you money with
													better features.
												</div>
											)}
										</div>
								...
								<div className="text-center">
									<Button asChild size="lg" className="w-full sm:w-auto">
										<Link href="/waitlist">Start Saving Today</Link>
									</Button>

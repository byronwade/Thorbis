...
import type { AnalyticsTrendData, DailyMetric } from "@/lib/queries/analytics";
	...
	const renderChart = () => {
		...
		return (
			<LineChart {...commonProps}>
				...
				<XAxis {...xAxisProps} />
				<YAxis {...yAxisProps} />
				<Tooltip content={<CustomTooltip valuePrefix={config.valuePrefix} />} />
				{selectedMetric === "communications" ? (
					<>
						<Line
							type="monotone"
			...
			<CardContent className="px-3 md:px-6">
				...
				<div className="mb-4 md:mb-6 grid grid-cols-3 gap-3 md:gap-6">
					<div className="text-center md:text-left">
						<p className="text-[0.65rem] md:text-sm text-muted-foreground uppercase tracking-wide font-medium">
							Total
						</p>

...
import { Briefcase, CheckCircle, Clock, TrendingUp, Users } from "lucide-react";
		...
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">
						Completion rates, technician performance, and job analysis
					</p>
				</div>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Distribution of jobs across different statuses
					</CardDescription>
				</CardHeader>
				<CardContent>
									...
									{data.byJobType.slice(0, 10).map((type) => (
										<TableRow key={type.jobType}>
											...
											<TableCell className="text-right">
												<Badge
													variant={
														type.completionRate >= 90 ? "default" : "secondary"
													}
												>

		...
		return (
			<Card className="max-w-2xl mx-auto p-8">
				<div className="text-center space-y-4">
					...
					<p className="text-sm text-muted-foreground">Error: {result.error}</p>
				</div>
			</Card>
		);
	}
				...
				<div className="space-y-3 text-sm text-muted-foreground bg-muted/40 rounded-lg p-4">
					...
					<ul className="space-y-2 text-left list-none">
						<li className="flex items-start gap-2">
							...
							<span>Your payment method is saved securely with Stripe</span>
						</li>
						<li className="flex items-start gap-2">
							<CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
							<span>You have 14 days to explore all features at no charge</span>
						</li>
						<li className="flex items-start gap-2">
							<CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
							<span>

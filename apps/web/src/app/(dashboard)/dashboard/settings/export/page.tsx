...
export const metadata = {
	...
	description: "Export your business data to various formats",
};
...
export default async function ExportPage() {
				...
				<div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
					<div className="text-center space-y-2">
						...
						<p className="text-muted-foreground">
							You need to be part of a company to use the export system.
						</p>
	...
	return (
		<Suspense fallback={<ExportPageSkeleton />}>
			<ExportPageContent companyId={membership.company_id} userId={user.id} />
		</Suspense>
	);
}

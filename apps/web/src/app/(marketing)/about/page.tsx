			...
			<div className="container mx-auto space-y-20 px-4 py-16 sm:px-6 lg:px-8">
					...
					<div className="grid gap-12 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)]">
						<div className="space-y-6">
							...
							<p className="text-muted-foreground text-lg leading-relaxed sm:text-xl">
								...
								call to final invoice, we use AI and automation to remove
								friction and let people focus on what matters—delighting
								customers.
							</p>
				...
				<section className="space-y-8">
					<div className="text-center max-w-3xl mx-auto">
						...
						<p className="text-muted-foreground mt-4 text-lg">
							From founding to today, we've been on a mission to transform how
							...
							return (
								...
								>
									<div className="flex items-center gap-4 mb-4">
										<div
											className={`flex size-12 items-center justify-center rounded-xl ${bgColors[index]}`}
										>
											<Icon className={`size-6 ${textColors[index]}`} />
										</div>
										<div>
											<p
												className={`text-sm font-bold uppercase ${textColors[index]}`}
											>
												{entry.year}
											</p>
				...
				<section className="space-y-8">
					<div className="text-center max-w-3xl mx-auto">
						...
						<p className="text-muted-foreground mt-4 text-lg">
							We're a team of operators, engineers, and customer advocates
							who've spent our careers building software for service businesses.
							We know the pain of missed calls, scheduling chaos, and late
							payments—because we've lived it.
						</p>
					</div>
				...
				<section className="relative overflow-hidden rounded-3xl border-2 bg-gradient-to-br from-primary/10 via-background to-primary/5 p-10 text-center">
					...
					<div className="relative space-y-6 max-w-3xl mx-auto">
						...
						<p className="text-muted-foreground text-lg">
							...
							across North America. We're always looking for passionate people
							who want to help service businesses thrive.
						</p>

...
const KPI_TARGETS = [
	{
		metric: "Go-live readiness",
		value: "30 days",
		description: "Checklist completed",
	},
	{
		metric: "Dispatch adoption",
		value: ">90%",
		description: "Within first week",
	},
	{
		metric: "AI assistant",
		value: "40%",
		description: "Handling calls by week six",
	},
	{
		metric: "Portal activation",
		value: ">60%",
		description: "After training campaign",
	},
];
			...
			<div className="container mx-auto space-y-20 px-4 py-16 sm:px-6 lg:px-8">
				...
				<section className="relative overflow-hidden rounded-3xl border bg-gradient-to-br from-cyan-600/20 via-background to-teal-500/5 p-8 sm:p-12 lg:p-16">
					...
					<div className="mx-auto max-w-3xl space-y-6 text-center">
						...
						<p className="text-muted-foreground text-lg leading-relaxed sm:text-xl">
							Dedicated migration engineers, AI strategists, and customer
							success coaches guide your team from day-one planning to long-term
								...
								>
									<CardHeader className="space-y-3">
										<div className="flex items-center gap-3">
											<div
												className={`flex size-12 items-center justify-center rounded-xl ${phase.iconBg}`}
											>
									...
									<CardContent>
										<ul className="space-y-2">
											{phase.bullets.map((bullet) => (
												...
												>
													<CheckCircle
														className={`size-4 shrink-0 mt-0.5 ${phase.iconColor}`}
													/>
				...
				<section className="space-y-8">
					<div className="text-center max-w-3xl mx-auto">
						...
						<p className="text-muted-foreground mt-4 text-lg">
							Technicians, dispatchers, finance, and leadership receive tailored
							instruction through live sessions and on-demand content.
						</p>
					</div>
						...
						{RESOURCES.map((resource) => {
							...
							return (
								...
								>
									<CardHeader className="space-y-3">
										<div
											className={`flex size-12 items-center justify-center rounded-xl ${resource.iconBg}`}
										>
								...
								>
									<CardHeader>
										<div className="flex items-center justify-between mb-3">
											<div
												className={`flex size-12 items-center justify-center rounded-xl ${pkg.iconBg}`}
											>
									...
									<CardContent className="flex flex-1 flex-col justify-between space-y-4">
										...
										<div className="space-y-2 pt-4 border-t border-border/50">
											{pkg.features.map((feature) => (
												...
												>
													<CheckCircle
														className={`size-4 shrink-0 mt-0.5 ${pkg.iconColor}`}
													/>
													<span className="text-muted-foreground">
														{feature}
													</span>
					...
					<Card className="relative overflow-hidden border-2 bg-gradient-to-br from-cyan-500/10 to-teal-500/10 border-cyan-500/30">
						...
						<CardContent className="flex h-full flex-col justify-center space-y-6 p-8">
							...
							<p className="text-2xl font-semibold leading-relaxed">
								"Thorbis migrated our multi-branch ServiceTitan deployment in 42
								days. Dispatchers were live day one, and AI booking added 11%
								more jobs in the first month."
							</p>

...
const PARTNER_BENEFITS = [
	{
		...
		description:
			"Build deep, reliable connections with comprehensive documentation.",
		icon: Code2,
	},
	{
		title: "Sandbox environment",
		description:
			"Test your integrations in a dedicated development environment.",
		icon: Bot,
	},
	{
			...
			<div className="container mx-auto space-y-20 px-4 py-16 sm:px-6 lg:px-8">
				...
				<section className="space-y-8">
					<div className="text-center max-w-3xl mx-auto">
						...
						<p className="text-muted-foreground mt-4 text-lg">
							Multiple paths to grow with Thorbis and deliver value to
							contractors.
						</p>
					</div>
						...
						{PARTNER_TYPES.map((partner) => {
							...
							return (
								...
								>
									<CardHeader>
										<div
											className={`flex size-12 items-center justify-center rounded-xl mb-3 ${partner.iconBg}`}
										>
									...
									<CardContent className="space-y-4">
										...
										<div className="pt-4 border-t border-border/50 space-y-2">
											{partner.benefits.map((benefit) => (
												...
												>
													<div
														className={`size-1.5 rounded-full ${partner.iconBg.replace("/10", "")}`}
													/>
				...
				<section className="space-y-8">
					<div className="text-center max-w-3xl mx-auto">
						...
						<p className="text-muted-foreground mt-4 text-lg">
							Thorbis integrates with the systems contractors depend on. Our
							open APIs and SDKs let you build deep, reliable connections.
						</p>
					</div>
				...
				<section className="relative overflow-hidden rounded-3xl border-2 bg-gradient-to-br from-primary/10 via-background to-primary/5 p-10 text-center">
					...
					<div className="relative space-y-6 max-w-3xl mx-auto">
						...
						<div className="flex flex-wrap justify-center gap-3">
							...
							<Button asChild size="lg" variant="outline">
								<a href="mailto:partners@thorbis.com">Contact partner team</a>
							</Button>
						</div>
					</div>
				</section>

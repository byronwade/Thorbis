				...
				<section className="relative overflow-hidden rounded-3xl border bg-gradient-to-br from-sky-600/20 via-background to-sky-500/5 p-8 sm:p-12 lg:p-16">
					...
					<div className="mx-auto max-w-3xl space-y-6 text-center">
						...
						<p className="text-muted-foreground text-lg leading-relaxed sm:text-xl">
							Whether you're exploring Thorbis, need support, or want to
							partner, our team responds quickly. Pricing stays
							simple—$200/month base subscription with pay-as-you-go usage,
							unlimited users, no contracts, no lock-in. Choose the option that
							fits and we'll get back within one business day.
						</p>
								...
								>
									<CardHeader>
										<div className="flex items-center gap-4 mb-2">
											<div
												className={`flex size-12 items-center justify-center rounded-xl ${option.iconBg}`}
											>
				...
				<section className="relative overflow-hidden rounded-3xl border-2 bg-gradient-to-br from-primary/10 via-background to-primary/5 p-10">
					...
					<div className="relative space-y-6 max-w-4xl mx-auto">
						...
						<p className="text-muted-foreground text-center text-lg leading-relaxed">
							Thorbis operates remotely with hubs across North America. All
							visits are by appointment—reach out to coordinate an onsite
							workshop.
						</p>

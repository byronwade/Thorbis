				...
				<div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
					...
					<header className="mx-auto mb-16 max-w-4xl text-center">
						...
						<p className="text-muted-foreground mx-auto mb-8 max-w-2xl text-lg leading-relaxed">
							...
							workflows, automations, and reporting. Every industry gets the
							same transparent pricing—$200/month base plus pay-as-you-go usage.
						</p>
					...
					<section className="from-primary/10 via-primary/5 to-primary/10 rounded-2xl border bg-gradient-to-r p-10 text-center">
						...
						<p className="text-muted-foreground mx-auto mb-6 max-w-2xl text-lg">
							No matter your industry, Thorbis delivers the tools, automations,
							and insights you need to grow. $200/month base with unlimited
							users.
						</p>
						<div className="flex flex-wrap justify-center gap-4">

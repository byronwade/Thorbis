 ...
 */
const getJobAppointments = cache(async (jobId: string, companyId: string) => {
	const supabase = await createClient();
 ...
 */
const getJobInvoices = cache(async (jobId: string, companyId: string) => {
	const supabase = await createClient();
	if (!supabase) return { data: null, error: new Error("No supabase client") };
 ...
 */
const getJobEstimates = cache(async (jobId: string, companyId: string) => {
	const supabase = await createClient();
	if (!supabase) return { data: null, error: new Error("No supabase client") };
 ...
 */
const getJobPayments = cache(async (jobId: string, companyId: string) => {
	const supabase = await createClient();
	if (!supabase) return { data: null, error: new Error("No supabase client") };
 ...
 */
const getJobPurchaseOrders = cache(async (jobId: string, companyId: string) => {
	const supabase = await createClient();
	if (!supabase) return { data: null, error: new Error("No supabase client") };
 ...
 */
const getJobActivityLog = cache(async (jobId: string, companyId: string) => {
	const supabase = await createClient();
	if (!supabase) return { data: null, error: new Error("No supabase client") };

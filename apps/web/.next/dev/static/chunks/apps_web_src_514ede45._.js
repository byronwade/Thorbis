        ...
        "JobCard.useCallback[handleDispatch]": (e)=>{
            ...
            startTransition({
                "JobCard.useCallback[handleDispatch]": async ()=>{
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$actions$2f$data$3a$61a93e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["dispatchAppointment"])(job.jobId);
                    if (result.success) {
        ...
        "JobCard.useCallback[handleArrive]": (e)=>{
            ...
            startTransition({
                "JobCard.useCallback[handleArrive]": async ()=>{
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$actions$2f$data$3a$82dac8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["arriveAppointment"])(job.jobId);
                    if (result.success) {
        ...
        "JobCard.useCallback[handleComplete]": (e)=>{
            ...
            startTransition({
                "JobCard.useCallback[handleComplete]": async ()=>{
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$actions$2f$data$3a$1ba7d6__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["completeAppointment"])(job.jobId);
                    if (result.success) {
    ...
    const handleItemMove = async ({ item, fromColumnId, toColumnId })=>{
        ...
        startTransition(()=>{
            void (async ()=>{
                ...
                switch(newStatus){
                    case "dispatched":
                        result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$actions$2f$data$3a$61a93e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["dispatchAppointment"])(jobItem.entity.id);
                        break;
                    case "arrived":
                        result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$actions$2f$data$3a$82dac8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["arriveAppointment"])(jobItem.entity.id);
                        break;
                    case "closed":
                        result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$actions$2f$data$3a$35ca9d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["closeAppointment"])(jobItem.entity.id);
                        break;
                    case "completed":
                        result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$actions$2f$data$3a$1ba7d6__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["completeAppointment"])(jobItem.entity.id);
                        break;
                    case "cancelled":
                        result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$actions$2f$data$3a$de2bd3__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["cancelAppointment"])(jobItem.entity.id);
                        break;
                    default:
...
//# sourceMappingURL=apps_web_src_514ede45._.js.map
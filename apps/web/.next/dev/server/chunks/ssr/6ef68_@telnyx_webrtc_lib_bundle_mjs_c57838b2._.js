module.exports = [
"[project]/node_modules/.pnpm/@telnyx+webrtc@2.25.2/node_modules/@telnyx/webrtc/lib/bundle.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var p = "undefined" != typeof globalThis ? globalThis : ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable";
function g(e, t) {
    return e(t = {
        exports: {}
    }, t.exports), t.exports;
...
var f = g(function(e) {
    var t, n;
    t = p, n = function() {
        var e = function() {}, t = "undefined", n = ("TURBOPACK compile-time value", "undefined") !== t && typeof window.navigator !== t && /Trident\/|MSIE /.test(window.navigator.userAgent), i = [
            "trace",
            "debug",
            "info",
            "warn",
        ...
        function c(i, r, c) {
            return function(i) {
                return "debug" === i && (i = "log"), typeof console !== t && (("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : void 0 !== console[i] ? s(console, i) : void 0 !== console.log ? s(console, "log") : e);
        ...
        var u = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : void 0;
        return l.noConflict = function() {
            return ("TURBOPACK compile-time value", "undefined") !== t && window.log === l && (window.log = u), l;
...
var L, P, M;
"undefined" != ("TURBOPACK compile-time value", "undefined") && window.addEventListener("beforeunload", ()=>{
    ...
    t.WebRTCStats = class extends s {
        constructor(e){
            if (super(), this.monitoringSetInterval = 0, this.connectionMonitoringSetInterval = 0, this.connectionMonitoringInterval = 1e3, this.remote = !0, this.peersToMonitor = {}, this.timeline = [], this.statsToMonitor = [
                ...
                "local-candidate",
                "remote-candidate"
            ], "undefined" == ("TURBOPACK compile-time value", "undefined")) throw new Error("WebRTCStats only works in browser");
            const t = {
                ...e
            };
...
class dt extends de {
    ...
    _setupNetworkListeners() {
        "undefined" != ("TURBOPACK compile-time value", "undefined") && (this._onlineHandler = ()=>{
    ...
    _cleanupNetworkListeners() {
        "undefined" != ("TURBOPACK compile-time value", "undefined") && this._onlineHandler && this._offlineHandler && (window.removeEventListener("online", this._onlineHandler), window.removeEventListener("offline", this._offlineHandler), this._onlineHandler = null, this._offlineHandler = null);
    }
...
//# sourceMappingURL=6ef68_%40telnyx_webrtc_lib_bundle_mjs_c57838b2._.js.map
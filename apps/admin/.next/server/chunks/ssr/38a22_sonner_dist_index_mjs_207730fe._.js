	...
	(a) => {
		...
		const q = (a) => {
				...
				const {
					...
					aF = (() => {
						const [a, c] = b.default.useState(document.hidden);
						return (
							b.default.useEffect(() => {
								const a = () => {
									c(document.hidden);
				...
				const aI = b.default.useCallback(() => {
					ab(!0),
						aj(az.current),
						B((a) => a.filter((a) => a.toastId !== y.id)),
						setTimeout(() => {
					...
					if (
						...
						if (G || A || aF) {
							if (aA.current < ay.current) {
								const a = new Date().getTime() - ay.current;
				...
				return b.default.createElement(
					"li",
					{
						...
						onPointerMove: (b) => {
							...
							if (
								...
								return;
							const g = b.clientY - aB.current.y,
					...
					(ar || y.icon || y.promise) &&
						null !== y.icon &&
						((null == U ? void 0 : U[ar]) !== null || y.icon)
						? b.default.createElement(
								"div",
								{
									"data-icon": "",
							...
							l.subscribe((a) => {
								a.dismiss
									...
									: setTimeout(() => {
											c.default.flushSync(() => {
												A((b) => {
													const c = b.findIndex((b) => b.id === a.id);
													return -1 !== c
														? [
																...b.slice(0, c),
																{ ...b[c], ...a },
								...
								? b.default.createElement(
										...
										B.filter(
											...
											return b.default.createElement(q, {
												...
												defaultRichColors: p,
												duration:
													null != (g = null == u ? void 0 : u.duration) ? g : r,

	...
	(e) => {
		...
		function o(e) {
			if (Uint8Array.fromBase64)
				return Uint8Array.fromBase64("string" == typeof e ? e : a.decode(e), {
					alphabet: "base64url",
				});
			let t = e;
		...
		const A = (e, t, ...r) => E(`Key for the ${e} algorithm must be `, t, ...r);
		async function v(e, t, r) {
			if (t instanceof Uint8Array) {
				if (!e.startsWith("HS"))
					throw TypeError(
						((e, ...t) => E("Key must be ", e, ...t))(
							t,
							"CryptoKey",
							"KeyObject",
							"JSON Web Key",
				...
				!((e, t, r) => {
					switch (t) {
						...
						case "HS512": {
							...
							if (b(e.algorithm.hash) !== r)
								throw g(`SHA-${r}`, "algorithm.hash");
							break;
						}
						case "RS256":
						case "RS384":
						...
						case "PS384":
						case "PS512": {
							if ("RSA-PSS" !== e.algorithm.name) throw g("RSA-PSS");
							const r = parseInt(t.slice(2), 10);
							if (b(e.algorithm.hash) !== r)
								throw g(`SHA-${r}`, "algorithm.hash");
							break;
						...
						case "Ed25519":
						case "EdDSA":
							if ("Ed25519" !== e.algorithm.name) throw g("Ed25519");
							break;
						case "ML-DSA-44":
						case "ML-DSA-65":
						case "ML-DSA-87": {
		...
		async function T(e, t, r) {
			const a = await v(e, t, "sign");
			return (
				S(e, a),
				new Uint8Array(await crypto.subtle.sign(w(e, a.algorithm), a, r))
			);
		}
		function H(...e) {
			let t,
		...
		const K = (e) => _(e) && "string" == typeof e.kty,
			R = (e) => e?.[Symbol.toStringTag],
			W = (e, t, r) => {
				if (void 0 !== t.use) {
					let e;
					switch (r) {
				...
				if (Array.isArray(t.key_ops)) {
					...
					switch (!0) {
						...
						case "encrypt" === r && e.startsWith("RSA"):
							...
							break;
						case "decrypt" === r:
							a = e.startsWith("RSA") ? "unwrapKey" : "deriveBits";
					}
			...
			switch (e.substring(0, 2)) {
				...
				case "PB":
					((e, t, r) => {
						if (!(t instanceof Uint8Array)) {
							if (K(t)) {
								if ("oct" === t.kty && "string" == typeof t.k && W(e, t, r))
									return;
								throw TypeError(
							...
							if ("secret" !== t.type)
								throw TypeError(
									`${R(t)} instances for symmetric algorithms must be of type "secret"`,
								);
						}
					})(e, t, r);
					break;
				default:
					((e, t, r) => {
						if (K(t))
							switch (r) {
								...
								case "sign":
									if (
										"oct" !== t.kty &&
										(("AKP" === t.kty && "string" == typeof t.priv) ||
											"string" == typeof t.d) &&
										W(e, t, r)
									)
										return;
						...
						if (!C(t))
							throw TypeError(
								A(e, t, "CryptoKey", "KeyObject", "JSON Web Key"),
							);
						if ("secret" === t.type)
							throw TypeError(
								`${R(t)} instances for asymmetric algorithms must not be of type "secret"`,
							);
						if ("public" === t.type)
							switch (r) {
								case "sign":
									throw TypeError(
										`${R(t)} instances for asymmetric algorithm signing must be of type "private"`,
									);
								case "decrypt":
									throw TypeError(
										`${R(t)} instances for asymmetric algorithm decryption must be of type "private"`,
									);
							}
						if ("private" === t.type)
							switch (r) {
								case "verify":
									throw TypeError(
										`${R(t)} instances for asymmetric algorithm verifying must be of type "public"`,
									);
								case "encrypt":
									throw TypeError(
										`${R(t)} instances for asymmetric algorithm encryption must be of type "public"`,
									);
							}
					})(e, t, r);
			}
		...
		function O(e, t, r, a, i) {
			...
			a.crit)) {
				if (!s.has(o))
					throw new y(`Extension Header Parameter "${o}" is not recognized`);
				if (void 0 === i[o])
					throw new e(`Extension Header Parameter "${o}" is missing`);
				if (s.get(o) && void 0 === a[o])
					throw new e(
		...
		async function I(e) {
			...
			const { algorithm: t, keyUsages: r } = ((e) => {
					let t, r;
					switch (e.kty) {
						case "AKP":
							switch (e.alg) {
		...
		const J = async (e, r, a, i = !1) => {
			const s = (t ||= new WeakMap()).get(e);
			if (s?.[a]) return s[a];
			const o = await I({ ...r, alg: a });
			return i && Object.freeze(e), s ? (s[a] = o) : t.set(e, { [a]: o }), o;
		};
			...
			if (P(e)) {
				...
				if ("toCryptoKey" in e && "function" == typeof e.toCryptoKey)
					try {
						return ((e, r) => {
							let a,
								i = (t ||= new WeakMap()).get(e);
							if (i?.[r]) return i[r];
							const s = "public" === e.type,
								o = !!s;
							...
							if ("ed25519" === e.asymmetricKeyType) {
								...
								a = e.toCryptoKey(e.asymmetricKeyType, o, [
									s ? "verify" : "sign",
								]);
							}
							...
							if ("ec" === e.asymmetricKeyType) {
								...
								"ES256" === r &&
									"P-256" === t &&
									(a = e.toCryptoKey({ name: "ECDSA", namedCurve: t }, o, [
										s ? "verify" : "sign",
									])),
									"ES384" === r &&
										"P-384" === t &&
							...
							return i ? (i[r] = a) : t.set(e, { [r]: a }), a;
						})(e, r);
					} catch (e) {
						if (e instanceof TypeError) throw e;
					}
				const a = e.export({ format: "jwk" });
				return J(e, a, r);
			}
			if (K(e)) return e.k ? o(e.k) : J(e, e, r, !0);
			throw Error("unreachable");
		}
		class j {
			#e;
			...
			async sign(e, t) {
				...
				let d = { ...this.#t, ...this.#r },
					l = O(u, new Map([["b64", !0]]), t?.crit, this.#t, d),
					p = !0;
				if (l.has("b64") && "boolean" != typeof (p = this.#t.b64))
					throw new u(
				...
				D(y, e, "sign"),
					p ? (a = s((r = n(this.#e)))) : ((a = this.#e), (r = "")),
					this.#t
						? (c = s((o = n(JSON.stringify(this.#t)))))
						: ((o = ""), (c = new Uint8Array()));
				const h = i(c, s("."), a),
					f = await x(e, y),
					m = { signature: n(await T(y, f, h)), payload: r };
				return this.#r && (m.header = this.#r), this.#t && (m.protected = o), m;
			}
		}
		class U {
			#a;
		...
		const $ = (e) => Math.floor(e.getTime() / 1e3),
			M =
		...
		class F {
			#e;
			constructor(e) {
				if (!_(e)) throw TypeError("JWT Claims Set MUST be an object");
			...
			set nbf(e) {
				"number" == typeof e
					? (this.#e.nbf = L("setNotBefore", e))
					: e instanceof Date
						? (this.#e.nbf = L("setNotBefore", $(e)))
						: (this.#e.nbf = $(new Date()) + N(e));
			}
			set exp(e) {
				"number" == typeof e
					? (this.#e.exp = L("setExpirationTime", e))
					: e instanceof Date
						? (this.#e.exp = L("setExpirationTime", $(e)))
						: (this.#e.exp = $(new Date()) + N(e));
			}
			set iat(e) {
				void 0 === e
					? (this.#e.iat = $(new Date()))
					: e instanceof Date
						? (this.#e.iat = L("setIssuedAt", $(e)))
						: "string" == typeof e
							? (this.#e.iat = L("setIssuedAt", $(new Date()) + N(e)))
							: (this.#e.iat = L("setIssuedAt", e));
			}
		}
		class G {
		...
		async function V(e, t, r, a) {
			const i = await v(e, t, "verify");
			S(e, i);
			const s = w(e, i.algorithm);
			try {
				return await crypto.subtle.verify(s, i, r, a);
			} catch {
				return !1;
			}
		}
		async function q(e, t, n) {
			let c, d;
			if (!_(e)) throw new u("Flattened JWS must be an object");
			...
			let y = { ...l, ...e.header },
				h = O(u, new Map([["b64", !0]]), n?.crit, l, y),
				f = !0;
			if (h.has("b64") && "boolean" != typeof (f = l.b64))
				throw new u(
					'The "b64" (base64url-encode payload) Header Parameter must be a boolean',
				);
			const { alg: w } = y;
			...
			if (S && !S.has(w))
				throw new p('"alg" (Algorithm) Header Parameter value not allowed');
			if (f) {
			...
			let g = !1;
			"function" == typeof t && ((t = await t(l, e)), (g = !0)),
				D(w, t, "verify");
			const b = i(
				void 0 !== e.protected ? s(e.protected) : new Uint8Array(),
				s("."),
				"string" == typeof e.payload
					? f
						? s(e.payload)
			...
			const E = await x(t, w);
			if (!(await V(w, E, c, b))) throw new m();
			if (f)
				try {
					d = o(e.payload);
				} catch {
			...
			else d = "string" == typeof e.payload ? r.encode(e.payload) : e.payload;
			const A = { payload: d };
			return (void 0 !== e.protected && (A.protectedHeader = l),
		...
		async function z(e, t, r) {
			if ((e instanceof Uint8Array && (e = a.decode(e)), "string" != typeof e))
				throw new u("Compact JWS must be a string or Uint8Array");
			const { 0: i, 1: s, 2: o, length: n } = e.split(".");
			if (3 !== n) throw new u("Invalid Compact JWS");
			const c = await q({ payload: s, protected: i, signature: o }, t, r),
				d = { payload: c.payload, protectedHeader: c.protectedHeader };
			return "function" == typeof t ? { ...d, key: c.key } : d;
		}
		async function X(e, t, r) {
			const i = await z(e, t, r);
			if (
			...
			const s = {
				payload: ((e, t, r = {}) => {
					...
					let o, n;
					try {
						o = JSON.parse(a.decode(t));
					} catch {}
					if (!_(o))
						throw new h("JWT Claims Set must be a top-level JSON object");
					const { typ: c } = r;
					if (c && ("string" != typeof e.typ || B(e.typ) !== B(c)))
						throw new d(
					...
					const {
						...
						w = [...p];
					for (const e of (void 0 !== m && w.push("iat"),
					void 0 !== f && w.push("aud"),
					void 0 !== u && w.push("sub"),
					void 0 !== y && w.push("iss"),
					new Set(w.reverse())))
						if (!(e in o))
							throw new d(`missing required "${e}" claim`, o, e, "missing");
					if (y && !(Array.isArray(y) ? y : [y]).includes(o.iss))
						throw new d(
					...
					if (
						f &&
						((i = o.aud),
						(s = "string" == typeof f ? [f] : f),
						"string" == typeof i
							? !s.includes(i)
							: !(
									Array.isArray(i) && s.some(Set.prototype.has.bind(new Set(i)))
								))
					)
						throw new d(
					...
					const { currentDate: S } = r,
						g = $(S || new Date());
					if ((void 0 !== o.iat || m) && "number" != typeof o.iat)
						throw new d('"iat" claim must be a number', o, "iat", "invalid");
					if (void 0 !== o.nbf) {
						if ("number" != typeof o.nbf)
							throw new d('"nbf" claim must be a number', o, "nbf", "invalid");
						if (o.nbf > g + n)
							throw new d(
					...
					if (void 0 !== o.exp) {
						if ("number" != typeof o.exp)
							throw new d('"exp" claim must be a number', o, "exp", "invalid");
						if (o.exp <= g - n)
							throw new l(
			...
			return "function" == typeof t ? { ...s, key: i.key } : s;
		}
		var Y = e.i(63093),
			Q = e.i(5320);
		const Z = "admin_session";
		function ee() {
			const e = process.env.ADMIN_JWT_SECRET;
			if (!e) throw Error("Missing ADMIN_JWT_SECRET environment variable");
			return new TextEncoder().encode(e);
		}
		async function et(e, t, r, a, i) {
			const s = await (0, Q.createClient)(),
				o = new Date();
			o.setDate(o.getDate() + 7);
			const n = crypto.randomUUID(),
				c = await new G({ userId: e, email: t, role: r, sessionId: n })
				...
				{ error: l } = await s
					...
					.insert({
						...
						ip_address: a,
						user_agent: i,
						expires_at: o.toISOString(),
					});
			if (l) throw Error(`Failed to create session: ${l.message}`);
			return (
				(await (0, Y.cookies)()).set(Z, c, {
					httpOnly: !0,
					secure: !0,
					sameSite: "lax",
					path: "/",
		...
		async function er(e) {
			try {
				const { payload: t } = await X(e, ee()),
					r = await (0, Q.createClient)(),
					{ data: a, error: i } = await r
						.from("admin_sessions")
						.select("*")
						.eq("id", t.sessionId)
						.is("revoked_at", null)
						.single();
				if (i || !a || new Date(a.expires_at) < new Date()) return null;
				return t;
			} catch {
				return null;
			}
		...
		async function ei() {
			const e = await ea();
			if (e) {
				const t = await (0, Q.createClient)();
				await t
					.from("admin_sessions")
					.update({ revoked_at: new Date().toISOString() })
					.eq("id", e.sessionId);
			}
			(await (0, Y.cookies)()).delete(Z);
		}
		async function es(e) {
			const t = await (0, Q.createClient)();
			await t
		...
		async function en() {
			const e = await (0, Q.createClient)(),
				{ data: t, error: r } = await e
					.from("admin_sessions")
					.delete()
					.lt("expires_at", new Date().toISOString())
					.select("id");
			if (r) throw Error(`Failed to cleanup sessions: ${r.message}`);
			return t?.length || 0;
		}
		e.s(
			[
...
//# sourceMappingURL=apps_admin_src_lib_auth_session_ts_ddeadb02._.js.map

...
export const ROLE_CONFIGS: Record<UserRole, RoleConfig> = {
	...
	[USER_ROLES.DISPATCHER]: {
		...
		color: "blue",
		permissions: ["view-schedule", "manage-assignments", "view-technicians", "dispatch-jobs", "view-customers"],
		dashboardFeatures: [
			"dispatch-map",
	...
	[USER_ROLES.MANAGER]: {
		...
		color: "green",
		permissions: ["view-reports", "manage-team", "view-customers", "handle-escalations", "view-financials"],
		dashboardFeatures: [
			"team-performance",
	...
	[USER_ROLES.TECHNICIAN]: {
		...
		color: "orange",
		permissions: ["view-my-schedule", "update-job-status", "view-job-details", "upload-photos", "create-invoices"],
		dashboardFeatures: [
			"my-schedule",
			"active-job",
			"my-earnings",
	...
	[USER_ROLES.CSR]: {
		...
		color: "pink",
		permissions: ["view-customers", "create-jobs", "schedule-appointments", "view-schedule", "send-communications"],
		dashboardFeatures: [
			"call-queue",
			"booking-calendar",
			"customer-search",

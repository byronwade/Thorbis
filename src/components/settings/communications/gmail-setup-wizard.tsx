...
export function GmailSetupWizard({ companyId, onComplete }: GmailSetupWizardProps) {
	...
	const canProceed = () => {
		switch (currentStep) {
			...
			case 2:
				return Object.values(selectedEmails).some((email) => email && email.length > 0);
			case 3:
								...
								<div className="flex flex-col items-center justify-center p-8 space-y-6">
									<div className="text-center max-w-md">
										...
										<p className="text-sm text-muted-foreground">
											Click the button below to authorize Stratos to access your Gmail
											account. You'll be redirected to Google's secure login page.
										</p>
									</div>
									<Button size="lg" onClick={handleOAuthConnect} disabled={loading}>
					...
					{currentStep === 2 && (
						<div className="space-y-6">
							<Alert>
								...
								<AlertDescription>
									Enter the Gmail addresses for each category. These will be synced to your
									company inbox and accessible to assigned team members.
								</AlertDescription>
							</Alert>
							...
							<div className="space-y-4">
								{EMAIL_CATEGORIES.map((category) => (
									<div key={category.id} className="space-y-2">
										...
										{category.id !== EMAIL_CATEGORIES[EMAIL_CATEGORIES.length - 1].id && (
					...
					{currentStep === 3 && (
						<div className="space-y-6">
							<Alert>
								...
								<AlertDescription>
									Configure which team members can access each email category. You can skip
									this step and configure permissions later in team settings.
								</AlertDescription>
							</Alert>
							...
							<div className="text-center p-8">
								...
								<p className="text-sm text-muted-foreground mb-4">
									Team permission management will be available after setup is complete.
								</p>
					...
					{currentStep === 4 && (
						<div className="space-y-6">
							<Alert>
								...
								<AlertDescription>
									We'll verify that we can successfully connect to your Gmail account and
									sync emails.
								</AlertDescription>
							</Alert>
							...
							<div className="space-y-4">
								<div className="grid gap-4 md:grid-cols-2">
									<Card>
										...
										<CardContent>
											<p className="font-mono text-sm">{gmailEmail || "Not connected"}</p>
										</CardContent>
									</Card>
									<Card>
										<CardHeader>
										...
										<CardContent>
											<p className="text-sm">
												{Object.keys(selectedEmails).length} categories configured
											</p>
										</CardContent>
									</Card>
								</div>
								...
								<div className="flex flex-col items-center justify-center p-8">
									<Button size="lg" onClick={handleTestConnection} disabled={loading}>
										{loading && <Loader2 className="h-5 w-5 mr-2 animate-spin" />}

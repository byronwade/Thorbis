/**
 * Pricebook Skeleton - Loading State
 *
 * Matches the exact layout of pricebook data to prevent layout shifts.
		...
		<div className="relative space-y-10 py-8 md:py-12">
			...
			<div className="mx-auto max-w-5xl space-y-8 pt-4">
				...
				<div className="rounded-lg border bg-card p-8 text-center">
					...
					<div className="mx-auto mb-6 h-5 w-56 animate-pulse rounded bg-muted" />

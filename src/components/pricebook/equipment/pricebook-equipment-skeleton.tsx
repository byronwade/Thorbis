/**
 * Pricebook Equipment Skeleton - Loading State
 *
 * Matches the exact layout of pricebook equipment data to prevent layout shifts.
 */

export function PricebookEquipmentSkeleton() {
	return (
		<div className="relative space-y-10 py-8 md:py-12">
			...
			<div className="mx-auto max-w-5xl space-y-8 pt-4">
				...
				<div className="bg-card rounded-lg border p-8 text-center">
					<div className="bg-muted mx-auto mb-3 h-7 w-72 animate-pulse rounded" />

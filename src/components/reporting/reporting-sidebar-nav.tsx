...
const presetReportGroups: ReportGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Email Open & Click Rates", href: "/dashboard/reporting/communication/email-metrics" },
      { title: "Support Ticket Analysis", href: "/dashboard/reporting/communication/tickets" },
      { title: "Response Time Metrics", href: "/dashboard/reporting/communication/response-time" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Cash Flow Reports", href: "/dashboard/reporting/finance/cash-flow" },
      ...
      { title: "Customer Lifetime Value", href: "/dashboard/reporting/finance/ltv" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Service Type Analysis", href: "/dashboard/reporting/operations/service-types" },
      ...
      { title: "Equipment Utilization", href: "/dashboard/reporting/operations/equipment" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Revenue Per Technician", href: "/dashboard/reporting/team/revenue" },
      ...
      { title: "Attendance & Availability", href: "/dashboard/reporting/team/attendance" },
      { title: "Training Completion", href: "/dashboard/reporting/team/training" },
      { title: "Certifications", href: "/dashboard/reporting/team/certifications" },
      { title: "Commission Reports", href: "/dashboard/reporting/team/commission" },
  ...
  },
  {
    ...
    items: [
      { title: "Customer Acquisition", href: "/dashboard/reporting/customers/acquisition" },
      { title: "Retention Rates", href: "/dashboard/reporting/customers/retention" },
      { title: "Churn Analysis", href: "/dashboard/reporting/customers/churn" },
      { title: "Customer Segments", href: "/dashboard/reporting/customers/segments" },
      ...
      { title: "Referral Sources", href: "/dashboard/reporting/customers/referrals" },
      { title: "Customer Geography", href: "/dashboard/reporting/customers/geography" },
  ...
  },
  {
    ...
    items: [
      { title: "Campaign Performance", href: "/dashboard/reporting/marketing/campaigns", badge: "New" },
      { title: "Lead Generation", href: "/dashboard/reporting/marketing/leads" },
      { title: "Lead Conversion", href: "/dashboard/reporting/marketing/conversion" },
      ...
      { title: "Social Media Metrics", href: "/dashboard/reporting/marketing/social" },
      { title: "Review Analysis", href: "/dashboard/reporting/marketing/reviews" },
  ...
  },
  {
    ...
    items: [
      { title: "Schedule Utilization", href: "/dashboard/reporting/schedule/utilization" },
      { title: "First-Time Fix Rate", href: "/dashboard/reporting/schedule/first-time-fix" },
      { title: "Callback Analysis", href: "/dashboard/reporting/schedule/callbacks" },
      { title: "Travel Time Analysis", href: "/dashboard/reporting/schedule/travel-time" },
      ...
      { title: "Rescheduling Trends", href: "/dashboard/reporting/schedule/rescheduling" },
    ],
    defaultOpen: false,
  },
  {
    ...
    items: [
      ...
      { title: "Renewal Rates", href: "/dashboard/reporting/maintenance/renewals" },
      { title: "Service Plan Revenue", href: "/dashboard/reporting/maintenance/revenue" },
      { title: "Maintenance Schedule", href: "/dashboard/reporting/maintenance/schedule" },
      { title: "Preventive Maintenance", href: "/dashboard/reporting/maintenance/preventive" },
      { title: "Agreement Profitability", href: "/dashboard/reporting/maintenance/profitability" },
    ],
    defaultOpen: false,
  },
  {
    ...
    items: [
      ...
      { title: "Supplier Performance", href: "/dashboard/reporting/inventory/suppliers" },
      { title: "Part Usage", href: "/dashboard/reporting/inventory/usage" },
      { title: "Dead Stock Analysis", href: "/dashboard/reporting/inventory/dead-stock" },
    ],
    defaultOpen: false,
  },
  {
    ...
    items: [
      { title: "Licensing Status", href: "/dashboard/reporting/compliance/licensing" },
      { title: "Insurance Coverage", href: "/dashboard/reporting/compliance/insurance" },
      { title: "Certification Tracking", href: "/dashboard/reporting/compliance/certifications" },
      { title: "Safety Incidents", href: "/dashboard/reporting/compliance/safety" },
      { title: "OSHA Compliance", href: "/dashboard/reporting/compliance/osha" },
      { title: "Audit Reports", href: "/dashboard/reporting/compliance/audits" },
    ],
    defaultOpen: false,
  },
  {
    ...
    items: [
      ...
      { title: "Trend Analysis", href: "/dashboard/reporting/analytics/trends" },
      { title: "Seasonality Reports", href: "/dashboard/reporting/analytics/seasonality" },
      { title: "Forecasting", href: "/dashboard/reporting/analytics/forecasting" },
      { title: "Benchmark Comparisons", href: "/dashboard/reporting/analytics/benchmarks" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Report Templates", href: "/dashboard/reporting/export/templates" },
        ...
        <Collapsible key={group.label} defaultOpen={group.defaultOpen}>
          <SidebarGroup>
            <SidebarGroupLabel asChild>
              <CollapsibleTrigger className="group/collapsible flex w-full items-center justify-between hover:bg-sidebar-accent hover:text-sidebar-accent-foreground rounded-md px-2 py-1.5 text-xs font-medium transition-colors">
                {group.label}

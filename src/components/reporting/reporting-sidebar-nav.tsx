...
import { BarChart3, DollarSign, Plus, Trash2, TrendingUp, Users } from "lucide-react";
				...
				<SidebarMenu>
					{customReports.length === 0 ? (
						<div className="px-2 py-8 text-center">
							<p className="mb-2 text-muted-foreground text-sm">No custom reports yet</p>
							<button className="text-primary text-xs hover:underline" onClick={handleCreateReport} type="button">

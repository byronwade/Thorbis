			...
			<div className="flex flex-col gap-1">
				<div className="flex items-center gap-3">
					...
					<div className="flex items-center gap-2 rounded-full border border-border bg-muted/30 px-3 py-1">
						...
						<span className="font-medium text-muted-foreground text-xs">Live</span>
					</div>
				</div>
				...
				<Card className="min-h-[400px]">
					<CardContent className="flex items-center justify-center pt-6">
						<div className="text-center">
							...
							<p className="mt-4 font-medium text-lg text-muted-foreground">Interactive Map Component</p>
							<p className="text-muted-foreground text-sm">Real-time GPS tracking with technician locations</p>
						</div>
					</CardContent>
				</Card>
			</div>
						...
						<CardContent className="space-y-3 pt-6">
							...
							<div className="flex items-start gap-3 rounded-lg border-2 border-destructive bg-destructive p-3 dark:border-destructive dark:bg-destructive/30">
								...
								<div className="flex-1">
									...
									<p className="text-muted-foreground text-xs">Sarah Johnson • 123 Main St • Water heater failure</p>
								</div>
								<Button size="sm" variant="destructive">
									Dispatch
								</Button>

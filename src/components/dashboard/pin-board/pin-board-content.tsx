...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  purple: "bg-purple-500/10 text-purple-500 hover:bg-purple-500/20 border-purple-500/20",
  orange: "bg-orange-500/10 text-orange-500 hover:bg-orange-500/20 border-orange-500/20",

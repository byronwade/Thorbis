	...
	if (paymentMethods.length === 0) {
		return (
			<Card className="p-8 text-center">
				...
				<p className="mt-2 text-muted-foreground text-sm">Add a payment method to get started</p>
			</Card>
		);
	}
					...
					<div className="flex items-center justify-between">
						...
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<p className="text-muted-foreground text-xs">Added {new Date(method.createdAt).toLocaleDateString()}</p>
							</div>
						</div>
							...
							<AlertDialog>
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										...
										<AlertDialogDescription>
											This will remove {formatPaymentMethodText(method)} from your account. This action cannot be
											undone.
										</AlertDialogDescription>
									</AlertDialogHeader>
									<AlertDialogFooter>

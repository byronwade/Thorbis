	...
	return (
		<div className="space-y-20">
			...
			>
				...
				<div className="relative mx-auto max-w-4xl space-y-8">
					<div className="flex items-center gap-3">
						<Badge className={cn("px-4 py-1.5 font-medium tracking-wide uppercase", config.badgeStyle)}>
					...
					<div className={cn("rounded-xl border p-4 backdrop-blur-sm", config.cardStyle)}>
			...
			<section className="grid gap-8 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)]">
				<Card className={cn("border-2 shadow-lg", config.cardStyle)}>
					<CardContent className="p-8">
						<div className={cn("mb-6 inline-flex rounded-full p-3", config.secondaryColor)}>
						...
						<div className="mt-8 space-y-4">
							...
							{competitor.idealCustomerProfile.map((profile, index) => (
								...
								>
									...
									>
										<span className={cn("text-xs font-bold", config.accentColor)}>
											{index + 1}
										</span>
									</div>
				...
				<div className="space-y-4">
					<div className={cn("rounded-2xl border-2 bg-gradient-to-br p-6", config.cardStyle)}>
			...
			<section className="space-y-8">
				...
				<div className={cn("overflow-hidden rounded-2xl border-2 shadow-lg", config.cardStyle)}>
						...
						<table className="divide-border min-w-full divide-y">
							<thead className="from-muted/60 to-muted/40 bg-gradient-to-r">
								<tr>
									...
									<th className={cn("px-6 py-4 text-left text-sm font-bold tracking-wide uppercase", config.tableHeaderStyle)}>
										Thorbis
									</th>
							...
							<tbody className="divide-border bg-background divide-y">
								{competitor.comparisonTable.map((row, index) => (
									...
									>
										...
										<td className={cn("px-6 py-5 text-sm leading-relaxed", config.tableHeaderStyle)}>
											<div className="flex items-start gap-2">
												<Check className={cn("mt-0.5 size-4 shrink-0", config.accentColor)} />
				...
				<div className={cn("rounded-xl border-2 p-6 text-center", config.savingsStyle)}>
					<p className="text-foreground font-semibold">
						<span className={config.accentColor}>Save 60-70%</span>{" "}
			...
			<section className="space-y-8">
				...
				<div className={cn("rounded-xl p-6 text-center", config.secondaryColor)}>
					<p className="text-foreground font-medium">
						Most migrations complete in{" "}
						<span className={config.accentColor}>30-45 days</span> with zero downtime
					</p>
				</div>
			</section>
				...
				{competitor.testimonial ? (
					...
					>
						...
						<CardContent className="flex flex-col justify-center p-8 text-center lg:p-12">
							<div className={cn("mb-6 text-6xl leading-none", config.accentColor)}>"</div>
							...
							<blockquote className="space-y-6">
								...
								<footer className="space-y-2">
									<div className={cn("mx-auto h-0.5 w-12", config.secondaryColor)} />
									<p className="text-foreground font-semibold">
					...
					<Card className={cn("border-2", config.cardStyle)}>
						<CardContent className="flex flex-col items-center justify-center p-12 text-center">
							<div className={cn("mb-4 rounded-full p-4", config.secondaryColor)}>
			...
			<section className="space-y-8">
				...
				<div className={cn("rounded-xl border p-6 text-center", config.secondaryColor)}>
					<p className="text-muted-foreground">
						Still have questions?{" "}
						<Link
							className={cn("font-semibold underline-offset-4 hover:underline", config.accentColor)}
							href="/contact"
						>

/**
 * Call Logs Skeleton - Loading State
 *
 * Matches the exact layout of call logs data to prevent layout shifts.
		...
		<div className="relative space-y-10 py-8 md:py-12">
			...
			<div className="mx-auto max-w-5xl space-y-8 pt-4">
				<div className="grid gap-6 md:grid-cols-2">
					...
					{/* Full-width card */}
					<div className="space-y-3 rounded-lg border bg-card p-6 md:col-span-2">
						<div className="size-12 animate-pulse rounded-lg bg-muted" />
						<div className="h-6 w-40 animate-pulse rounded bg-muted" />
						<div className="space-y-2">
							<div className="h-4 w-full animate-pulse rounded bg-muted" />

/**
 * SMS Campaigns Skeleton - Loading State
 *
 * Matches the exact layout of SMS campaigns data to prevent layout shifts.
 * Displays while content is loading.
 */

export function SmsCampaignsSkeleton() {
	return (
		<div className="relative space-y-10 py-8 md:py-12">
			...
			<div className="mx-auto max-w-5xl space-y-8 pt-4">
				...
				<div className="grid gap-4 md:grid-cols-3">
					{[...new Array(3)].map((_, i) => (
						<div className="bg-card rounded-lg border p-6 text-center" key={i}>
							<div className="bg-muted mx-auto mb-2 h-9 w-16 animate-pulse rounded" />
				...
				<div className="bg-card rounded-lg border p-8 text-center">
					...
					<div className="bg-muted mx-auto mb-6 h-5 w-72 animate-pulse rounded" />

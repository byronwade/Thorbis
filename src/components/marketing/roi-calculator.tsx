...
export function RoiCalculator() {
	...
	useEffect(() => {
		if (Number.isFinite(results.netMonthlyImpact) && results.netMonthlyImpact > 0) {
	...
	const handleExport = () => {
		const csvRows = [
			...
			[
				...
				((inputs.thorbisPlanCost - inputs.currentSoftwareSpend) * 12).toFixed(2),
			],
					...
					<div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
						<div className="text-center">
							...
							<p className="text-muted-foreground mx-auto max-w-2xl text-base leading-relaxed text-pretty">
								See how much you can save and earn by switching to Thorbis. Use your real numbers to
								project labor savings, revenue lift, and net ROI after replacing your legacy field
								service stack.
							</p>
						</div>
					</div>
					...
					<div className="mx-auto max-w-6xl space-y-12">
						...
						<section className="scroll-mt-24" id="inputs">
							...
							<div className="bg-background space-y-6 rounded-lg p-6">
								{/* Team & Operations */}
								<div>
									<h3 className="text-foreground mb-3 text-sm font-semibold">Team & Operations</h3>
								...
								{/* Software Costs */}
								<div>
									<h3 className="text-foreground mb-3 text-sm font-semibold">Software Costs</h3>
										...
										<Tooltip>
											...
											<TooltipContent>
												<p className="text-xs">
													...
													<br />= ({inputs.minutesSavedPerJob} × {formatNumber(results.monthlyJobs)}
													) ÷ 60
												</p>
											</TooltipContent>
										</Tooltip>
										...
										<Tooltip>
											...
											<TooltipContent>
												<p className="text-xs">
													...
													<br />= {formatNumber(results.monthlyJobs)} × ({inputs.closeRateLift}% ÷
													100)
												</p>
											</TooltipContent>
										</Tooltip>
								...
								<div className="flex flex-wrap gap-3">
									...
									<Button asChild type="button" variant="ghost">
										<Link href="/tools/calculators/hourly-rate">Calculate hourly rate →</Link>
									</Button>
								</div>
							</div>
						</section>
							...
							<div className="space-y-6">
								...
								<div className="grid gap-6 lg:grid-cols-2">
									...
									<div className="bg-background rounded-lg p-6">
										<div className="mb-4 flex items-center gap-3">
											...
											<div>
												<h3 className="text-lg font-semibold">Labor Time Savings</h3>
									...
									<div className="bg-background rounded-lg p-6">
										...
										<div className="space-y-4">
											<div className="bg-muted/30 rounded-lg border p-4">
												...
												<p className="text-muted-foreground mt-2 text-sm">
													{formatNumber(results.monthlyJobs * (inputs.closeRateLift / 100))}{" "}
													additional jobs × {formatCurrency(inputs.averageTicket)}
												</p>
											</div>
											<div className="bg-muted/30 rounded-lg border p-4">
												<p className="text-muted-foreground mb-1 text-xs font-medium tracking-wide uppercase">
												...
												<p className="text-muted-foreground mt-2 text-sm">
													{formatNumber(results.monthlyJobs * (inputs.closeRateLift / 100) * 12)}{" "}
								...
								<div className="border-primary bg-primary/5 rounded-lg border-2 p-6">
									<div className="mb-4 flex items-center gap-3">
										...
										<div>
											<h3 className="text-lg font-semibold">Net Monthly Impact</h3>
									...
									<div className="grid gap-6 lg:grid-cols-3">
										<div className="bg-background/80 rounded-lg p-4">
											...
											<p className="text-muted-foreground mt-2 text-sm">Savings + Revenue Lift</p>
										</div>
										<div className="bg-background/80 rounded-lg p-4">
											<p className="text-muted-foreground mb-1 text-xs font-medium tracking-wide uppercase">
								...
								<div className="bg-background rounded-lg p-6">
									<div className="mb-4">
										<h3 className="text-lg font-semibold">12-Month Projections</h3>
										<p className="text-muted-foreground text-sm">
										...
										<table className="w-full">
											<thead className="bg-muted/50">
												<tr>
													...
													<th className="px-4 py-3 text-right text-sm font-medium">Monthly</th>
													<th className="px-4 py-3 text-right text-sm font-medium">Annual</th>
												</tr>
											</thead>
											<tbody className="divide-border/30 divide-y">
												<tr className="hover:bg-muted/20">
													<td className="px-4 py-3 text-sm font-medium">Labor Savings</td>
												...
												<tr className="hover:bg-muted/20">
													<td className="px-4 py-3 text-sm font-medium">Additional Revenue</td>
													<td className="px-4 py-3 text-right text-sm">
														{formatCurrency(results.additionalRevenueMonthly)}
													</td>
													<td className="px-4 py-3 text-right text-sm">
												...
												<tr className="hover:bg-muted/20">
													<td className="px-4 py-3 text-sm font-medium">Total Impact</td>
												...
												<tr className="hover:bg-muted/20">
													...
													<td className="px-4 py-3 text-right text-sm">
														{formatCurrency(
															(inputs.thorbisPlanCost - inputs.currentSoftwareSpend) * 12
														)}
													</td>
												</tr>
								...
								<div className="from-primary/10 rounded-lg bg-gradient-to-br to-transparent p-6 text-center">
									<div className="mx-auto max-w-2xl">
										<h3 className="mb-2 text-xl font-semibold">Ready to achieve these results?</h3>
										<p className="text-muted-foreground mb-6">
											Join service businesses saving an average of{" "}
											{formatCurrency(results.netMonthlyImpact)} per month with Thorbis.
										</p>
...
function calculateROI({
	...
	const additionalRevenueMonthly = monthlyJobs * (closeRateLift / 100) * averageTicket;
	...
	const roiMultiple = thorbisPlanCost > 0 ? totalMonthlyImpact / thorbisPlanCost : 0;

/**
 * Marketing Analytics Skeleton - Loading State
 *
 * Matches the exact layout of marketing analytics data to prevent layout shifts.
 * Displays while content is loading.
 */

export function MarketingAnalyticsSkeleton() {
	return (

...
function EquipmentCard({ item }: { item: EquipmentKanbanItem }) {
	...
	return (
		<div className="space-y-3">
			<div>
				<p className="font-semibold text-muted-foreground text-xs uppercase tracking-wide">{equipment.assetId}</p>
				...
				<div className="mt-2 flex flex-wrap items-center gap-2">
					<Badge
						...
						variant={columnId === "available" ? "secondary" : columnId === "retired" ? "destructive" : "outline"}
					>

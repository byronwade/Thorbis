...
/**
 * Service Tickets Filter Dropdown
 *
 * Comprehensive filter control for service tickets
 */
...
export function ServiceTicketsFilterDropdown({
	activeCount,
	archivedCount,
	totalCount,
			...
			<DropdownMenuContent align="start" className="w-80 p-4">
				<div className="space-y-4">
					<div className="flex items-center justify-between">
						<h4 className="text-sm font-semibold">Filter Service Tickets</h4>
						{activeFilterCount > 0 && (
							<Button
					...
					<div className="space-y-2">
						...
						<Select
							onValueChange={(value: ServiceTicketsFilters["archiveStatus"]) =>

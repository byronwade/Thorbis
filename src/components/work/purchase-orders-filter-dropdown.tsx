...
import { type PurchaseOrdersFilters, usePurchaseOrdersFiltersStore } from "@/lib/stores/purchase-orders-filters-store";
					...
					<div className="space-y-2">
						...
						>
							...
							<SelectContent>
								...
								<SelectItem value="all">All Purchase Orders {totalCount !== undefined && `(${totalCount})`}</SelectItem>
							</SelectContent>
						</Select>
					</div>

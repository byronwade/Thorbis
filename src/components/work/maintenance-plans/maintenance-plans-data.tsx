...
import { type MaintenancePlan, MaintenancePlansTable } from "@/components/work/maintenance-plans-table";
	...
	const plans: MaintenancePlan[] =
		...
		(plansRaw || []).map((plan: any): MaintenancePlan => {
			...
			return {
				...
				nextVisit: nextVisit || "",
				monthlyFee:
					typeof plan.monthly_fee === "number" ? plan.monthly_fee : typeof plan.value === "number" ? plan.value : 0,

...
import { type AppointmentsFilters, useAppointmentsFiltersStore } from "@/lib/stores/appointments-filters-store";
			...
			<DropdownMenuContent align="start" className="w-80 p-4">
				<div className="space-y-4">
					<div className="flex items-center justify-between">
						<h4 className="font-semibold text-sm">Filter Appointments</h4>
						{activeFilterCount > 0 && (
					...
					<div className="space-y-2">
						...
						>
							...
							<SelectContent>
								...
								<SelectItem value="all">All Appointments {totalCount !== undefined && `(${totalCount})`}</SelectItem>
							</SelectContent>
						</Select>
					</div>

					...
					<div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
						<div className="flex flex-col gap-4">
							...
							<div className="flex flex-col gap-2">
								<h1 className="font-semibold text-2xl sm:text-3xl">{material.name}</h1>
								{material.description && (
									<p className="text-muted-foreground text-sm sm:text-base">{material.description}</p>
								)}
							</div>
						</div>
					</div>
				...
				<UnifiedAccordionContent>
					<div className="grid gap-4 md:grid-cols-3">
						...
						<div className="space-y-2 rounded-lg border bg-background p-4 shadow-sm">
							...
							<p className="font-semibold text-foreground text-xl tabular-nums">{material.reorderPoint ?? 0}</p>
							<p className="text-muted-foreground text-sm">Reorder {material.reorderQuantity ?? 0} when at minimum</p>
						</div>
						<div className="space-y-2 rounded-lg border bg-background p-4 shadow-sm">
						...
						<div className="space-y-4">
							...
							<div className="grid gap-4 sm:grid-cols-2">
								<div>
									...
									<p className="text-muted-foreground text-sm">{priceBookItem.category || "Uncategorized"}</p>
								</div>
								<div>
									<Label>Subcategory</Label>
									<p className="text-muted-foreground text-sm">{priceBookItem.subcategory || "—"}</p>
								</div>
							</div>
							<div>

...
export function JobsFilterDropdown({ activeCount, archivedCount, totalCount }: JobsFilterDropdownProps) {
					...
					<div className="space-y-2">
						...
						>
							...
							<SelectContent>
								...
								<SelectItem value="all">All Jobs {totalCount !== undefined && `(${totalCount})`}</SelectItem>
							</SelectContent>
						</Select>
					</div>

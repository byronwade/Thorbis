				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mx-auto mb-8 max-w-3xl text-foreground/70 text-xl">
							<strong>$100/month base</strong> + pay only for what you use. Calculate your exact monthly cost below. No
							surprises. No hidden fees. No per-user charges.
						</p>
						...
						<div className="grid gap-4 md:grid-cols-3">
							<div className="rounded-xl border border-destructive/20 bg-destructive/5 p-4">
								...
								<p className="text-destructive text-sm dark:text-destructive">$398/user/mo</p>
								<p className="text-muted-foreground text-xs">5 users = $23,880/year</p>
							</div>
							<div className="rounded-xl border border-warning/20 bg-warning/5 p-4">
								<div className="mb-2 text-2xl">📱</div>
								<p className="mb-1 font-bold">Housecall Pro</p>
								<p className="text-sm text-warning dark:text-warning">$289/user/mo</p>
					...
					<div className="mx-auto max-w-4xl">
						...
						<div className="grid gap-4 md:grid-cols-2">
							{[
								...
								<div className="flex items-start gap-3 rounded-xl border border-primary/10 bg-background p-4" key={i}>
									<div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-primary/10">
										<feature.icon className="size-5 text-primary" />
									</div>
									<div>
										<p className="mb-1 font-semibold text-sm">{feature.title}</p>
					...
					<div className="mx-auto max-w-5xl">
						<div className="mb-12 text-center">
							...
							<p className="mx-auto max-w-2xl text-foreground/70 text-lg">
								Adjust the sliders below to estimate your monthly costs based on actual usage. Most businesses pay{" "}
							...
							<div className="p-6 md:p-8">
								<div className="space-y-8">
									{PRICING_ITEMS.map((item) => {
										...
										return (
											<div className="rounded-xl border border-primary/10 bg-muted/30 p-6" key={item.id}>
												<div className="mb-4 flex items-start justify-between gap-4">
													<div className="flex items-start gap-3">
														...
														<div className="flex-1">
															...
															<p className="mt-1 text-muted-foreground text-xs italic">{item.example}</p>
														</div>
													</div>
													<div className="text-right">
														<div className="font-bold text-2xl text-primary">${cost.toFixed(2)}</div>
								...
								<div className="space-y-3">
									...
									<div className="border-border/50 border-t pt-3">
										<div className="flex items-center justify-between">
											<span className="font-bold text-2xl">Estimated Monthly Total</span>
											<span className="font-bold text-4xl text-primary">${monthlyTotal.toFixed(2)}</span>
										</div>
									...
									<div className="flex items-start gap-3">
										...
										<div>
											<p className="mb-1 font-semibold text-success dark:text-success">
												You&apos;re saving ${(23_880 - monthlyTotal * 12).toFixed(0)}/year vs ServiceTitan (5 users)
											</p>
											<p className="text-muted-foreground text-xs">
												That&apos;s enough for 2 new technicians, marketing budget, or equipment upgrades.
											</p>
										</div>
									</div>
								</div>
						...
						<div className="mt-8 rounded-xl border border-primary/10 bg-background p-6">
							<h3 className="mb-4 font-semibold text-lg">Detailed Cost Breakdown</h3>
							<div className="space-y-2">
								...
								<table className="w-full">
									<thead className="bg-muted/50">
										<tr>
											...
											<th className="bg-primary/5 p-4 text-center font-semibold text-primary">Thorbis</th>
										</tr>
									</thead>
											...
											<tr key={i}>
												...
												<td className="bg-primary/5 p-4 text-center">
													{typeof row.thorbis === "boolean" ? (
														...
														<span className="font-semibold text-primary text-sm">{row.thorbis}</span>
													)}
												</td>
											</tr>
										))}
			...
			<section className="border-border/50 border-t bg-muted/30 py-16">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-3xl">
						<h2 className="mb-12 text-center font-bold text-3xl">Pricing Questions</h2>
						<div className="space-y-6">
							{[
								...
								<div className="rounded-xl border border-primary/10 bg-background p-6" key={i}>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mb-8 text-foreground/70 text-xl">
							Start your 14-day free trial today. No credit card required. No sales calls. Cancel anytime.
						</p>

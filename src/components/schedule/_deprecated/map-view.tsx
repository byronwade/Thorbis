		...
		<div className="flex h-full w-full overflow-hidden">
			...
			<div className="bg-muted/20 relative flex-1">
				...
				<div className="absolute top-4 right-4 z-10 flex flex-col gap-2">
					<button
						className="bg-background hover:bg-accent flex size-10 items-center justify-center rounded-lg border shadow-md transition-colors"
						type="button"
					>
				...
				{/* Map Legend */}
				<div className="bg-background absolute bottom-4 left-4 z-10 rounded-lg border p-3 shadow-md">
						...
						return (
							...
							>
								...
								<div className="relative">
									<div
										className={cn(
											"border-background flex size-10 items-center justify-center rounded-full border-4 shadow-lg",
									...
									<div
										className={cn(
											"absolute top-full left-1/2 size-0 -translate-x-1/2 border-8 border-transparent",
								...
								{/* Hover Label */}
								<div className="bg-foreground text-background pointer-events-none absolute -top-2 left-1/2 -translate-x-1/2 -translate-y-full rounded px-2 py-1 text-xs whitespace-nowrap opacity-0 shadow-lg transition-opacity group-hover:opacity-100">
									{job.title}
								</div>
							</button>
						);
						...
						<Card className="relative overflow-hidden shadow-xl">
							...
							<div className="p-4 pl-5">
								...
								{selectedJob.description && (
									<p className="text-muted-foreground mb-3 text-sm">{selectedJob.description}</p>
								)}
								...
								<button
									className="bg-foreground text-background mt-3 w-full rounded-md py-2 text-sm font-medium transition-opacity hover:opacity-90"
									type="button"
								>
									Get Directions
								</button>
			...
			<div className="bg-background w-80 border-l">
				<div className="border-b p-4">
					<h3 className="text-lg font-semibold">Jobs Today</h3>
				...
				<div className="divide-y overflow-auto" style={{ height: "calc(100% - 73px)" }}>
					{allJobs.map((job) => (
						...
						>
							...
							<p className="text-muted-foreground mb-1 text-xs">{job.customer}</p>

...
export function CustomerSuccessSection() {
  ...
  const stories = [
    ...
    },
    {
      ...
      logo: "❄️",
      quote:
        "The mobile app alone pays for itself. Our techs complete 3 more jobs per day.",
      author: "Sarah Chen",
    ...
    },
    {
      ...
      logo: "⚡",
      quote:
        "Best investment we've made. The scheduling intelligence is game-changing.",
      author: "David Kim",
      role: "CEO",
      metrics: [
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 lg:p-12">
                ...
                <div className="mb-8">
                  ...
                  <p className="mb-6 font-medium text-white text-xl leading-relaxed md:text-2xl">
                    {activeData.quote}
                  </p>
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  {activeData.metrics.map((metric, idx) => (
                    <div
                      className="rounded-xl border border-primary/20 bg-primary/5 p-4 transition-all duration-300 hover:border-primary/40 hover:bg-primary/10"
                      key={idx}
                    >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-primary/20 bg-black p-8 lg:p-12">
            ...
            <h2 className="mb-4 text-balance font-semibold text-3xl text-white md:text-5xl">
            ...
            <div className="space-y-6">
              <div>
                <label
                  className="mb-2 flex items-center justify-between text-sm text-white"
                  htmlFor="team-size"
                >
                  <span>Team Size</span>
            ...
            <div className="mt-8 space-y-4 rounded-2xl border border-primary/20 bg-primary/5 p-6">
              <div className="flex items-center justify-between border-border border-b pb-4">
                ...
                <span className="font-bold text-2xl text-white">
                  {calculations.timesSaved.toLocaleString()}h
                </span>
              </div>
              ...
              <div className="flex items-center justify-between border-border border-b pb-4">
                ...
                <span className="font-bold text-2xl text-white">
                  ${(calculations.revenuIncrease / 1000).toFixed(0)}K+
                </span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-bold text-2xl text-white">
                  ${(calculations.adminReduction / 1000).toFixed(0)}K
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col justify-center">
            <h3 className="mb-8 font-semibold text-3xl text-white md:text-4xl">
              What You'll Get
            </h3>
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  className="group flex items-start gap-4 rounded-xl border border-transparent p-4 transition-all duration-300 hover:border-primary/30 hover:bg-primary/5"
                  key={idx}
                >
...
export function IndustrySolutionsSection() {
  ...
  const industries = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1581578949510-fa7315c4c350?q=80&w=2070&auto=format&fit=crop",
      features: [
        "Recurring service",
        "Supply ordering",
        "Quality checklists",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1558904541-efa843a96f01?q=80&w=2070&auto=format&fit=crop",
      features: [
        "Seasonal contracts",
        "Weather alerts",
        "Equipment logs",
    ...
    <section className="bg-black py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-foreground text-lg md:text-xl">
            Specialized features designed for field service professionals
          </p>
        </div>
        ...
        <div className="group relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-primary/5 to-transparent transition-all duration-500">
          <div className="grid gap-0 lg:grid-cols-2">
            ...
            <div className="relative h-[400px] overflow-hidden lg:h-auto">
              <div
                className={`absolute inset-0 bg-gradient-to-br ${active.color}`}
              />
              <img
                alt={active.name}
                className="absolute inset-0 size-full object-cover opacity-60 grayscale transition-all duration-700 group-hover:scale-105 group-hover:opacity-80 group-hover:grayscale-0"
            ...
            {/* Features */}
            <div className="flex flex-col justify-center p-8 lg:p-12">
              <h3 className="mb-2 font-bold text-3xl text-white md:text-4xl">
                {active.name} Solutions
              </h3>
              <p className="mb-8 text-foreground">
                Everything you need to run your {active.name.toLowerCase()}{" "}
                business
              </p>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {active.features.map((feature, idx) => (
                  <div
                    className="flex items-center gap-3 rounded-xl border border-primary/20 bg-primary/5 p-4 transition-all duration-300 hover:scale-105 hover:border-primary/40 hover:bg-primary/10"
                    key={idx}
                  >
    ...
    <section className="bg-gradient-to-b from-black via-primary/10 to-black py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-foreground text-lg md:text-xl">
            Join the fastest-growing field service platform
          </p>
        </div>

        {/* Stats Grid */}
        <div className="mb-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <div className="group relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/10 to-transparent p-8 transition-all duration-300 hover:scale-105 hover:border-primary/40">
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/10 to-transparent p-8 transition-all duration-300 hover:scale-105 hover:border-primary/40">
            ...
            <div className="mb-2 font-bold text-5xl text-white">
              {(animatedStats.jobsCompleted / 1_000_000).toFixed(1)}M+
            </div>
            ...
            <div
              className={`group relative flex flex-col overflow-hidden rounded-3xl border p-8 transition-all duration-300 ${
                plan.popular
                  ...
                  : "border-border bg-black/50 hover:scale-105 hover:border-primary/30"
              }`}
              key={idx}
            >
              {plan.popular && (
              ...
              <ul className="mb-8 flex-1 space-y-3">
                {plan.features.map((feature, featureIdx) => (
                  <li className="flex items-start gap-3" key={featureIdx}>

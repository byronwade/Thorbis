			...
			<div className="mx-auto max-w-5xl space-y-6 md:space-y-8 p-4 md:p-0">
				...
				<div className="grid gap-4 md:gap-6 grid-cols-1 md:grid-cols-2">
					...
					<div className="border-primary/10 bg-card/50 space-y-3 rounded-lg border p-4 md:p-6 backdrop-blur-sm">
						...
						<h3 className="text-base md:text-lg font-semibold">Real-Time Stock Tracking</h3>
					...
					<div className="border-primary/10 bg-card/50 space-y-3 rounded-lg border p-4 md:p-6 backdrop-blur-sm">
						...
						<h3 className="text-base md:text-lg font-semibold">Usage Analytics</h3>
						<p className="text-muted-foreground text-xs md:text-sm leading-relaxed">
					...
					<div className="border-primary/10 bg-card/50 space-y-3 rounded-lg border p-4 md:p-6 backdrop-blur-sm">
						...
						<h3 className="text-base md:text-lg font-semibold">Cost Tracking</h3>
						<p className="text-muted-foreground text-xs md:text-sm leading-relaxed">

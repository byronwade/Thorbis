	...
	return (
		<SheetPortal>
			...
			<SheetPrimitive.Content
				className={cn(
					"fixed z-50 flex flex-col gap-4 border bg-background transition ease-in-out data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:duration-300 data-[state=open]:duration-500",
					side === "right" &&

...
export function TableFilters({ filters, activeFilters, onFilterChange, showBadge = true }: TableFiltersProps) {
						...
						{filterGroup.options.map((option) => {
							...
							return (
								...
								>
									...
									{option.count !== undefined && <span className="text-muted-foreground text-xs">{option.count}</span>}
								</DropdownMenuItem>
							);
						})}
					</div>

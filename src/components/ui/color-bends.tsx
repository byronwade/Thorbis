...
/**
 * ColorBends - Client Component
 *
 * Client-side features:
 * - Three.js WebGL rendering with shader effects
 * - Mouse tracking and parallax effects
 * - Real-time animation and color manipulation
 * - Interactive pointer movements
 *
 * Performance optimizations:
 * - Efficient WebGL rendering with high-performance mode
...
export default function ColorBends({
	...
	useEffect(() => {
		...
		// Initial size - use requestAnimationFrame to ensure container is in DOM

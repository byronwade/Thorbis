...
function NavigationMenuLink({
	...
	return (
		<NavigationMenuPrimitive.Link
			className={cn(
				"hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground focus-visible:ring-ring/50 data-[active=true]:bg-primary/50 data-[active=true]:text-primary-foreground data-[active=true]:focus:bg-primary data-[active=true]:hover:bg-primary [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4",
				className,
			)}

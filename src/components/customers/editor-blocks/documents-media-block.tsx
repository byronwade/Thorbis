			...
			<NodeViewWrapper className="documents-media-block">
					...
					actions={
						<>
							<input
								...
								type="file"
							/>
							<CollapsibleActionButton icon={<Plus className="h-3.5 w-3.5" />} onClick={handleAddDocument}>
								Add Document
				...
				>
					...
					>
						...
						<p className="mt-2 text-muted-foreground text-sm">Supports images, PDFs, and documents</p>
					</div>
				</CollapsibleDataSection>
			</NodeViewWrapper>
		);
				...
				actions={
					<>
						<input
							...
							type="file"
						/>
						<CollapsibleActionButton icon={<Plus className="size-4" />} onClick={handleAddDocument}>
							Add Document
						</CollapsibleActionButton>
					</>
				}
												...
												>
													<div
														className={cn(
															...
															attachment.is_image && "bg-primary text-primary dark:bg-primary",
															attachment.is_document && "bg-secondary text-muted-foreground dark:bg-foreground",
															attachment.is_video && "bg-accent text-accent-foreground dark:bg-accent"
														)}
													>
													...
													<div className="min-w-0 flex-1">
														<p className="truncate font-medium text-sm">{attachment.original_file_name}</p>
									...
									>
										...
										<div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity group-hover:opacity-100">
											<div className="absolute right-0 bottom-0 left-0 p-2">
												<p className="truncate text-white text-xs">{attachment.original_file_name}</p>
												<p className="text-white/80 text-xs">{new Date(attachment.uploaded_at).toLocaleDateString()}</p>
											</div>
										</div>
									</a>
								))}

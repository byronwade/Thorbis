/**
 * Job Templates Data - Async Server Component
 *
 * Displays job templates content.
...
export async function JobTemplatesData() {
	...
	// const templates = await fetchJobTemplates();
							...
							<div className="flex items-center gap-4 rounded-lg border p-4" key={index}>
								...
								<div className="flex-1 space-y-1">
									<div className="flex items-center gap-2">
										<p className="font-medium text-sm leading-none">{template.name}</p>
										<span

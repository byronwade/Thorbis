...
const formSchema = z.object({
	...
	orgSupportEmail: z.string().email("Please enter a valid email").optional().or(z.literal("")),
	orgSupportPhone: z.string().min(10, "Support phone must be at least 10 digits"),
	orgBrandColor: z
		.string()
...
export function WelcomePageClientAdvanced({
	...
	const trialEndsAt = incompleteCompany?.trialEndsAt ? new Date(incompleteCompany.trialEndsAt) : null;
				...
				<Alert className="mb-8 border-primary/30 bg-primary/5">
					<div className="flex items-start gap-3">
						...
						<div className="space-y-1">
							...
							<AlertDescription className="text-muted-foreground text-sm">{trialBannerDescription}</AlertDescription>
						</div>
					</div>
				</Alert>
							...
							{STEPS.map((step, index) => (
								<div className="flex flex-1 items-center" key={step.id}>
									<div className="flex w-full flex-col items-center">
										...
										>
											{currentStep > step.id ? <Check className="size-7" /> : <step.icon className="size-7" />}
										</div>
										<div className="mt-4 text-center">
											...
											<span className="mt-1 block text-muted-foreground text-xs">{step.description}</span>
										</div>
									</div>
				...
				<Card className="mx-auto mb-10 max-w-4xl border border-primary/20 bg-primary/5 shadow-lg">
					<CardHeader>
						...
						<CardDescription className="text-sm">
							Thorbis provisions Resend for both outbound sending and inbound routing automatically.
						</CardDescription>
					</CardHeader>
							...
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-muted-foreground text-xs">
										{String(emailInfra.domain?.domain ?? "Pending provisioning")}
									</p>
								</div>
						...
						<div className="rounded-lg border border-primary/10 bg-background/80 p-4">
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-muted-foreground text-xs">
										{String(emailInfra.inboundRoute?.route_address ?? "Automatic reply capture pending")}
									</p>
								</div>
								<Badge className="capitalize" variant="secondary">
							...
							<p className="mt-2 text-muted-foreground text-xs">
								Customer replies will flow back into the Communications hub automatically.
							</p>
						</div>
					</CardContent>
				</Card>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem className="sm:col-span-2">
													...
													<FormControl>
														<Input className="h-12 text-base" placeholder="Acme HVAC Services" {...field} />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input className="h-12 text-base" placeholder="Brand name customers know" {...field} />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input className="h-12 text-base" placeholder="87-1234567" {...field} />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input className="h-12 text-base" placeholder="support@yourcompany.com" {...field} />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input className="h-12 text-base" placeholder="(831) 555-1234" {...field} />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem className="sm:col-span-2">
													...
													<FormControl>
														<Input className="h-12 text-base" placeholder="(555) 123-4567" {...field} />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input className="h-12 text-base" placeholder="https://example.com" {...field} />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input className="h-12 text-base" placeholder="12-3456789" {...field} />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
									...
									<div className="grid gap-4 sm:grid-cols-3">
										...
										<Card
											className={cn(
												...
												phoneOption === "purchase" && "border-2 border-primary ring-2 ring-primary/20"
											)}
											onClick={() => {
										...
										<Card
											className={cn(
												"cursor-pointer transition-all hover:shadow-lg",
												phoneOption === "port" && "border-2 border-primary ring-2 ring-primary/20"
											)}
											onClick={() => {
												setPhoneOption("port");
										...
										<Card
											className={cn(
												"cursor-pointer transition-all hover:shadow-lg",
												phoneOption === "existing" && "border-2 border-primary ring-2 ring-primary/20"
											)}
											onClick={() => {
										...
										>
											<CardContent className="flex flex-col items-center justify-center p-8 text-center">
												...
												<p className="text-muted-foreground text-sm">Continue using your current phone system</p>
									...
									<Card className="border-primary/20 bg-primary/5">
										<CardContent className="flex gap-4 p-6">
											...
											<div className="space-y-2">
												...
												<p className="text-muted-foreground text-sm">
													You can skip this step and set up your phone number later in Settings → Communications. Phone
													features include calls, SMS, and VoIP capabilities.
												</p>
											</div>
										</CardContent>
									</Card>
							...
							<div className="mt-12 flex items-center justify-between gap-4 border-t pt-8">
								<div>
									{companyId && currentStep === 1 && !hasActiveCompany && (
										<Button onClick={() => setArchiveDialogOpen(true)} type="button" variant="ghost">
											Cancel Setup
										</Button>
									)}
								</div>
			...
			{editingMember && (
				<TeamMemberEditDialog
					...
					onSave={(updatedMember) => {
						setTeamMembers((prev: ExtendedTeamMember[]) =>
							prev.map((m) => (m.email === updatedMember.email ? updatedMember : m))
						);
						setEditingMember(null);
					}}
					open={true}

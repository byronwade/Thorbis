...
export function TeamMemberEditDialog({ open, onOpenChange, member, onSave }: TeamMemberEditDialogProps) {
					...
					<div className="flex items-center gap-4">
						{photoPreview ? (
							<div className="relative">
								<img alt="Profile preview" className="size-20 rounded-full border object-cover" src={photoPreview} />
								<Button
					...
					<div className="space-y-2">
						...
						>
							...
							<SelectContent>
								...
								<SelectItem value="technician">Technician - View and complete assigned jobs</SelectItem>
							</SelectContent>
						</Select>
					</div>
				</div>

			...
			<div className="rounded-lg border bg-card p-5 space-y-4">
				...
				<div className="space-y-3 text-sm">
					<div className="flex items-start gap-3">
						<Clock className="h-5 w-5 text-muted-foreground flex-shrink-0 mt-0.5" />
						<div>
							<p className="font-medium text-foreground">Standard Timeline: 2-4 weeks</p>
							<p className="text-muted-foreground mt-1">
								This is the industry-standard timeline for all carriers due to federal regulations and verification requirements.
							</p>
						</div>
					</div>
					...
					<div className="flex items-start gap-3">
						...
						<div>
							...
							<p className="text-muted-foreground mt-1">
								We use Telnyx, a professional porting service, to coordinate with {carrier}. The timeline is controlled by {carrier} and federal regulations - not by us or Telnyx.
							</p>
						</div>
					</div>
					...
					<div className="flex items-start gap-3">
						...
						<div>
							...
							<p className="text-muted-foreground mt-1">
								We'll email you with updates throughout the process and notify you immediately when the port is complete. The timeline can vary based on {carrier}'s internal processes and workload. We appreciate your patience!
							</p>
						</div>
					</div>
				</div>
			...
			<div className="space-y-4">
				...
				<div className="rounded-lg border bg-card p-5 space-y-4">
					<div className="flex items-start gap-3">
						...
						<div className="flex-1">
							<p className="text-sm font-semibold text-foreground mb-3">You must do these:</p>
				...
				<div className="rounded-lg border-2 border-destructive bg-destructive/5 p-5 space-y-4">
					<div className="flex items-start gap-3">
						...
						<div className="flex-1">
							<p className="text-sm font-semibold text-destructive mb-3">Never do these (port will fail!):</p>
				...
				<div className="rounded-lg border bg-card p-5 space-y-3">
					<div className="flex items-start gap-3">
						...
						<p className="text-sm font-medium text-foreground">Why does it take 2-4 weeks?</p>
					</div>

...
import { Cloud, CloudOff, Check, Loader2, Info, X, ArrowLeft } from "lucide-react";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";
import { useOnboardingStore, STEP_CONFIG } from "@/lib/onboarding/onboarding-store";
...
export function WelcomeBackBanner({
	...
	const stepConfig = currentStep ? STEP_CONFIG[currentStep as keyof typeof STEP_CONFIG] : null;

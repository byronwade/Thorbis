			...
			<div className="space-y-10">
				...
				<div className="space-y-2">
					...
					<p className="text-muted-foreground">
						Your pricebook powers estimates and invoices. How would you like to get started?
					</p>
				</div>
			...
			<div className="space-y-10">
				...
				<div className="space-y-6">
					<div className="rounded-lg bg-muted/40 p-6 space-y-4">
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<p className="text-sm text-muted-foreground">Sync services, pricing & categories</p>
							</div>
						</div>
					...
					<p className="text-xs text-muted-foreground text-center">
						You'll be redirected to ProfitRhino to authorize access.
						Don't have ProfitRhino?{" "}
						<button
		...
		return (
			<div className="space-y-10">
				...
				<div className="space-y-2">
					...
					<h2 className="text-2xl font-semibold">Start with a blank pricebook</h2>
					<p className="text-muted-foreground">
					...
					<div className="flex items-center gap-3">
						...
						<div>
							...
							<p className="text-sm text-muted-foreground">
								You can create estimates with custom line items, or add services later.
							</p>
						</div>
					</div>
				</div>
	...
	return (
		<div className="space-y-10">
			...
			<div className="space-y-2">
				...
				<p className="text-muted-foreground">
					We've added {data.services.length} {industryLabel} services. Edit prices or add more.
				</p>
			</div>
			...
			<p className="text-xs text-muted-foreground">
				Tip: You can add materials, equipment, and more detailed pricing in Settings → Pricebook
			</p>
		</div>
	);
}

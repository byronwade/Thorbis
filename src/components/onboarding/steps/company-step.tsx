...
const BUSINESS_TYPES = [
	{ value: "sole_proprietor", label: "Sole Proprietor", description: "Individual owner" },
		...
		<div className="space-y-10">
			...
			<div className="space-y-2">
				...
				<p className="text-muted-foreground">
					This information is used for identity verification, bank account setup, and compliance.
				</p>
			</div>
			...
			<div className="space-y-4">
				<div className="flex items-center space-x-2">
					<Checkbox
						...
						onCheckedChange={(v) => updateData({ mailingAddressSame: v as boolean })}
					/>
			...
			<div className="space-y-6">
				<div className="flex items-start gap-3 bg-amber-500/10 rounded-lg p-4">
					...
					<div className="text-sm">
						<p className="font-medium text-foreground">Business verification required</p>
						<p className="text-muted-foreground">
							This information is needed for bank account setup, payment processing, and compliance. All data is encrypted and secure.
						</p>
					</div>
				</div>
				...
				<div className="grid gap-6 sm:grid-cols-2">
					...
					<div className="space-y-2 sm:col-span-2">
						<Label htmlFor="businessLicense">Business License Number (if applicable)</Label>
						<Input
							id="businessLicense"
			...
			<div className="space-y-6">
				<div className="flex items-start gap-3 bg-blue-500/10 rounded-lg p-4">
					...
					<div className="text-sm">
						<p className="font-medium text-foreground">Beneficial owner information</p>
						<p className="text-muted-foreground">
							Required for financial compliance (FinCEN rules). This is the person who owns or controls 25% or more of the business.
						</p>
					</div>
				</div>
			...
			<div className="flex items-start gap-3 text-xs text-muted-foreground bg-muted/40 rounded-lg p-4">
				...
				<p>
					All sensitive information is encrypted with bank-level security (AES-256) and never shared without your consent. Required for payment processing and compliance with FinCEN regulations.
				</p>
			</div>
		</div>
	);

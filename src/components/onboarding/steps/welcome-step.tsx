...
import { User, Users, Building2, Building, Check, Sparkles, Clock, TrendingUp, Shield, Phone, Calendar, ArrowRight } from "lucide-react";
...
export function WelcomeStep() {
	...
	const industryInsight = data.industry ? INDUSTRY_INSIGHTS[data.industry] : null;
	...
	return (
		<div className="space-y-10">
			...
			<div className="space-y-4">
				<label className="text-sm font-medium text-muted-foreground">
					How did you hear about us? <span className="text-muted-foreground/60">(optional)</span>
				</label>
				<Select
				...
				<div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
					...
					<div className="flex-1 space-y-1">
						...
						<p className="text-sm text-blue-700 dark:text-blue-300">
							Schedule a free 30-minute call with our onboarding team. We'll help you
							migrate data, configure settings, and get your team trained.
						</p>
					</div>
					<Button
						variant="outline"
						className="shrink-0 border-blue-300 dark:border-blue-700 hover:bg-blue-100 dark:hover:bg-blue-900"
						onClick={() => window.open("https://calendly.com/thorbis/onboarding", "_blank")}
					>

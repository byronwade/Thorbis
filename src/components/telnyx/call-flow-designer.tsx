			...
			<Card className="border-dashed">
				<CardContent className="flex flex-col items-center justify-center py-12 text-center">
					...
					<p className="mb-6 max-w-sm text-muted-foreground text-sm">
						Design complex call routing with our drag-and-drop flow builder. Create IVR menus, conditional routing, and
			...
			<Card className="border-primary/50 bg-primary/5">
				<CardContent className="flex items-start gap-3 pt-6">
					...
					<div className="space-y-1">
						<p className="font-medium text-primary text-sm dark:text-primary">Flow Design Best Practices</p>
						<p className="text-muted-foreground text-sm">
							Keep IVR menus simple with 3-4 options maximum. Always provide an option to reach a live person. Test your
							flows before publishing. Use clear, concise voice prompts. Consider peak hours when designing call
							capacity.
						</p>
					</div>
				</CardContent>

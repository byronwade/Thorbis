						...
						<TableBody>
							{serviceRows.map((row) => (
								<TableRow key={row.service}>
									...
									<TableCell className="text-xs text-muted-foreground">{row.rate}</TableCell>
			...
			<Card>
				...
				<CardContent>
					{phoneNumbers.length === 0 ? (
						<div className="flex h-[200px] items-center justify-center text-muted-foreground">No phone numbers configured</div>
					) : (
						<Table>
							<TableHeader>
								<TableRow>

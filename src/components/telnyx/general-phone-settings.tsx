				...
				<Card>
					...
					<CardContent className="space-y-4">
						<div>
							...
							/>
							<p className="mt-1 text-muted-foreground text-xs">Displayed to customers and used for caller ID</p>
						</div>
						...
						<div>
							<Label className="flex items-center gap-2 font-medium text-sm">
								...
								<Tooltip>
									...
									<TooltipContent>
										<p className="max-w-xs">Number to forward calls when all team members are unavailable</p>
									</TooltipContent>
								</Tooltip>
							</Label>
							<Input
							...
							/>
							<p className="mt-1 text-muted-foreground text-xs">Emergency or on-call number when no agents available</p>
						</div>
					</CardContent>
				</Card>
					...
					<CardContent className="space-y-4">
						<div>
							...
							<p className="mt-1 text-muted-foreground text-xs">
								{settings.routingStrategy === "round_robin" && "Distribute calls evenly across available team members"}
								{settings.routingStrategy === "simultaneous" && "Ring all available team members at once"}
								{settings.routingStrategy === "longest_idle" &&
									"Route to team member who hasn't received a call the longest"}
								{settings.routingStrategy === "skills_based" && "Route based on agent skills and expertise"}
							</p>
						</div>
						...
						<div>
							...
							<Select
								onValueChange={(value) => updateSetting("maxConcurrentCalls", Number.parseInt(value, 10))}
							...
							<p className="mt-1 text-muted-foreground text-xs">Maximum number of simultaneous calls per team member</p>
						</div>
						...
						<div className="flex items-center justify-between">
							<div className="flex-1">
								...
								<p className="text-muted-foreground text-xs">Enforce business hours for call routing</p>
							</div>
							<Switch
					...
					<CardContent className="space-y-4">
						<div className="flex items-center justify-between">
							<div className="flex-1">
								...
								<p className="text-muted-foreground text-xs">Record calls for quality and training</p>
							</div>
							<Switch
											...
											<Tooltip>
												...
												<TooltipContent>
													<p className="max-w-xs">
														Play "This call may be recorded" message (required by law in most states)
													</p>
												</TooltipContent>
											</Tooltip>
										</Label>
										<p className="text-muted-foreground text-xs">Notify caller that call is recorded</p>
									</div>
									<Switch
							...
							<>
								...
								<div className="flex items-center justify-between">
									<div className="flex-1">
										...
										<p className="text-muted-foreground text-xs">Send email when voicemail received</p>
									</div>
									<Switch
								...
								<div className="flex items-center justify-between">
									<div className="flex-1">
										<Label className="font-medium text-sm">Voicemail Transcription</Label>
										<p className="text-muted-foreground text-xs">Auto-transcribe voicemail to text</p>
									</div>
									<Switch
				...
				<Card className="border-primary/50 bg-primary/5">
					<CardContent className="flex items-start gap-3 pt-6">
						...
						<div className="space-y-1">
							<p className="font-medium text-primary text-sm dark:text-primary">Phone System Best Practices</p>
							<p className="text-muted-foreground text-sm">
								Always disclose call recording when enabled. Configure business hours in the Hours tab for accurate
								routing. Set up team member extensions for direct dialing. Use the fallback number for after-hours
								emergencies.
							</p>
						</div>
					</CardContent>

/**
 * Weekly Stats Widget - Fully Responsive
 *
 * Responsive stages:
...
export function WeeklyStatsWidget({ data }: WeeklyStatsWidgetProps) {
	return (
		<ResponsiveWidgetWrapper className="bg-gradient-to-br from-purple-500/10 to-purple-500/5">
					...
					<div className="space-y-2">
						...
						<div className="flex items-center justify-between">
							<div className="flex items-center gap-1.5">
								<DollarSign className="text-accent-foreground size-3.5" />

 ...
 */
export function convertLegacySize(legacySize: "small" | "medium" | "large" | "full" | string): WidgetGridSize {
	switch (legacySize) {
		case "small":
		case "1x1":
 ...
 */
export function constrainWidgetSize(requestedSize: WidgetGridSize, dimensions: GridDimensions): WidgetGridSize {
	return {

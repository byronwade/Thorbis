...
const sidebarGroups: SidebarGroup[] = [
  ...
  },
  {
    ...
    items: [
      { title: "Google Business Profile", href: "/tools/marketing/google-business", badge: "Essential" },
      { title: "Local Services Ads", href: "/tools/marketing/local-services", badge: "Recommended" },
  ...
  },
  {
    ...
    items: [
      { title: "Business Registration", href: "/tools/business/registration", badge: "Required" },
      { title: "Licensing & Permits", href: "/tools/business/licensing", badge: "Required" },
      { title: "Business Insurance", href: "/tools/business/insurance", badge: "Essential" },
  ...
  },
  {
    ...
    items: [
      { title: "Consumer Financing", href: "/tools/financing/consumer", badge: "Popular" },
  ...
  },
  {
    ...
    items: [
      { title: "Nexstar Network", href: "/tools/networks/nexstar", badge: "Premium" },
      { title: "Service Nation", href: "/tools/networks/service-nation", badge: "Premium" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "OSHA Safety Training", href: "/tools/training/osha", badge: "Required" },
  ...
  },
  {
    ...
    items: [
      { title: "Hourly Rate Calculator", href: "/tools/calculators/hourly-rate", badge: "Popular" },
      { title: "Job Pricing Calculator", href: "/tools/calculators/job-pricing", badge: "Essential" },
      { title: "Profit & Loss Calculator", href: "/tools/calculators/profit-loss", badge: "Popular" },
      ...
      { title: "Industry Pricing Standards", href: "/tools/calculators/industry-pricing", badge: "Premium" },
    ],
  },
  {
    label: "Resources",

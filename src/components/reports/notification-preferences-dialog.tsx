					...
					<div className="grid gap-6 lg:grid-cols-2">
						...
						<div className="space-y-4">
							<div className="flex items-center justify-between">
								<div>
									<Label className="text-base font-semibold">Alert Conditions</Label>
							...
							<div className="space-y-3 max-h-[300px] overflow-y-auto pr-2">
								{alerts.map((alert) => (
									...
									>
										...
										<Select
											value={alert.metric}
											onValueChange={(v) => updateAlert(alert.id, { metric: v })}
										>
										...
										<Select
											...
											onValueChange={(v) => updateAlert(alert.id, { operator: v as any })}
										>
										...
										<Input
											type="number"
											value={alert.value}
											onChange={(e) => updateAlert(alert.id, { value: parseFloat(e.target.value) || 0 })}
									...
									<div className="flex items-center justify-between py-2 border-t">
										<div className="flex items-center gap-3">
											...
											<div>
												...
												<p className="text-xs text-muted-foreground">Text message for urgent alerts</p>
											</div>
										</div>

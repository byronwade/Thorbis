...
export const LazyMotionSvg = dynamic<any>(() => import("framer-motion").then((mod) => mod.motion.svg), {
	ssr: false,
	loading: () => <MotionLoadingPlaceholder as="svg" />,
});

// Lazy load motion.path
export const LazyMotionPath = dynamic<any>(() => import("framer-motion").then((mod) => mod.motion.path), {
	ssr: false,

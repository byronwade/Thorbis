        ...
        <main className="mt-16 space-y-20">
          <section className="space-y-8">
            <div className="mx-auto max-w-3xl text-center space-y-3">
              ...
              <p className="text-muted-foreground">
                A proven implementation methodology honed with hundreds of contractors moving from ServiceTitan, Housecall Pro, Jobber, and custom tools.
              </p>
            </div>
            <div className="grid gap-6 lg:grid-cols-3">
              {PHASES.map((phase) => {
                ...
                return (
                  <Card key={phase.title} className="border-primary/30 bg-primary/5">
          ...
          <section className="space-y-6">
            <div className="mx-auto max-w-3xl text-center space-y-3">
              ...
              <p className="text-muted-foreground">
                Technicians, dispatchers, finance, and leadership receive tailored instruction through live sessions and on-demand content.
              </p>
            </div>
          ...
          <section className="space-y-8">
            <div className="mx-auto max-w-3xl text-center space-y-3">
              <h2 className="text-3xl font-semibold">Success packages designed for every growth stage</h2>
              <p className="text-muted-foreground">
                Choose the support level that matches your expansion plans. All packages include proactive guidance and metrics reviews.
              </p>
            </div>
            <div className="grid gap-6 lg:grid-cols-3">
            ...
            <Card className="bg-primary/5">
              <CardContent className="flex h-full flex-col justify-center space-y-4 p-8">
                ...
                <p className="text-2xl font-semibold">
                  “Thorbis migrated our multi-branch ServiceTitan deployment in 42 days. Dispatchers were live day one, and AI booking added 11% more jobs in the first month.”
                </p>
                <p className="text-muted-foreground">

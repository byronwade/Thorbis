...
const TIMELINE_STEPS = [
	{
		...
		description: "Kickoff, data exports, and configuration workshops. Thorbis builds your environment while reconciling data.",
		icon: ClipboardCheck,
	},
	{
		week: "Week 3",
		title: "Workflow Testing",
		description: "Workflow testing in a staging environment, plus dispatcher and technician training with live feedback.",
		icon: Settings,
	},
	{
		week: "Week 4",
		title: "Final Prep",
		description: "Final data sync, go-live planning, and customer communications.",
		icon: FileCheck,
	},
	{
		week: "Week 5-6",
		title: "Launch & Optimize",
		description: "Cutover weekend, daily huddles, KPI tracking, and optimization sessions with Thorbis success coaches.",
		icon: Rocket,
	},
];
			...
			<div className="container mx-auto space-y-20 px-4 py-16 sm:px-6 lg:px-8">
					...
					<div className="mx-auto max-w-4xl space-y-6 text-center">
						...
						<div className="border-border/50 flex flex-wrap items-center justify-center gap-6 border-t pt-6">
							<div className="flex items-center gap-2">
								...
								<span className="text-muted-foreground text-sm">45-day go-live</span>
							</div>
							<div className="flex items-center gap-2">
								<CheckCircle className="size-5 text-orange-600 dark:text-orange-400" />
								<span className="text-muted-foreground text-sm">Dedicated migration team</span>
							</div>
							<div className="flex items-center gap-2">
								<CheckCircle className="size-5 text-orange-600 dark:text-orange-400" />
								<span className="text-muted-foreground text-sm">Zero data loss</span>
							</div>
						</div>
				...
				<section className="space-y-8">
					<div className="text-center max-w-3xl mx-auto">
						...
						<p className="text-muted-foreground mt-4 text-lg">
							Everything you need to switch platforms without disrupting operations.
						</p>
					</div>
				...
				<section className="space-y-8">
					...
					<div className="grid gap-6 md:grid-cols-3">
						{competitorComparisons.map((comparison) => (
							<Card className="h-full border-2 hover:border-primary/30 transition-all hover:shadow-lg" key={comparison.slug}>
								<CardHeader>
						...
						{TIMELINE_STEPS.map((step, index) => {
							...
							return (
								<div
									...
									key={step.week}
								>
									<div className={`flex size-12 items-center justify-center rounded-xl mb-4 ${bgColors[index]}`}>
										<Icon className={`size-6 ${textColors[index]}`} />
									</div>
									<p className={`text-sm font-bold uppercase mb-1 ${textColors[index]}`}>
										{step.week}
									</p>
					...
					<Card className="border-2 hover:border-primary/30 transition-all">
						...
						<CardContent className="space-y-4">
							<p className="text-muted-foreground leading-relaxed">
								You'll work with dedicated specialists who understand field service operations:
							</p>
							<ul className="text-muted-foreground space-y-2 text-sm">
								<li>• Migration Engineer - handles data and configuration</li>
								<li>• Solution Architect - designs workflows and automations</li>
				...
				<section className="space-y-8">
					<div className="mx-auto max-w-3xl space-y-4 text-center">
						...
						<h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Migration FAQ</h2>

...
export const metadata = generateSEOMetadata({
	...
	path: "/case-studies",
	keywords: ["field service case study", "hvac software success story", "plumbing business automation"],
});
		...
		<>
			...
			<div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
				<header className="mx-auto mb-16 max-w-3xl text-center">
					...
					<h1 className="mb-6 font-bold text-4xl tracking-tight sm:text-5xl">Field Teams Winning with Thorbis</h1>
					<p className="text-lg text-muted-foreground">
						Discover how high-performing service companies reduce windshield time, improve first-time fix rate, and grow
						recurring revenue with the Thorbis field management platform—all for a $100/month base subscription,
						pay-as-you-go usage, and no lock-in.
					</p>
				</header>
				...
				{caseStudies.length ? (
					...
					<div className="rounded-xl border border-dashed bg-muted/20 p-12 text-center">
						<h2 className="mb-3 font-semibold text-xl">More stories are on the way</h2>
						<p className="text-muted-foreground">
							We&apos;re putting the finishing touches on additional customer highlights. Check back soon or connect

...
export default async function ContractSignSuccessPage({ params }: { params: Promise<{ id: string }> }) {
			...
			<div className="mx-auto max-w-2xl px-4 py-16">
				...
				<Card className="border-success bg-success/50 dark:border-success/50 dark:bg-success/20">
					<CardContent className="flex flex-col items-center py-12">
						...
						<h1 className="mt-6 font-bold text-3xl text-success dark:text-success">Contract Signed Successfully!</h1>
					...
					<CardContent className="flex items-start gap-4 py-6">
						...
						<div className="flex-1">
							...
							<p className="text-muted-foreground text-sm">
								A copy of the signed contract has been sent to your email address. Please check your inbox (and spam
								folder) for the confirmation.
							</p>
						</div>
					</CardContent>
				</Card>
				...
				<div className="mt-8 text-center">
					<p className="text-muted-foreground text-xs">
						This electronically signed document is legally binding. A copy has been recorded with a timestamp and your
						IP address for verification purposes. If you have any questions, please contact the service provider.
					</p>
				</div>
			</div>
		</div>

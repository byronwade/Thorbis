...
export const metadata = generateSEOMetadata({
	...
	description: "Connect with Thorbis sales, support, or partnerships. Our team responds within one business day.",
	path: "/contact",
	section: "Company",
		...
		<>
			...
			<div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
				<section className="max-w-2xl space-y-6">
					...
					<h1 className="font-bold text-4xl tracking-tight sm:text-5xl">We’re here to help</h1>
					<p className="text-lg text-muted-foreground leading-relaxed">
						Whether you’re exploring Thorbis, need support, or want to partner, our team responds quickly. Pricing stays
						simple—$100/month base subscription with pay-as-you-go usage, unlimited users, no contracts, no lock-in.
						Choose the option that fits and we’ll get back within one business day.
					</p>
					...
					{CONTACT_OPTIONS.map((option) => (
						<Card key={option.title}>
							...
							<CardContent className="space-y-2 text-muted-foreground text-sm">
								<p>
									Email:{" "}
									<a className="text-primary underline-offset-4 hover:underline" href={`mailto:${option.email}`}>
										{option.email}
									</a>
								</p>
				...
				<section className="mt-16 rounded-3xl border bg-muted/20 p-10">
					...
					<p className="mt-2 text-muted-foreground text-sm leading-relaxed">
						Thorbis operates remotely with hubs in Austin, Denver, and Toronto. All visits are by appointment—reach out
						to coordinate an onsite workshop.
					</p>
				</section>
			</div>
		</>

...
import { Calculator, TrendingUp, Clock, DollarSign, Users, ArrowRight, Share2, Copy, Check } from "lucide-react";
...
const IMPROVEMENTS = {
	...
	adminTimeReduction: 0.40, // 40% admin time saved
...
export default function ROICalculatorPage() {
	...
	const results = useMemo(() => {
		...
		// Current state
		const currentMonthlyJobs = inputs.technicians * inputs.jobsPerDay * workingDaysPerMonth;
		...
		const improvedJobsPerDay = inputs.jobsPerDay * (1 + IMPROVEMENTS.jobsPerDayIncrease);
		const improvedMonthlyJobs = inputs.technicians * improvedJobsPerDay * workingDaysPerMonth;
		...
		const improvedAdminHours = inputs.adminHoursPerWeek * (1 - IMPROVEMENTS.adminTimeReduction);
		...
		return {
			...
			adminHoursSaved: Math.round((inputs.adminHoursPerWeek - improvedAdminHours) * 4),
		};
	}, [inputs]);
	...
	const structuredData = {
		...
		description: "Calculate your potential ROI from switching to Thorbis field service management software. Free interactive tool for HVAC, plumbing, and electrical contractors.",
	};
			...
			<div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
				...
				<div className="mx-auto max-w-3xl text-center mb-12">
					...
					<p className="text-lg text-muted-foreground">
						See how much your business could save and earn with Thorbis.
						Enter your numbers below to calculate your potential return on investment.
					</p>
				</div>
					...
					<Card>
						...
						<CardContent className="space-y-6">
							<div className="space-y-2">
								<Label htmlFor="technicians" className="flex items-center gap-2">
								...
								<div className="flex items-center gap-4">
									<Slider
										...
										className="flex-1"
									/>
									<span className="w-12 text-right font-medium">{inputs.technicians}</span>
								</div>
							</div>
							...
							<div className="space-y-2">
								...
								<div className="flex items-center gap-4">
									<Slider
										...
										className="flex-1"
									/>
									<span className="w-12 text-right font-medium">{inputs.jobsPerDay}</span>
								</div>
							</div>
							...
							<div className="space-y-2">
								...
								<div className="flex items-center gap-4">
									<Slider
										...
										onValueChange={([value]) =>
											setInputs((prev) => ({ ...prev, adminHoursPerWeek: value }))
										}
										className="flex-1"
									/>
									<span className="w-12 text-right font-medium">{inputs.adminHoursPerWeek}h</span>
								</div>
							</div>
						</CardContent>
					</Card>
					...
					<div className="space-y-6">
							...
							<CardContent>
								<div className="text-center py-4">
									...
									<div className="mt-2 text-2xl font-semibold text-green-600">
										{results.roi > 0 ? `${Math.round(results.roi)}% ROI` : "Calculate your ROI"}
									</div>
								</div>
							</CardContent>
						</Card>
						...
						<div className="grid gap-4 sm:grid-cols-2">
							...
							<Card>
								<CardContent className="pt-6">
									<div className="text-3xl font-bold text-blue-600">
										{formatCurrency(results.softwareSavings > 0 ? results.softwareSavings : 0)}
									</div>
									<div className="text-sm text-muted-foreground">
							...
							<CardContent className="pt-6">
								<div className="text-center space-y-4">
									...
									<p className="text-sm text-muted-foreground">
										Thorbis: <strong>$200/month</strong> flat rate, unlimited users
									</p>
								</div>
							</CardContent>
						</Card>
				...
				<div className="max-w-3xl mx-auto mt-16">
					<h2 className="text-2xl font-semibold mb-4">How We Calculate Your ROI</h2>
					<div className="prose prose-sm text-muted-foreground">
						<p>
							Our ROI calculator uses industry-standard improvement factors based on
							data from thousands of field service businesses:
						</p>
						<ul>
							<li>
								<strong>15% more jobs per day</strong> - AI-powered scheduling and
								route optimization reduces drive time and eliminates scheduling gaps
							</li>
							<li>
								<strong>12% higher average tickets</strong> - Good-better-best pricing
								options and built-in upsell prompts increase ticket values
							</li>
							<li>
								<strong>40% less admin time</strong> - Automated invoicing, scheduling,
								and customer communication reduce manual work
							</li>
							<li>
								<strong>25% fewer missed calls</strong> - AI call handling ensures
								every opportunity is captured, even after hours
							</li>
						</ul>
						<p>

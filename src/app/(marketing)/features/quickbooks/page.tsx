				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="text-muted-foreground mx-auto mb-8 max-w-2xl text-lg sm:text-xl">
							Stop wasting hours on double entry. Thorbis syncs bidirectionally with QuickBooks in
							real-time, keeping your financials accurate without the manual work.
						</p>
					...
					<div className="relative mx-auto mt-20 max-w-6xl">
								...
								<div className="space-y-3 p-6">
									<div className="rounded-lg border border-green-500/30 bg-green-500/5 p-3">
										<div className="mb-2 flex items-center gap-2">
											...
											<span className="text-sm font-semibold">Invoice Created</span>
										</div>
									...
									<div className="rounded-lg border border-purple-500/30 bg-purple-500/5 p-3">
										<div className="mb-2 flex items-center gap-2">
											...
											<span className="text-sm font-semibold">Expense Logged</span>
										</div>
								...
								<div className="space-y-3 p-6">
									<div className="rounded-lg border border-green-500/30 bg-green-500/5 p-3">
										<div className="mb-2 flex items-center gap-2">
											...
											<span className="text-sm font-semibold">Invoice Synced</span>
										</div>
									...
									<div className="rounded-lg border border-blue-500/30 bg-blue-500/5 p-3">
										<div className="mb-2 flex items-center gap-2">
											...
											<span className="text-sm font-semibold">Payment Applied</span>
										</div>
									...
									<div className="rounded-lg border border-purple-500/30 bg-purple-500/5 p-3">
										<div className="mb-2 flex items-center gap-2">
											...
											<span className="text-sm font-semibold">Expense Recorded</span>
										</div>
						...
						<div className="mt-8 grid gap-4 sm:grid-cols-3">
							<div className="bg-background rounded-xl border p-4 text-center">
								<div className="text-primary mb-1 text-2xl font-bold">Real-time</div>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
						<div className="text-center">
							...
							<div className="text-muted-foreground text-sm font-medium">Saved Per Month</div>
						</div>
						<div className="text-center">
							<div className="text-primary mb-2 text-4xl font-bold">99.9%</div>
							<div className="text-muted-foreground text-sm font-medium">Sync Accuracy</div>
						</div>
						<div className="text-center">
							<div className="text-primary mb-2 text-4xl font-bold">&lt; 5 min</div>
							<div className="text-muted-foreground text-sm font-medium">Setup Time</div>
						</div>
						<div className="text-center">
								...
								<div className="space-y-4">
									<div className="bg-muted/30 rounded-lg border p-4">
										<div className="mb-2 flex items-center gap-2">
											...
											<span className="text-sm font-semibold">Invoices & Estimates</span>
										</div>
									...
									<div className="bg-muted/30 rounded-lg border p-4">
										<div className="mb-2 flex items-center gap-2">
											...
											<span className="text-sm font-semibold">Payments & Deposits</span>
										</div>
										<ul className="text-muted-foreground ml-7 space-y-1 text-sm">
									...
									<div className="bg-muted/30 rounded-lg border p-4">
										<div className="mb-2 flex items-center gap-2">
											<FileText className="text-primary size-5" />
											<span className="text-sm font-semibold">Expenses & Bills</span>
										</div>
										<ul className="text-muted-foreground ml-7 space-y-1 text-sm">
									...
									<div className="bg-muted/30 rounded-lg border p-4">
										<div className="mb-2 flex items-center gap-2">
											...
											<span className="text-sm font-semibold">Customers & Jobs</span>
										</div>
										<ul className="text-muted-foreground ml-7 space-y-1 text-sm">
								...
								<div className="space-y-4">
									<div className="bg-muted/30 rounded-lg border p-4">
										<div className="mb-2 flex items-center gap-2">
											...
											<span className="text-sm font-semibold">Chart of Accounts</span>
										</div>
										<ul className="text-muted-foreground ml-7 space-y-1 text-sm">
									...
									<div className="bg-muted/30 rounded-lg border p-4">
										<div className="mb-2 flex items-center gap-2">
											...
											<span className="text-sm font-semibold">Customer Updates</span>
										</div>
										<ul className="text-muted-foreground ml-7 space-y-1 text-sm">
									...
									<div className="bg-muted/30 rounded-lg border p-4">
										<div className="mb-2 flex items-center gap-2">
											...
											<span className="text-sm font-semibold">Financial Data</span>
										</div>
										<ul className="text-muted-foreground ml-7 space-y-1 text-sm">
						...
						<Card className="border-primary/20 from-primary/5 overflow-hidden bg-gradient-to-br to-transparent">
							<CardContent className="p-8 sm:p-12">
								...
								<blockquote className="text-lg leading-relaxed">
									"Before Thorbis, our bookkeeper spent 15 hours a month manually entering data into
									QuickBooks. Now it's all automatic. Our books are always current, our accountant
									is happy, and we saved enough to hire another technician."
								</blockquote>

import { ArrowRight, BarChart3, Building2, CheckCircle2, DollarSign, FileText, Mail, MessageSquare, Phone, Target, TrendingUp, Users, Zap } from "lucide-react";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground sm:text-xl">
              A CRM that actually understands service businesses. Track every touchpoint, 
              automate follow-ups, and close more deals with intelligent insights.
            </p>
          ...
          <div className="relative mx-auto mt-20 max-w-6xl">
            <div className="overflow-hidden rounded-2xl border border-border/50 bg-background shadow-2xl">
              {/* Pipeline Header */}
              <div className="flex items-center justify-between border-b border-border/50 bg-gradient-to-r from-primary/5 to-transparent px-6 py-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="rounded-lg border border-yellow-500/30 bg-yellow-500/5 p-3">
                      <div className="mb-2 flex items-start justify-between">
                        <div className="flex size-8 items-center justify-center rounded-full bg-yellow-500/20 font-semibold text-yellow-600 text-xs">
                          TC
                        </div>
              ...
              <div className="grid grid-cols-4 gap-4 border-t border-border/50 bg-muted/20 px-6 py-4">
                <div>
            ...
            {/* Floating AI Insight */}
            <div className="absolute -right-4 top-1/4 hidden max-w-xs rounded-xl border border-primary/50 bg-background p-4 shadow-2xl lg:block">
              <div className="mb-2 flex items-center gap-2">
              ...
              <p className="text-muted-foreground text-xs leading-relaxed">
                ...
                <span className="font-medium text-foreground"> Recommend follow-up call today</span> 

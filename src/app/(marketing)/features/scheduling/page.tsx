		...
		<>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground sm:text-xl">
							Drag-and-drop scheduling boards with AI-powered route optimization. Keep every truck profitable and every
							customer happy.
						</p>
					...
					<div className="relative mx-auto mt-16 max-w-6xl">
						...
						<div className="-left-4 absolute top-1/4 hidden rounded-xl border border-border/50 bg-background p-4 shadow-xl lg:block">
							<div className="mb-2 font-semibold text-muted-foreground text-xs">Today's Metrics</div>
							<div className="space-y-2">
								<div className="flex items-center gap-2">
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
						<div className="text-center">
							...
							<div className="font-medium text-muted-foreground text-sm">More Jobs Per Day</div>
						</div>
						<div className="text-center">
							<div className="mb-2 font-bold text-4xl text-primary">2.5 hrs</div>
							<div className="font-medium text-muted-foreground text-sm">Saved Per Tech Daily</div>
						</div>
						<div className="text-center">
							<div className="mb-2 font-bold text-4xl text-primary">90%</div>
							<div className="font-medium text-muted-foreground text-sm">On-Time Arrival Rate</div>
						</div>
						<div className="text-center">
							<div className="mb-2 font-bold text-4xl text-primary">$18K</div>
							<div className="font-medium text-muted-foreground text-sm">Avg. Monthly Savings</div>
						</div>
					</div>
				</div>
			</section>
			...
			<section className="py-20">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mb-12 text-center">
						<h2 className="mb-4 font-bold text-3xl tracking-tight sm:text-4xl">Built for modern dispatch teams</h2>
					...
					<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>See exactly where every tech is in real-time with ETA updates</CardDescription>
							</CardHeader>
							<CardContent>
								<ul className="space-y-2 text-sm">
									<li className="flex items-start gap-2">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>Keep customers informed with automatic SMS and email notifications</CardDescription>
							</CardHeader>
							<CardContent>
								<ul className="space-y-2 text-sm">
									<li className="flex items-start gap-2">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>Forecast demand and optimize crew size for maximum profitability</CardDescription>
							</CardHeader>
							<CardContent>
								<ul className="space-y-2 text-sm">
									<li className="flex items-start gap-2">
			...
			<section className="bg-gradient-to-br from-primary via-primary to-primary/90 py-20 text-primary-foreground">
				<div className="container mx-auto px-4 text-center sm:px-6 lg:px-8">
					<h2 className="mb-4 font-bold text-3xl tracking-tight sm:text-4xl">Ready to optimize your dispatch?</h2>

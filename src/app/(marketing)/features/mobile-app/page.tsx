		...
		<>
						...
						<div className="relative mx-auto w-full max-w-sm lg:max-w-md">
							<div className="relative">
												...
												<div className="space-y-3 p-4">
													...
													<div className="space-y-2">
														...
														<div className="flex items-center gap-2">
															...
															<span className="text-sm line-through opacity-60">Check refrigerant</span>
														</div>
														<div className="flex items-center gap-2">
															<div className="size-5 rounded-full border-2 border-border" />
															<span className="font-medium text-sm">Replace filter</span>
														</div>
														<div className="flex items-center gap-2">
															<div className="size-5 rounded-full border-2 border-border" />
								...
								<div className="-right-4 absolute top-20 flex items-center gap-2 rounded-full border border-orange-500/50 bg-orange-500/10 px-4 py-2 backdrop-blur-sm">
									...
									<span className="font-semibold text-orange-700 text-xs dark:text-orange-400">Offline Mode</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
						<div className="text-center">
							...
							<div className="font-medium text-muted-foreground text-sm">Offline Capable</div>
						</div>
						<div className="text-center">
							<div className="mb-2 font-bold text-4xl text-primary">45 min</div>
							<div className="font-medium text-muted-foreground text-sm">Faster Job Completion</div>
						</div>
						<div className="text-center">
							<div className="mb-2 font-bold text-4xl text-primary">95%</div>
							<div className="font-medium text-muted-foreground text-sm">Tech Adoption Rate</div>
						</div>
						<div className="text-center">
							<div className="mb-2 font-bold text-4xl text-primary">Zero</div>
							<div className="font-medium text-muted-foreground text-sm">Paperwork Delays</div>
						</div>
					</div>
				</div>
			</section>
			...
			<section className="py-20">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mb-12 text-center">
						<h2 className="mb-4 font-bold text-3xl tracking-tight sm:text-4xl">Built for the field, not the office</h2>
					...
					<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>Customizable checklists that ensure nothing gets missed on every job</CardDescription>
							</CardHeader>
							<CardContent>
								<ul className="space-y-2 text-sm">
									<li className="flex items-start gap-2">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>One-tap navigation to job sites with real-time traffic updates</CardDescription>
							</CardHeader>
							<CardContent>
								<ul className="space-y-2 text-sm">
									<li className="flex items-start gap-2">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>Accept credit cards, checks, and cash right from the mobile app</CardDescription>
							</CardHeader>
							<CardContent>
								<ul className="space-y-2 text-sm">
									<li className="flex items-start gap-2">
			...
			<section className="bg-gradient-to-br from-primary via-primary to-primary/90 py-20 text-primary-foreground">
				<div className="container mx-auto px-4 text-center sm:px-6 lg:px-8">
					<h2 className="mb-4 font-bold text-3xl tracking-tight sm:text-4xl">Empower your field team today</h2>

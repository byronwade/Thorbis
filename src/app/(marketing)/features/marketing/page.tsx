		...
		<>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground sm:text-xl">
							Stop losing customers to competitors. Automated campaigns that nurture leads, generate 5-star reviews, and
							bring customers back—all on autopilot.
						</p>
									...
									<div className="grid items-center gap-6 p-6 lg:grid-cols-[1fr_auto_2fr]">
										...
										<div className="space-y-2">
											...
											<div className="rounded-lg border bg-background/50 p-3">
												...
												<p className="text-muted-foreground text-xs">"Still need help? Click here to schedule..."</p>
											</div>
										</div>
									</div>
								</div>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
						<div className="text-center">
							...
							<div className="font-medium text-muted-foreground text-sm">Avg. Review Rating</div>
						</div>
						<div className="text-center">
							<div className="mb-2 font-bold text-4xl text-primary">3.2x</div>
							<div className="font-medium text-muted-foreground text-sm">More Reviews Generated</div>
						</div>
						<div className="text-center">
							<div className="mb-2 font-bold text-4xl text-primary">42%</div>
							<div className="font-medium text-muted-foreground text-sm">Higher Lead Conversion</div>
						</div>
						<div className="text-center">
							<div className="mb-2 font-bold text-4xl text-primary">$32K</div>
							<div className="font-medium text-muted-foreground text-sm">Avg. Annual Revenue Lift</div>
						</div>
					</div>
				</div>
			</section>
					...
					<div className="grid gap-8 lg:grid-cols-2">
						...
						<Card className="overflow-hidden">
							<CardHeader className="bg-gradient-to-br from-yellow-500/10 to-transparent">
								...
								<CardDescription>Turn happy customers into 5-star reviews automatically</CardDescription>
							</CardHeader>
							...
							<CardContent className="pt-6">
								...
								<div className="rounded-lg border border-blue-500/30 bg-blue-500/5 p-4">
									...
									<div className="grid grid-cols-2 gap-4 text-center">
										...
										<div>
											<div className="font-bold text-blue-600 text-xl">14 days</div>
						...
						<Card className="overflow-hidden">
							...
							<CardContent className="pt-6">
								<div className="mb-6 space-y-3">
									...
									<div className="flex items-start gap-3">
										...
										<div>
											...
											<p className="text-muted-foreground text-xs">Email, SMS, and postcard series over 30 days</p>
										</div>
									</div>
									<div className="flex items-start gap-3">
										<div className="flex size-6 shrink-0 items-center justify-center rounded-full bg-primary/10 font-semibold text-primary text-xs">
								...
								<div className="rounded-lg border border-purple-500/30 bg-purple-500/5 p-4">
									...
									<div className="grid grid-cols-2 gap-4 text-center">
										<div>
											<div className="font-bold text-purple-600 text-xl">28%</div>
											<div className="text-muted-foreground text-xs">Reactivation Rate</div>
										</div>
										<div>
											<div className="font-bold text-purple-600 text-xl">$8.2K</div>
							...
							<CardContent className="pt-6">
								...
								<div className="rounded-lg border border-green-500/30 bg-green-500/5 p-4">
									...
									<div className="grid grid-cols-2 gap-4 text-center">
										...
										<div>
											<div className="font-bold text-green-600 text-xl">18%</div>
						...
						<Card className="overflow-hidden border-primary/20 bg-gradient-to-br from-primary/5 to-transparent">
							<CardContent className="p-8 sm:p-12">
								...
								<blockquote className="text-lg leading-relaxed">
									"Our Google reviews went from 47 to 312 in six months. The automated campaigns brought back $82K in
									dormant customers we thought were gone forever. Marketing used to be an afterthought—now it's our best
									salesperson."
								</blockquote>
			...
			<section className="bg-gradient-to-br from-purple-500 via-purple-600 to-pink-500 py-20 text-white">
				<div className="container mx-auto px-4 text-center sm:px-6 lg:px-8">
					<h2 className="mb-4 font-bold text-3xl tracking-tight sm:text-4xl">Start marketing on autopilot</h2>

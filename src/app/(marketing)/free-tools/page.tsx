			...
			<div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
				<header className="mx-auto max-w-4xl space-y-6 text-center">
					...
					<p className="text-lg text-muted-foreground leading-relaxed">
						Explore battle-tested tools from Thorbis customers—covering operations, finance, training, and marketing. No
						paywall, no fluff, and included with the $100/month base subscription, pay-as-you-go usage, and zero
						lock-in.
					</p>
				...
				<main className="mt-16 space-y-20">
					<section className="space-y-6">
						<div className="flex flex-col gap-3 text-center">
							<h2 className="font-semibold text-3xl">Popular templates & checklists</h2>
					...
					<section className="space-y-6">
						<div className="flex flex-col gap-3 text-center">
							<h2 className="font-semibold text-3xl">Calculators & quick estimators</h2>
							<p className="text-muted-foreground">
					...
					<section className="space-y-6">
						<div className="mx-auto max-w-3xl text-center">
							<h2 className="font-semibold text-3xl">Stay ahead with the Thorbis help center</h2>
							<p className="text-muted-foreground">
						...
						<Card className="mx-auto max-w-4xl border-primary/30 border-dashed bg-primary/5">
							<CardContent className="flex flex-col items-center gap-4 py-10 text-center">
								<p className="font-semibold text-lg">Looking for something specific?</p>
								<p className="max-w-2xl text-muted-foreground text-sm">
									Search the knowledge base for written walkthroughs or head to the community to ask questions and share
									wins with peers.
								</p>
								<div className="flex flex-wrap justify-center gap-3">
									<Button asChild>
					...
					<section className="mx-auto max-w-4xl space-y-4">
						<h2 className="text-center font-semibold text-3xl">Free tools FAQ</h2>

...
function LoginForm() {
  ...
  // Log error to console so it's easier to see
  if (errorParam) {
  ...
  const handleOAuthLogin = async (provider: "google" | "facebook") => {
    ...
    try {
      console.log("🔵 Calling signInWithOAuth for provider:", provider);
      ...
      console.error("❌ Caught exception in handleOAuthLogin:", err);

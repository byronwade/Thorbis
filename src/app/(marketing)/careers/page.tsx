		...
		<>
			...
			<div className="container mx-auto space-y-20 px-4 py-16 sm:px-6 lg:px-8">
				...
				<section className="grid gap-4 md:grid-cols-4">
					{TEAM_STATS.map((stat) => (
						<Card className="text-center border-2 hover:border-primary/30 transition-all hover:shadow-lg bg-gradient-to-br from-primary/5 to-transparent" key={stat.label}>
								...
								>
									<CardHeader>
										<div className="flex items-center gap-4">
											<div className={`flex size-12 items-center justify-center rounded-xl ${benefit.iconBg}`}>

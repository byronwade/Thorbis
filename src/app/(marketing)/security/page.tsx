			...
			<div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
				<section className="max-w-3xl space-y-6">
					...
					<p className="text-lg text-muted-foreground leading-relaxed">
						Thorbis was designed with security at its core. From encrypted data storage to rigorous compliance programs,
						we protect sensitive information for contractors of every size.
					</p>

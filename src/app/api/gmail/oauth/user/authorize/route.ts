...
export async function GET(request: NextRequest) {
	...
	try {
		...
		if (memberError || !teamMember) {
			console.error("[Gmail User OAuth] Team member not found:", memberError?.message);
		...
		console.log(`[Gmail User OAuth] Redirecting ${teamMember.first_name} ${teamMember.last_name} to Google OAuth`);

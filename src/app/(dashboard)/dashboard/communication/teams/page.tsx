...
const DEFAULT_CHANNELS = [
    ...
    { id: "sales", name: "Sales", icon: Hash },
    { id: "support", name: "Support", icon: Hash },
    { id: "technicians", name: "Technicians", icon: Hash },
    { id: "management", name: "Management", icon: Hash },
];
...
export default function TeamsPage() {
    ...
    const channelId = (params?.channel as string) || searchParams.get("channel") || "general";
    ...
    const currentChannel = DEFAULT_CHANNELS.find(c => c.id === channelId) || DEFAULT_CHANNELS[0];
                    ...
                    markTeamChannelAsReadAction(channelId)
                        .then((result) => {
                            if (result.success) {
                                ...
                                console.error("Failed to mark channel as read:", result.error);
                            }
                        })
                        .catch((err) => {

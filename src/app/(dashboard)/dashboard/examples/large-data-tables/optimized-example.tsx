	...
	return (
		<div className="space-y-6">
			...
			<div className="rounded-lg border bg-card p-6">
				<h2 className="mb-2 font-semibold text-lg">Optimized Client-Side Table</h2>
				<p className="mb-4 text-muted-foreground text-sm">
					Uses React.memo, useMemo, and useCallback for efficient rendering. Best for 1,000-5,000 rows with client-side
					pagination.
				</p>
			...
			<div className="grid gap-4 md:grid-cols-3">
				<div className="rounded-lg border bg-card p-4">
					...
					<div className="mt-1 font-bold text-2xl">~{Math.round(rowCount * 0.002)}MB</div>
					<div className="mt-1 text-muted-foreground text-xs">All data in memory</div>
				</div>
				<div className="rounded-lg border bg-card p-4">
					<div className="text-muted-foreground text-sm">Initial Render</div>
					<div className="mt-1 font-bold text-2xl">~{Math.round(rowCount * 0.05)}ms</div>
					<div className="mt-1 text-muted-foreground text-xs">With pagination</div>
				</div>
				<div className="rounded-lg border bg-card p-4">
					<div className="text-muted-foreground text-sm">Re-renders</div>
					<div className="mt-1 font-bold text-2xl">50-70%</div>
					<div className="mt-1 text-muted-foreground text-xs">Reduction vs unoptimized</div>
				</div>
			</div>

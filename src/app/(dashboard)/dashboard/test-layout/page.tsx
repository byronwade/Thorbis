...
export default function TestLayoutPage() {
	return (
		<div className="space-y-6">
			<div>
				<h1 className="font-bold text-3xl tracking-tight">Default Layout Test</h1>
				<p className="text-muted-foreground">
					This page uses the default 7xl max-width layout with standard padding and gap.
				</p>
			</div>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>This page demonstrates the default layout behavior</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4">
					...
					<div className="rounded-lg border-2 border-primary/20 border-dashed bg-primary/5 p-4">
						...
						<p className="mt-1 text-muted-foreground text-xs">
							This content should be centered and constrained to 1280px max width on large screens. Try resizing your

		...
		<div className="space-y-6">
			...
			<div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
				{filteredProducts.map((product) => (
					<Link className="group" href={`/dashboard/shop/${product.id}`} key={product.id}>
						<Card className="h-full overflow-hidden transition-shadow hover:shadow-lg">
							<div className="relative aspect-square overflow-hidden bg-muted">
								...
								{product.originalPrice && (
									<Badge className="absolute top-2 left-2 bg-destructive" variant="destructive">
							...
							<CardContent>
								...
								{product.inStock ? (
									<p className="mt-1 text-success text-xs dark:text-success">In Stock</p>
								) : (
									<p className="mt-1 text-destructive text-xs dark:text-destructive">Out of Stock</p>
								)}
							</CardContent>
						</Card>
					</Link>
					...
					<Card>
						...
						<CardContent>
							<p className="text-muted-foreground text-sm">
								Carefully curated selection of tools and supplies specifically chosen for trade professionals.
							</p>
						</CardContent>
					</Card>
					<Card>
						...
						<CardContent>
							<p className="text-muted-foreground text-sm">
								Net-30 payment terms available for established businesses with approved credit.
							</p>
						</CardContent>
					</Card>
					<Card>
						...
						<CardContent>
							<p className="text-muted-foreground text-sm">
								Save more when you buy in bulk. Perfect for outfitting your entire team.
							</p>
						</CardContent>
					</Card>
				</div>

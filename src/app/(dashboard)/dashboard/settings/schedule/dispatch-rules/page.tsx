								...
								<div>
									...
									>
										...
										<SelectContent>
											...
											<SelectItem value="proximity">Nearest Available</SelectItem>
							...
							<div>
								...
								<div className="mt-2 flex items-center gap-2">
									<Input
										min="0"
										onChange={(e) =>
											updateSetting("minTimeBetweenJobs", Number(e.target.value))
										}
										type="number"
								...
								<div>
									...
									<div className="mt-2 flex items-center gap-2">
										<Input
											...
											min="0"
											onChange={(e) =>
												updateSetting("travelTimeBuffer", Number(e.target.value))
											}
											type="number"
					...
					<CardContent className="flex items-start gap-3 pt-6">
						...
						<div className="space-y-1">
							...
							<p className="text-muted-foreground text-sm">
								Start with balanced assignment method and adjust weights based on
								your business priorities. Monitor technician utilization weekly
								and fine-tune rules for optimal efficiency. Consider enabling
								route optimization during slower periods to minimize customer
								impact.
							</p>
						</div>
					</CardContent>

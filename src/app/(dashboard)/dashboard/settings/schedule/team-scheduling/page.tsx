			...
			<div className="space-y-6">
							...
							<div className="flex-1">
								<Label className="flex items-center gap-2 font-medium text-sm">
									...
									<Tooltip>
										...
										<TooltipContent>
											<p className="max-w-xs">
												Enable assigning crews to jobs
											</p>
										</TooltipContent>
									</Tooltip>
								</Label>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Customize the team schedule view
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
						<div className="flex items-center justify-between">
							<div className="flex-1">
								<Label className="font-medium text-sm">Show Team Calendar</Label>
								<p className="text-muted-foreground text-xs">
					...
					<CardContent className="flex items-start gap-3 pt-6">
						...
						<div className="space-y-1">
							...
							<p className="text-muted-foreground text-sm">
								Balance technician autonomy with manager oversight. Allow schedule
								viewing for transparency but limit editing to prevent conflicts.
								Configure time off lead times to ensure adequate coverage. Use
								crew assignments for complex jobs requiring multiple skill sets.
							</p>
						</div>
					</CardContent>
				</Card>

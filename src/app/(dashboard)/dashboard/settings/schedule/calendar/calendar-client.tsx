			...
			<Card>
				...
				<CardContent className="grid gap-4 md:grid-cols-2">
					<div>
						...
						<Select
							onValueChange={(value) =>
								updateSetting("defaultView", value as CalendarSettingsState["defaultView"])
							}
			...
			<Card>
				...
				<CardContent className="grid gap-4 md:grid-cols-2">
					<div>
						...
						<Select
							onValueChange={(value) =>
								updateSetting("timeSlotDurationMinutes", Number.parseInt(value, 10))
							}
						...
						<div className="flex items-center justify-between rounded-lg border p-3" key={item.key}>
							...
							<Switch
								...
								onCheckedChange={(checked) =>
									updateSetting(item.key as keyof CalendarSettingsState, checked)
								}
							/>
						</div>
					))}
			...
			<Card>
				...
				<CardContent className="space-y-4">
					<div className="flex items-center justify-between rounded-lg border p-3">
						<div>
							<p className="text-sm font-medium">Sync with Google Calendar</p>

		...
		<TooltipProvider>
			<div className="space-y-6">
				...
				<div className="flex items-start justify-between">
					<div>
						<h1 className="font-bold text-4xl tracking-tight">Job Checklists</h1>
						<p className="mt-2 text-muted-foreground">Ensure quality and consistency on every job</p>
					</div>
					<Button>
				...
				<div className="grid gap-4 sm:grid-cols-4">
					<Card>
						<CardContent className="pt-6">
							<div className="flex items-center justify-between">
								<div>
									<p className="text-muted-foreground text-sm">Active Checklists</p>
					...
					<Card>
						<CardContent className="pt-6">
							<div className="flex items-center justify-between">
								<div>
									<p className="text-muted-foreground text-sm">Total Checklists</p>
						...
						<CardContent className="pt-6">
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="mt-1 font-bold text-2xl">{avgItemsPerChecklist}</p>
								</div>
								<Settings className="h-8 w-8 text-muted-foreground" />
							</div>
						</CardContent>
					...
					<CardHeader>
						<CardTitle className="flex items-center gap-2 text-base">
							...
							<Tooltip>
								...
								<TooltipContent>
									<p className="max-w-xs">How checklists work for your technicians</p>
								</TooltipContent>
							</Tooltip>
						</CardTitle>
						<CardDescription>How technicians use checklists in the field</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
						<div className="flex items-center justify-between">
							<div className="flex-1">
								...
								<p className="text-muted-foreground text-xs">Show checklists to technicians during jobs</p>
							</div>
							<Switch
								checked={settings.enableChecklists}
								onCheckedChange={(checked) => updateSetting("enableChecklists", checked)}
							/>
						</div>
									...
									<div className="flex-1">
										<Label className="flex items-center gap-2 font-medium text-sm">
											...
											<Tooltip>
												...
												<TooltipContent>
													<p className="max-w-xs">Technician must complete checklist before finishing job</p>
												</TooltipContent>
											</Tooltip>
										</Label>
										<p className="text-muted-foreground text-xs">Can't complete job without finishing checklist</p>
									</div>
									<Switch
										checked={settings.requireChecklistCompletion}
										onCheckedChange={(checked) => updateSetting("requireChecklistCompletion", checked)}
									/>
								</div>
									...
									<div className="flex-1">
										<Label className="flex items-center gap-2 font-medium text-sm">
											...
											<Tooltip>
												...
												<TooltipContent>
													<p className="max-w-xs">Let tech skip non-essential items if needed</p>
												</TooltipContent>
											</Tooltip>
										</Label>
										<p className="text-muted-foreground text-xs">Tech can skip optional checklist items</p>
									</div>
									<Switch
										checked={settings.allowTechnicianSkip}
										onCheckedChange={(checked) => updateSetting("allowTechnicianSkip", checked)}
									/>
								</div>
										...
										<div className="flex-1">
											<Label className="flex items-center gap-2 font-medium text-sm">
												...
												<Tooltip>
													...
													<TooltipContent>
														<p className="max-w-xs">Tech must explain why they skipped an item</p>
													</TooltipContent>
												</Tooltip>
											</Label>
											<p className="text-muted-foreground text-xs">Must explain why item was skipped</p>
										</div>
										<Switch
											checked={settings.requireSkipReason}
											onCheckedChange={(checked) => updateSetting("requireSkipReason", checked)}
										/>
									</div>
								)}
							</>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>Photo documentation for quality assurance</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
						<div className="flex items-center justify-between">
							<div className="flex-1">
								<Label className="flex items-center gap-2 font-medium text-sm">
									...
									<Tooltip>
										...
										<TooltipContent>
											<p className="max-w-xs">Technician must take photos during job</p>
										</TooltipContent>
									</Tooltip>
								</Label>
								<p className="text-muted-foreground text-xs">Photos required for checklist items</p>
							</div>
							<Switch
								...
								<div>
									<Label className="flex items-center gap-2 font-medium text-sm">
										...
										<Tooltip>
											...
											<TooltipContent>
												<p className="max-w-xs">Minimum number of photos required</p>
											</TooltipContent>
										</Tooltip>
									</Label>
									<Input
										className="mt-2"
										min="0"
										onChange={(e) => updateSetting("minimumPhotosPerJob", Number.parseInt(e.target.value, 10) || 2)}
										placeholder="2"
										type="number"
										value={settings.minimumPhotosPerJob}
									/>
									<p className="mt-1 text-muted-foreground text-xs">Tech must take at least this many photos</p>
								</div>
									...
									<div className="flex-1">
										<Label className="flex items-center gap-2 font-medium text-sm">
											...
											<Tooltip>
												...
												<TooltipContent>
													<p className="max-w-xs">Check for blurry or dark photos</p>
												</TooltipContent>
											</Tooltip>
										</Label>
										<p className="text-muted-foreground text-xs">Warn if photos are blurry or too dark</p>
									</div>
									<Switch
										checked={settings.photoQualityCheck}
										onCheckedChange={(checked) => updateSetting("photoQualityCheck", checked)}
									/>
								</div>
							</>
						)}
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>What's required to mark checklist complete</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
						<div className="flex items-center justify-between">
							<div className="flex-1">
								<Label className="flex items-center gap-2 font-medium text-sm">
									...
									<Tooltip>
										...
										<TooltipContent>
											<p className="max-w-xs">Every item must be checked off to complete</p>
										</TooltipContent>
									</Tooltip>
								</Label>
								<p className="text-muted-foreground text-xs">Must check every single item</p>
							</div>
							<Switch
								checked={settings.requireAllItemsChecked}
								onCheckedChange={(checked) => updateSetting("requireAllItemsChecked", checked)}
							/>
						</div>
							...
							<div className="flex-1">
								<Label className="flex items-center gap-2 font-medium text-sm">
									...
									<Tooltip>
										...
										<TooltipContent>
											<p className="max-w-xs">Save checklist even if not all items done</p>
										</TooltipContent>
									</Tooltip>
								</Label>
								<p className="text-muted-foreground text-xs">Can complete job with partial checklist</p>
							</div>
							<Switch
								checked={settings.allowPartialCompletion}
								onCheckedChange={(checked) => updateSetting("allowPartialCompletion", checked)}
							/>
						</div>
							...
							<div className="flex-1">
								<Label className="flex items-center gap-2 font-medium text-sm">
									...
									<Tooltip>
										...
										<TooltipContent>
											<p className="max-w-xs">Keep partially completed checklists for later</p>
										</TooltipContent>
									</Tooltip>
								</Label>
								<p className="text-muted-foreground text-xs">Keep partial progress if job interrupted</p>
							</div>
							<Switch
								checked={settings.saveIncompleteLists}
								onCheckedChange={(checked) => updateSetting("saveIncompleteLists", checked)}
							/>
						</div>
					</CardContent>
				</Card>
					...
					<CardHeader>
						<CardTitle className="flex items-center gap-2 text-base">
							...
							<Tooltip>
								...
								<TooltipContent>
									<p className="max-w-xs">What customers can see about checklists</p>
								</TooltipContent>
							</Tooltip>
						</CardTitle>
						<CardDescription>Share checklist results with customers</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
						<div className="flex items-center justify-between">
							<div className="flex-1">
								<Label className="flex items-center gap-2 font-medium text-sm">
									...
									<Tooltip>
										...
										<TooltipContent>
											<p className="max-w-xs">Show completed checklist to customer</p>
										</TooltipContent>
									</Tooltip>
								</Label>
								<p className="text-muted-foreground text-xs">Let customers see completed checklist</p>
							</div>
							<Switch
								checked={settings.shareChecklistWithCustomer}
								onCheckedChange={(checked) => updateSetting("shareChecklistWithCustomer", checked)}
							/>
						</div>
									...
									<div className="flex-1">
										<Label className="flex items-center gap-2 font-medium text-sm">
											...
											<Tooltip>
												...
												<TooltipContent>
													<p className="max-w-xs">Add checklist to job completion email</p>
												</TooltipContent>
											</Tooltip>
										</Label>
										<p className="text-muted-foreground text-xs">Email checklist when job completes</p>
									</div>
									<Switch
										checked={settings.includeInJobSummary}
										onCheckedChange={(checked) => updateSetting("includeInJobSummary", checked)}
									/>
								</div>
									...
									<div className="flex-1">
										<Label className="flex items-center gap-2 font-medium text-sm">
											...
											<Tooltip>
												...
												<TooltipContent>
													<p className="max-w-xs">Customer can view checklist in portal</p>
												</TooltipContent>
											</Tooltip>
										</Label>
										<p className="text-muted-foreground text-xs">Available in customer portal</p>
									</div>
									<Switch
										checked={settings.customerCanViewInPortal}
										onCheckedChange={(checked) => updateSetting("customerCanViewInPortal", checked)}
									/>
								</div>
							</>
						)}
							...
							<div className="flex items-start gap-3">
								...
								<div className="flex-1 space-y-1">
									...
									<p className="text-muted-foreground text-xs">
										Customers love seeing detailed checklists! It shows professionalism and proves work was done
										thoroughly. Businesses that share checklists get 40% more 5-star reviews.
									</p>
								</div>
							</div>
						</div>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>Manage checklists for different job types</CardDescription>
					</CardHeader>
					<CardContent className="space-y-3">
						{checklists.map((checklist) => {
							...
							const photoItems = checklist.items.filter((item) => item.photoRequired).length;

							return (
								<div className="rounded-lg border transition-colors hover:bg-muted/50" key={checklist.id}>
									{/* Checklist Header */}
									<div
										...
										<div className="flex flex-1 items-center gap-3">
											...
											<div className="flex-1">
												<div className="flex items-center gap-2">
													...
													{!checklist.active && <Badge variant="secondary">Inactive</Badge>}
												</div>
												<p className="mt-1 text-muted-foreground text-sm">{checklist.description}</p>
												<div className="mt-2 flex items-center gap-4 text-xs">
													<span className="text-muted-foreground">{checklist.items.length} items</span>
													<span className="text-muted-foreground">•</span>
													<span className="text-muted-foreground">{requiredItems} required</span>
													<span className="text-muted-foreground">•</span>
													<span className="text-muted-foreground">{photoItems} photos needed</span>
													<span className="text-muted-foreground">•</span>
													<span className="text-muted-foreground">Used {checklist.usageCount} times</span>
												</div>
											</div>
										</div>
											...
											<div className="p-4">
												<div className="space-y-2">
													{checklist.items.map((item) => (
														<div className="flex items-center gap-3 rounded-lg border bg-muted/30 p-3" key={item.id}>
															...
															<div className="flex gap-2">
																...
																{item.photoRequired && <Badge variant="outline">Photo</Badge>}
															</div>
														</div>
													))}
												</div>

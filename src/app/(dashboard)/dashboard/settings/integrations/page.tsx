...
import { type IntegrationCategory, integrations } from "@/lib/data/integrations";
...
export default function IntegrationsPage() {
	...
	const [viewMode, setViewMode] = useState<"connected" | "available" | "all">("all");
	...
	return (
		<div className="container mx-auto space-y-6 p-6">
			...
			<div>
				...
				<p className="text-muted-foreground">Connect Thorbis with your favorite tools and services</p>
			</div>
			...
			<div className="grid gap-4 md:grid-cols-3">
				...
				<Card>
					...
					<CardContent>
						...
						<p className="text-muted-foreground text-xs">Integrations catalog</p>
					</CardContent>
				</Card>
			</div>
			...
			<div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
				<div className="flex flex-1 gap-2">
					...
					<Select onValueChange={(value) => setSelectedCategory(value as IntegrationCategory)} value={selectedCategory}>
				...
				<Tabs
					...
					onValueChange={(value) => setViewMode(value as "connected" | "available" | "all")}
					value={viewMode}
				>
							...
							<CardHeader>
								<div className="flex items-start justify-between">
									<Avatar className="size-12 rounded-lg">
										...
										<AvatarFallback className={cn("rounded-lg text-white", integration.color)}>
									...
									<div className="flex gap-2">
										...
										{integration.isPremium && <Badge variant="secondary">Premium</Badge>}
									</div>
								</div>
							...
							<CardContent className="space-y-4">
								{integration.features && integration.features.length > 0 && (
									<div className="space-y-2">
										<p className="font-medium text-muted-foreground text-xs uppercase tracking-wider">Features</p>
										<ul className="space-y-1">
											{integration.features.slice(0, MAX_DISPLAYED_FEATURES).map((feature) => (
			...
			<Card className="border-primary/20 bg-primary/5">
				<CardHeader>
					...
					<CardDescription>
						Our team can help you connect with custom tools or build specialized integrations for your business needs.
					</CardDescription>
				</CardHeader>
				<CardContent>

				...
				<CardContent className="space-y-4">
					...
					<div className="flex items-center justify-between">
						<div className="space-y-0.5">
							...
							<p className="text-muted-foreground text-sm">Save customer payment methods for future use</p>
						</div>
						<Switch defaultChecked />
					</div>
				...
				<CardContent className="space-y-4">
					<div className="flex items-center justify-between">
						<div className="space-y-0.5">
							...
							<p className="text-muted-foreground text-sm">Require card verification code for all transactions</p>
						</div>
						<Switch defaultChecked />
					</div>
					...
					<div className="flex items-center justify-between">
						<div className="space-y-0.5">
							...
							<p className="text-muted-foreground text-sm">Use Stripe's machine learning fraud detection</p>
						</div>
						<Switch defaultChecked />
					</div>
					...
					<div className="flex items-center justify-between">
						<div className="space-y-0.5">
							...
							<p className="text-muted-foreground text-sm">Require 3D Secure authentication for eligible cards</p>
						</div>
						<Switch />
					</div>
				...
				<CardContent className="space-y-4">
					<div className="flex items-center justify-between">
						<div className="space-y-0.5">
							...
							<p className="text-muted-foreground text-sm">Automatically send receipts to customers</p>
						</div>
						<Switch defaultChecked />
					</div>
					...
					<div className="flex items-center justify-between">
						<div className="space-y-0.5">
							...
							<p className="text-muted-foreground text-sm">Get notified about chargebacks and disputes</p>
						</div>
						<Switch defaultChecked />
					</div>
			...
			<Card>
				...
				<CardContent className="space-y-4">
					<div className="space-y-2">
						...
						<Input defaultValue="https://api.thorbis.com/webhooks/stripe" disabled id="webhook-url" type="url" />
					</div>

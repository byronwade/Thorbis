		...
		<div className="space-y-6">
			<div>
				<div className="flex items-center gap-3">
					<h1 className="font-bold text-4xl tracking-tight">Automation Settings</h1>
					<Badge variant="secondary">Beta</Badge>
				</div>
				<p className="mt-2 text-muted-foreground">Configure automated workflows and business rules</p>
			</div>
			...
			<Card className="border-primary/50 bg-primary/5">
				<CardContent className="flex items-start gap-3 pt-6">
					...
					<div className="space-y-1">
						<p className="font-medium text-primary text-sm dark:text-primary">Automation Beta Program</p>
						<p className="text-muted-foreground text-sm">
							Automation features are currently in beta. We're actively developing new automation capabilities and would
							love your feedback. Some features may change as we improve the system based on user input.
						</p>
					</div>
				</CardContent>
			</Card>
			...
			<Card>
				<CardContent className="p-6">
					<div className="flex items-start gap-3">
						...
						<div className="space-y-1">
							<p className="font-medium text-sm">Automation Settings Overview</p>
							<p className="text-muted-foreground text-sm">
								Automate repetitive tasks and create intelligent workflows that save time and reduce errors. Set up
								triggers that respond to events, create multi-step workflows, use AI to make smart decisions, and build
								complex automation with conditional logic. Automation can handle customer follow-ups, job assignments,
					...
					<div className="space-y-3">
						<div className="rounded-lg border p-4">
							...
							<p className="text-muted-foreground text-xs">
								Automatically assign jobs to available technicians based on location, skills, and availability
							</p>
						</div>
						...
						<div className="rounded-lg border p-4">
							...
							<p className="text-muted-foreground text-xs">
								Send automatic follow-up messages to customers 3 days after job completion
							</p>
						</div>

						<div className="rounded-lg border p-4">
							<h4 className="mb-1 font-medium text-sm">Escalate overdue invoices</h4>
							<p className="text-muted-foreground text-xs">
								Automatically escalate invoices that are 30+ days overdue to the collections team
							</p>
						</div>
						...
						<div className="rounded-lg border p-4">
							...
							<p className="text-muted-foreground text-xs">
								Change job status to "Complete" when technician marks all tasks as done and customer signature is
								received
							</p>
						</div>
					</div>

...
/**
 * Settings > Finance > Consumer Financing Page - Client Component
 *
...
export default function ConsumerFinancingSettingsPage() {  const [hasUnsavedChanges, setHasUnsavedChanges] = useState(false);

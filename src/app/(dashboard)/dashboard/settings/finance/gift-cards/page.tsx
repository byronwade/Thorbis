...
/**
 * Settings > Finance > Gift Cards Page - Client Component
 *
...
export default function GiftCardsSettingsPage() {  const [hasUnsavedChanges, setHasUnsavedChanges] = useState(false);

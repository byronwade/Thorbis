							...
							<div>
								...
								<select
									...
									onChange={(event) =>
										updateSetting(
											"routingStrategy",
											event.target.value as PhoneSettingsState["routingStrategy"]
										)
									}
						...
						{settings.voicemailEnabled && (
							<>
								...
								<div className="grid gap-4 md:grid-cols-2">
									<div>
										<Label className="text-sm font-medium">Greeting URL</Label>
										<Input
											className="mt-2"
											onChange={(event) =>
												updateSetting("voicemailGreetingUrl", event.target.value)
											}
									...
									<div>
										<p className="text-sm font-medium">Email notifications for new voicemail</p>
										<Switch
								...
								<div className="flex items-center justify-between">
									<div>
										<p className="text-sm font-medium">Transcribe voicemail</p>
										<p className="text-muted-foreground text-xs">
					...
					<CardContent className="space-y-4">
						...
						{settings.ivrEnabled && (
							<>
								<Separator />
								<div>
									<Label className="text-sm font-medium">IVR JSON definition</Label>
									<Textarea
				...
				<Card className="border-warning/40 bg-warning/5">
					<CardContent className={cn("flex items-start", "gap-3", "pt-6")}>
						...
						<div className="space-y-1">
							<p className="text-warning text-sm font-semibold">Regulatory reminder</p>
							<p className="text-muted-foreground text-sm">
								Recording and IVR features may carry legal obligations in your jurisdiction (GDPR,
								HIPAA, state consent laws). Confirm with legal counsel before enabling and keep
								callers informed via the announcement message.
							</p>
						</div>
					</CardContent>
				</Card>

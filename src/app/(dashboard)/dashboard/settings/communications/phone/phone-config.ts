...
export function mapPhoneSettings(row: PhoneSettingsRow): Partial<PhoneSettingsState> {
	...
	return {
		routingStrategy: (row.routing_strategy as PhoneSettingsState["routingStrategy"]) ?? "round_robin",
		...
		recordingAnnouncement: row.recording_announcement || "This call may be recorded for quality assurance purposes.",

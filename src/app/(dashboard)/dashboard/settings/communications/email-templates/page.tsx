    ...
    <div className="space-y-6 p-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage your email templates powered by Resend and React Email
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All email templates are code-based using React Email for maximum
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <Button asChild size="sm" variant="outline">
                      <a
                        href={`/emails/preview/${template.id}`}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View recent email send history and delivery status
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground text-sm">
            Email logging is configured. View logs in the database or integrate
            with Resend webhooks for real-time delivery tracking.
          </p>
        </CardContent>
      </Card>
    </div>

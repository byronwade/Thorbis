				...
				<div className="space-y-6 lg:col-span-2">
					<Card>
						<CardHeader>
							...
							<CardDescription>Use variables to personalize emails for each invoice</CardDescription>
						</CardHeader>
						...
						<Card>
							...
							<CardContent className="space-y-4">
								...
								<div>
									...
									<p className="mt-1 whitespace-pre-wrap text-sm">{getPreviewText(template.body)}</p>
								</div>
								{template.footer && (
									<>
										<Separator />
										<div>
											<Label className="text-muted-foreground text-xs">Footer</Label>
											<p className="mt-1 text-muted-foreground text-sm">{getPreviewText(template.footer)}</p>
										</div>
									</>
								)}
							</CardContent>
				...
				<div className="space-y-6">
					...
					<Card>
						...
						<CardContent className="space-y-2 text-sm">
							<p className="text-muted-foreground">• Keep your subject line clear and concise</p>
							<p className="text-muted-foreground">• Include payment instructions and due date</p>
							<p className="text-muted-foreground">• Add a personal touch to build customer relationships</p>
							<p className="text-muted-foreground">• Include contact information for questions</p>
						</CardContent>
					</Card>
				</div>
			</div>

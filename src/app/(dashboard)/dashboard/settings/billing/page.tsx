...
const TOTAL_USAGE_COST = Object.values(COSTS).reduce(
  (sum, cost) => sum + cost,
  0
);
...
const PERCENT_COMPLETE =
  ((DAYS_IN_MONTH - DAYS_LEFT) / DAYS_IN_MONTH) * PERCENT_TO_DECIMAL;
...
export default function BillingPage() {  const categories: UsageCategory[] = [
    {
      ...
      tooltip:
        "Team members can access your account based on their role. Each member costs $5/month.",
    ...
    },
    {
      ...
      tooltip:
        "Every invoice you create and send to customers. Includes email delivery and payment tracking.",
    ...
    },
    {
      ...
      tooltip:
        "Estimates and quotes sent to potential customers. Can be converted to invoices once approved.",
    ...
    },
    {
      ...
      example:
        "You sent 1,205 emails like invoice receipts and booking confirmations",
    },
    {
      name: "Video Calls",
      icon: Video,
            ...
            <Tooltip>
              ...
              <TooltipContent className="max-w-sm">
                ...
                <p className="mt-2 text-sm">
                  You pay a ${BASE_FEE} monthly platform fee plus usage charges
                  for everything you actually use. No hidden fees, no surprises.
                </p>
              </TooltipContent>
            </Tooltip>
          </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-sm">
                        ...
                        <p className="mt-2 text-sm">
                          This is an estimate based on your current usage. Your
                          final bill on April 1st will reflect your actual usage
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p className="text-sm">
                          Projected total based on your usage so far this month.
                          The actual amount may vary slightly.
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-base">
                    <div className="flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          <p className="text-sm">
                            Your base subscription fee. This gives you access to
                            the platform and all core features.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
                    <span className="font-semibold">
                      ${BASE_FEE.toFixed(CURRENCY_DECIMAL_PLACES)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between text-base">
                    <div className="flex items-center gap-2">
                      <span className="text-muted-foreground">
                        What You Used This Month
                      </span>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                        ...
                        <TooltipContent className="max-w-xs">
                          <p className="text-sm">
                            Total cost of all usage-based features (texts,
                            calls, invoices, storage, etc.). See breakdown
                            below.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          <p className="text-sm">
                            Shows how far through the monthly billing cycle you
                            are. We bill on the 1st of each month.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-sm">
                      <p className="text-sm">
                        Detailed breakdown of all usage-based charges. Hover
                        over each item for more information about what it
                        includes.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                ...
                <p className="text-muted-foreground">
                  Here's exactly what you used and what it costs - simple
                  breakdown
                </p>
              </div>
                      ...
                      <div className="flex items-start justify-between gap-6">
                        <div className="flex gap-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex items-baseline gap-2 rounded-md bg-muted/50 px-3 py-2 font-mono text-sm">
                              ...
                              <span className="font-medium">
                                ${item.priceEach.toFixed(PRICE_DECIMAL_PLACES)}
                              </span>
                              <span className="text-muted-foreground">
                                each
                              </span>
                        ...
                        <div className="shrink-0 text-right">
                          <p className="font-bold text-2xl">
                            ${item.totalCost.toFixed(CURRENCY_DECIMAL_PLACES)}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-semibold text-lg">
                      Total Usage Charges This Month
                    </p>
                    <p className="text-muted-foreground text-sm">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-xs">
                      <p className="text-sm">
                        Your payment method is charged automatically on the 1st
                        of each month. You can update it anytime.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              ...
              <div className="space-y-4 rounded-lg border bg-card p-6 shadow-sm">
                ...
                <div className="space-y-2 rounded-lg bg-blue-50 p-4 dark:bg-blue-950/20">
                  ...
                  <p className="text-muted-foreground text-xs">
                    We'll automatically charge this card monthly for your base
                    fee plus usage. You'll receive a detailed email receipt.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-xs">
                      <p className="text-sm">
                        Download PDF receipts for your accounting records. Each
                        receipt includes a detailed usage breakdown.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-base">
                          ${invoice.amount.toFixed(CURRENCY_DECIMAL_PLACES)}
                        </p>
                        <Button
                          className="mt-2"
                          size="sm"
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Questions about your bill? We're here to help explain
                      everything.
                    </p>
                  </div>
                </div>

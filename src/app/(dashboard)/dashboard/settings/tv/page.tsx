...
import { ArrowLeft, Clock, Layout, Monitor, Palette, Save, Users } from "lucide-react";
	...
	return (
		<div className="relative space-y-8">
			...
			<div className="relative">
				...
				<p className="text-lg text-muted-foreground">Customize how the leaderboard appears on TV displays</p>
			</div>
						...
						<div className="space-y-3">
							...
							<div className="flex items-center gap-4">
								<input
									...
									max={20}
									min={3}
									onChange={(e) => setDisplayCount(Number.parseInt(e.target.value, 10))}
									type="range"
									value={displayCount}
								/>
					...
					<div className="space-y-6">
						...
						<div className="flex items-center justify-between rounded-lg border border-primary/20 bg-background/50 p-4">
							<div>
								...
								<p className="text-muted-foreground text-sm">Automatically cycle through technicians</p>
							</div>
							<button
						...
						<div className="space-y-3">
							...
							<div className="flex items-center gap-4">
								<input
									...
									max={30}
									min={3}
									onChange={(e) => setTableScrollInterval(Number.parseInt(e.target.value, 10))}
									type="range"
							...
							<p className="text-muted-foreground text-xs">How long to display each set of technicians in table view</p>
						</div>
						...
						<div className="space-y-3">
							...
							<div className="flex items-center gap-4">
								<input
									...
									max={30}
									min={5}
									onChange={(e) => setSlideshowInterval(Number.parseInt(e.target.value, 10))}
									type="range"
							...
							<p className="text-muted-foreground text-xs">How long to display each technician in slideshow view</p>
						</div>
					</div>
				</div>
					...
					<div className="space-y-4">
						...
						<div className="flex items-center justify-between rounded-lg border border-primary/20 bg-background/50 p-4">
							<div>
								...
								<p className="text-muted-foreground text-sm">Display green/red arrows for performance trends</p>
							</div>
							<button

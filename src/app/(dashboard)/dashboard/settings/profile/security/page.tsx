...
const securityFeatures: SecurityFeature[] = [
	...
	},
	{
		...
		actionText: "Enable",
		tooltip: "Add an extra layer of security by requiring a code from your phone",
	},
	{
							...
							<div className="flex items-center gap-2">
								...
								<Tooltip>
									...
									<TooltipContent className="max-w-xs">
										<p className="text-sm">Control how you sign in to your account and add extra layers of security.</p>
									</TooltipContent>
								</Tooltip>
							</div>
							<p className="text-muted-foreground text-sm">Control how you sign in to your account</p>
						</div>
										...
										<div className="flex items-center gap-3">
											...
											{feature.actionText && (
												<Button asChild size="sm" variant="outline">
													<Link href={feature.href || "#"}>{feature.actionText}</Link>
												</Button>
											)}
										</div>
									</div>
							...
							<div className="mb-6 space-y-2">
								<div className="flex items-center gap-2">
									...
									<Tooltip>
										...
										<TooltipContent className="max-w-xs">
											<p className="text-sm">
												Devices where you're currently signed in. Remove any devices you don't recognize.
											</p>
										</TooltipContent>
									</Tooltip>
								</div>
								<p className="text-muted-foreground text-sm">Devices where you're currently signed in</p>
							</div>
							...
							<div className="mb-6 space-y-2">
								<div className="flex items-center gap-2">
									...
									<Tooltip>
										...
										<TooltipContent className="max-w-xs">
											<p className="text-sm">
												Recent sign-in attempts on your account. Check for any suspicious activity.
											</p>
										</TooltipContent>
									</Tooltip>
								</div>
								<p className="text-muted-foreground text-sm">Recent sign-in attempts on your account</p>
							</div>
										...
										<div className="flex-1 space-y-1">
											<div className="flex items-center justify-between">
												<div>
													...
													<p className="text-muted-foreground text-xs">{activity.location}</p>
												</div>
					...
					<div className="rounded-xl border bg-card p-8 shadow-sm">
						<div className="mb-6 space-y-2">
							<div className="flex items-center gap-2">
								...
								<Tooltip>
									...
									<TooltipContent className="max-w-xs">
										<p className="text-sm">Add recovery options to regain access if you forget your password.</p>
									</TooltipContent>
								</Tooltip>
							</div>
							<p className="text-muted-foreground text-sm">Add recovery options to help regain access</p>
						</div>
						...
						<div className="grid gap-6 md:grid-cols-2">
							<div className="rounded-lg border bg-muted/30 p-4">
								...
								<p className="text-muted-foreground text-sm">Add a backup email to recover your account.</p>
							...
							<div className="rounded-lg border bg-muted/30 p-4">
								...
								<p className="text-muted-foreground text-sm">
									Save single-use backup codes in case you lose access to your authenticator.
								</p>
								<Button className="mt-4" size="sm" variant="outline">
									Download Codes
								</Button>
						...
						<div className="mb-6 space-y-2">
							<div className="flex items-center gap-2">
								...
								<Tooltip>
									...
									<TooltipContent className="max-w-xs">
										<p className="text-sm">Sign out of other active sessions and protect your account.</p>
									</TooltipContent>
								</Tooltip>
							</div>
							<p className="text-muted-foreground text-sm">Manage where you're currently signed in</p>
						</div>
						...
						<div className="mb-6 space-y-2">
							<div className="flex items-center gap-2">
								...
								<Tooltip>
									...
									<TooltipContent className="max-w-xs">
										<p className="text-sm">Manage API keys used to integrate Thorbis with other systems.</p>
									</TooltipContent>
								</Tooltip>
							</div>
							<p className="text-muted-foreground text-sm">Manage keys used for third-party integrations</p>
						</div>
							...
							<div className="rounded-lg border bg-muted/30 p-4">
								<div className="flex flex-wrap items-center justify-between gap-3">
									<div>
										...
										<p className="text-muted-foreground text-xs">Created Sep 10, 2024 • Last used 2 hours ago</p>
									</div>
							...
							<div className="rounded-lg border bg-muted/30 p-4">
								<div className="flex flex-wrap items-center justify-between gap-3">
									<div>
										...
										<p className="text-muted-foreground text-xs">Created Aug 22, 2024 • Last used 5 days ago</p>
									</div>
									<div className="flex gap-2">
										<Button size="icon" type="button" variant="outline">
											<Download className="h-4 w-4" />

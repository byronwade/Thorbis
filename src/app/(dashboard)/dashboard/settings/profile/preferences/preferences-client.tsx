			...
			>
				<div className="space-y-6">
									...
									return (
										...
										>
											<div className="mb-2 flex items-center gap-2">
												...
												{isActive && <Check className="text-primary ml-auto h-4 w-4" />}
											</div>
					...
					<Card>
						...
						<CardContent className="space-y-6">
							<div>
								<Label className="mb-2 block text-sm font-medium">Sidebar Position</Label>
								<div className="grid gap-4 sm:grid-cols-2">
					...
					<div className="bg-card flex flex-wrap items-center justify-between gap-3 rounded-xl border p-6">
						<div>
							<h3 className="text-sm font-semibold">Reset preferences to defaults</h3>
							<p className="text-muted-foreground text-xs">
								Restores the recommended Thorbis interface defaults
							</p>
						</div>
						<Button
							onClick={() => {

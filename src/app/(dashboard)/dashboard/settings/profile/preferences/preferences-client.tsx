...
export function PreferencesClient({ initialSettings }: PreferencesClientProps) {
	const {
		...
		transformSave: (currentSettings) => {
			...
			formData.append(
				"defaultPageSize",
				currentSettings.tableView === "compact" ? "10" : "25",
			);
			return formData;
		},
	});
				...
				<div className="space-y-6">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Control layout density and animation preferences
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Sidebar position and table density settings
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							<div>
					...
					<div className="bg-card flex flex-wrap items-center justify-between gap-3 rounded-xl border p-6">
						...
						<Button
							onClick={() => {
								...
								updateSetting(
									"autoSaveForms",
									DEFAULT_PREFERENCE_SETTINGS.autoSaveForms,
								);
								updateSetting(
									"sidebarPosition",

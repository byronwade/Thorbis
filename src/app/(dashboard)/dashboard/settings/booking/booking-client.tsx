			...
			>
					...
					<CardContent className="space-y-4">
						...
						<div className="grid gap-4 md:grid-cols-2">
							<div className="flex items-center justify-between rounded-lg border p-3">
								<div>
									<p className="text-sm font-medium">Require account</p>
									<p className="text-muted-foreground text-xs">
				...
				<Card>
					...
					<CardContent className="grid gap-4 md:grid-cols-2">
						<div className="flex items-center justify-between rounded-lg border p-3">
							<div>
								<p className="text-sm font-medium">Service or package</p>
								<p className="text-muted-foreground text-xs">
						...
						<div className="flex items-center justify-between rounded-lg border p-3">
							<div>
								<p className="text-sm font-medium">Allow time preferences</p>
								<p className="text-muted-foreground text-xs">
						...
						<div className="flex items-center justify-between rounded-lg border p-3">
							<div>
								<p className="text-sm font-medium">Portal confirmation SMS</p>
								<p className="text-muted-foreground text-xs">
				...
				<Card>
					...
					<CardContent className="grid gap-4 md:grid-cols-2">
						<div className="rounded-lg border p-3">
							...
							<p className="mt-2 text-2xl font-semibold">{settings.minBookingNoticeHours}h</p>
							<p className="text-muted-foreground text-xs">

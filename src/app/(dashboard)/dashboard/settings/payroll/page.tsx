...
import { AlertCircle, BadgeDollarSign, Calendar, Clock, Layers, Settings, TrendingUp, Wallet } from "lucide-react";
		...
		<div className="space-y-6">
			...
			<div>
				...
				<p className="mt-2 text-muted-foreground">
					Configure commission structures, deductions, bonuses, and payroll policies
				</p>
			</div>
				...
				<CardContent className="flex items-start gap-3 pt-6">
					...
					<div className="space-y-1">
						...
						<p className="text-muted-foreground text-sm">
							These settings define company-wide payroll policies. Changes affect how all technicians are compensated.
							Individual employee rates and overrides are managed in their profile pages.
						</p>
					</div>
				</CardContent>
			</Card>
			...
			<Card>
				...
				<CardContent>
					<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
						...
						<div className="space-y-1">
							<p className="text-muted-foreground text-sm">Overtime Threshold</p>
			...
			<Card className="border-primary/50 bg-primary/5">
				<CardHeader>
					<div className="flex items-center gap-2">
						...
						<CardTitle className="text-base text-primary dark:text-primary">Need Help Configuring Payroll?</CardTitle>
					</div>
					<CardDescription>
						Our payroll specialists can help you set up your payroll system correctly and ensure compliance with all
						regulations.
					</CardDescription>
				</CardHeader>
				<CardContent>

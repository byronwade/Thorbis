	...
	return (
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">Customer self-service portal access and management</p>
			</div>
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Self-Service Rate</CardTitle>
						<svg
							className="size-4 text-muted-foreground"
							fill="none"
							stroke="currentColor"
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
				<Card className="col-span-4">
					<CardHeader>
						...
						<CardDescription>Recent customer portal usage and activities</CardDescription>
					</CardHeader>
					<CardContent>
								...
								<div className="flex items-center gap-4 rounded-lg border p-4" key={index}>
									...
									<div className="flex-1 space-y-1">
										<div className="flex items-center gap-2">
											<p className="font-medium text-sm leading-none">{activity.customer}</p>
											<span
				...
				<Card className="col-span-3">
					<CardHeader>
						...
						<CardDescription>Available customer self-service options</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="space-y-4">
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									...
									<p className="text-muted-foreground text-xs">Book appointments online</p>
								</div>
								<div className="text-right">
							...
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									...
									<p className="text-muted-foreground text-xs">View and download invoices</p>
								</div>
								<div className="text-right">
									<p className="font-bold text-sm">Active</p>
							...
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									...
									<p className="text-muted-foreground text-xs">View past services</p>
								</div>
								<div className="text-right">
									<p className="font-bold text-sm">Active</p>
							...
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									...
									<p className="text-muted-foreground text-xs">Request service quotes</p>
								</div>
								<div className="text-right">
									<p className="font-bold text-sm">Active</p>
							...
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									...
									<p className="text-muted-foreground text-xs">Update contact info</p>
								</div>
								<div className="text-right">
									<p className="font-bold text-sm">Active</p>

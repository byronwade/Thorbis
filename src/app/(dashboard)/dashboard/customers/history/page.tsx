	...
	return (
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">Complete service history and maintenance records for all customers</p>
			</div>
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Total Services</CardTitle>
						<svg
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Completed This Week</CardTitle>
						<svg
							className="size-4 text-muted-foreground"
							fill="none"
							stroke="currentColor"
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Repeat Customers</CardTitle>
						<svg
							className="size-4 text-muted-foreground"
							fill="none"
							stroke="currentColor"
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
				<Card className="col-span-4">
					<CardHeader>
						...
						<CardDescription>Latest completed services and maintenance records</CardDescription>
					</CardHeader>
					<CardContent>
							...
							{[
								{
									...
									status: "Completed",
									rating: "5.0",
									notes: "Routine maintenance, all systems functioning properly",
								},
								{
								...
								<div className="flex items-center gap-4 rounded-lg border p-4" key={index}>
									...
									<div className="flex-1 space-y-1">
										<div className="flex items-center gap-2">
											<p className="font-medium text-sm leading-none">{service.customer}</p>
											<span
										...
										<p className="text-muted-foreground text-sm">{service.notes}</p>
									</div>
						...
						<div className="space-y-4">
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								...
								<div className="text-right">
									...
									<p className="text-muted-foreground text-xs">of all services</p>
								</div>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									<p className="font-medium text-sm">Average Service Time</p>
									<p className="text-muted-foreground text-xs">Per service call</p>
								</div>
								<div className="text-right">
							...
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									...
									<p className="text-muted-foreground text-xs">Follow-up services</p>
								</div>
								<div className="text-right">

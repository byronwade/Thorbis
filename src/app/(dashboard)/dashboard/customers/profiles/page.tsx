    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Detailed customer profiles with contact information and service
          history
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            ...
            <CardDescription>
              Detailed customer information and service preferences
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              Customer profile analytics and trends
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">

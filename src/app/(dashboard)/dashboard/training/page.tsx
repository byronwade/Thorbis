			...
			<div className="relative w-full max-w-6xl space-y-12 text-center">
				...
				<div className="space-y-4">
					...
					<p className="mx-auto max-w-3xl text-foreground/60 text-xl leading-relaxed">
						A comprehensive learning management system bringing together company training, industry partnerships, and
						professional certifications - all in one place.
					</p>
				</div>
					...
					<div>
						...
						<div className="grid gap-6 sm:grid-cols-2">
							...
							<div className="rounded-xl border border-warning/20 bg-gradient-to-br from-yellow-500/10 to-transparent p-6 text-left">
								...
								<div className="flex flex-wrap gap-2">
									<span className="rounded-full bg-warning/10 px-2 py-1 text-xs">Advanced Training</span>
									<span className="rounded-full bg-warning/10 px-2 py-1 text-xs">Leadership</span>
									<span className="rounded-full bg-warning/10 px-2 py-1 text-xs">Industry Certified</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="rounded-2xl border border-primary/10 bg-gradient-to-br from-primary/5 to-transparent p-8">
						...
						<div className="mx-auto max-w-3xl space-y-3 text-left text-muted-foreground">
							<div className="flex items-start gap-3">
								...
								<p className="text-sm">
									<span className="font-medium text-foreground">Thorbis System Training:</span> Master every feature
									with video tutorials, interactive guides, and hands-on exercises
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Sales & Customer Service:</span> Proven techniques to
							...
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Nextstar Partnership:</span> Access exclusive content
									from the nation's premier coaching organization - all integrated in one platform
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Trade Certifications:</span> Real curriculum for
									journeyman and master certifications with EPA, NATE, and state licensing prep
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Company Training:</span> Upload your own videos, create
									custom curricula, and build courses specific to your processes
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Progress & Analytics:</span> Track individual and team
									progress, completion rates, and certification status
								</p>
							</div>
						</div>
					</div>

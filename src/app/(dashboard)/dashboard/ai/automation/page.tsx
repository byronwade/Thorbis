			...
			<div className="relative w-full max-w-6xl space-y-12 text-center">
				...
				<div className="space-y-4">
					...
					<p className="mx-auto max-w-3xl text-foreground/60 text-xl leading-relaxed">
						Tell the AI what you want automated and it creates the workflow for you. No coding, no complex setup - just
						describe what should happen and the AI builds it.
					</p>
				</div>
				...
				<div className="mx-auto max-w-5xl space-y-8 pt-8">
					...
					<div>
						<h2 className="mb-6 font-semibold text-2xl">Create Automations with Natural Language</h2>
						<div className="grid gap-6 sm:grid-cols-2">
							<div className="rounded-xl border border-border/20 bg-gradient-to-br from-purple-500/10 to-transparent p-6 text-left">
								<div className="mb-4 flex items-center gap-3">
									...
									<div>
										<h3 className="font-semibold text-lg">&quot;Send reminder 1 day before appointment&quot;</h3>
									</div>
								</div>
								<p className="mb-3 text-muted-foreground text-sm">
									AI creates automation: When appointment scheduled → Wait until 24 hours before → Send SMS and email
									reminder → Log confirmation
								</p>
							...
							<div className="rounded-xl border border-primary/20 bg-gradient-to-br from-blue-500/10 to-transparent p-6 text-left">
								<div className="mb-4 flex items-center gap-3">
									...
									<div>
										<h3 className="font-semibold text-lg">&quot;Alert me when invoice unpaid 30 days&quot;</h3>
									</div>
								</div>
								<p className="mb-3 text-muted-foreground text-sm">
									AI creates automation: When invoice created → Wait 30 days → Check payment status → If unpaid, notify
									you → Create follow-up task
								</p>
							...
							<div className="rounded-xl border border-success/20 bg-gradient-to-br from-green-500/10 to-transparent p-6 text-left">
								<div className="mb-4 flex items-center gap-3">
									...
									<div>
										<h3 className="font-semibold text-lg">&quot;Auto-assign to nearest available tech&quot;</h3>
									</div>
								</div>
								<p className="mb-3 text-muted-foreground text-sm">
									AI creates automation: When job approved → Find techs with right skills → Check availability →
									Calculate distance → Assign to best match → Notify tech
								</p>
							...
							<div className="rounded-xl border border-warning/20 bg-gradient-to-br from-orange-500/10 to-transparent p-6 text-left">
								<div className="mb-4 flex items-center gap-3">
									...
									<div>
										<h3 className="font-semibold text-lg">&quot;Send invoice when job completed&quot;</h3>
									</div>
								</div>
								<p className="mb-3 text-muted-foreground text-sm">
									AI creates automation: When job marked complete → Generate invoice from work order → Email and SMS to
									customer → Log in finance system
								</p>
					...
					<div>
						<h2 className="mb-6 font-semibold text-2xl">Pre-Built Smart Automations</h2>
						<div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
							...
							<div className="group hover:-translate-y-1 rounded-2xl border border-primary/10 bg-gradient-to-br from-green-500/5 to-transparent p-6 transition-all duration-300 hover:border-success/20 hover:shadow-green-500/10 hover:shadow-lg">
								...
								<h3 className="mb-2 font-semibold text-lg">Auto-Billing & Collection</h3>
								<p className="text-muted-foreground text-sm">
					...
					<div>
						...
						<div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
							...
							<div className="rounded-xl border border-success/20 bg-gradient-to-br from-green-500/10 to-transparent p-5 text-left">
								...
								<p className="mb-3 text-muted-foreground text-xs">
									Invoice unpaid 7 days → Send friendly reminder → Wait 7 days → Send urgent notice → Create collection
									task
								</p>
								<div className="flex items-center gap-1 text-success text-xs dark:text-success">
									<TrendingUp className="size-3" />
							...
							<div className="rounded-xl border border-border/20 bg-gradient-to-br from-purple-500/10 to-transparent p-5 text-left">
								...
								<p className="mb-3 text-muted-foreground text-xs">
									Job completed → Wait 1 hour → Send review request via SMS → Thank customer → Escalate low ratings
								</p>
								<div className="flex items-center gap-1 text-accent-foreground text-xs dark:text-accent-foreground">
									<Sparkles className="size-3" />
							...
							<div className="rounded-xl border border-warning/20 bg-gradient-to-br from-orange-500/10 to-transparent p-5 text-left">
								...
								<p className="mb-3 text-muted-foreground text-xs">
									Appointment scheduled → Send confirmation → 24 hours before → SMS reminder → 2 hours before → Final
									reminder
								</p>
								<div className="flex items-center gap-1 text-warning text-xs dark:text-warning">
							...
							<div className="rounded-xl border border-border/20 bg-gradient-to-br from-pink-500/10 to-transparent p-5 text-left">
								<div className="mb-3 flex items-center gap-2">
									...
									<h3 className="font-semibold text-sm">Lead Nurture Sequence</h3>
								</div>
								<p className="mb-3 text-muted-foreground text-xs">
									New lead → Send welcome email → Day 3: Follow-up call → Day 7: Special offer → Day 14: Final outreach
								</p>
								<div className="flex items-center gap-1 text-accent-foreground text-xs dark:text-accent-foreground">
									<Rocket className="size-3" />
							...
							<div className="rounded-xl border border-teal-500/20 bg-gradient-to-br from-teal-500/10 to-transparent p-5 text-left">
								...
								<p className="mb-3 text-muted-foreground text-xs">
									Job completed → Check photos uploaded → Verify invoice matches work order → Alert if missing → Prevent
									payout
								</p>
							...
							<div className="rounded-xl border border-border/20 bg-gradient-to-br from-indigo-500/10 to-transparent p-5 text-left">
								<div className="mb-3 flex items-center gap-2">
									...
									<h3 className="font-semibold text-sm">Schedule Optimization</h3>
								</div>
								<p className="mb-3 text-muted-foreground text-xs">
									Every night → Analyze next day schedule → Optimize routes → Group nearby jobs → Notify techs of
									changes
								</p>
								<div className="flex items-center gap-1 text-accent-foreground text-xs dark:text-accent-foreground">
									<TrendingUp className="size-3" />
							...
							<div className="rounded-xl border border-warning/20 bg-gradient-to-br from-yellow-500/10 to-transparent p-5 text-left">
								...
								<p className="mb-3 text-muted-foreground text-xs">
									New customer → Send welcome pack → Add to CRM → Schedule follow-up → Offer membership → Track
									engagement
								</p>
								<div className="flex items-center gap-1 text-warning text-xs dark:text-warning">
									<Sparkles className="size-3" />
							...
							<div className="rounded-xl border border-destructive/20 bg-gradient-to-br from-red-500/10 to-transparent p-5 text-left">
								...
								<p className="mb-3 text-muted-foreground text-xs">
									Tech running late → Alert dispatcher → Notify next customer → Offer reschedule option → Track pattern
								</p>
							...
							<div className="rounded-xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/10 to-transparent p-5 text-left">
								...
								<p className="mb-3 text-muted-foreground text-xs">
									HVAC repair booked → AI suggests maintenance plan → Notify tech → Present options → Auto-add to quote
								</p>
							...
							<div className="rounded-xl border border-rose-500/20 bg-gradient-to-br from-rose-500/10 to-transparent p-5 text-left">
								...
								<p className="mb-3 text-muted-foreground text-xs">
									Urgent call received → Find nearest available tech → Auto-book → Notify all parties → Premium pricing
									applied
								</p>
							...
							<div className="rounded-xl border border-border/20 bg-gradient-to-br from-violet-500/10 to-transparent p-5 text-left">
								...
								<p className="mb-3 text-muted-foreground text-xs">
									Equipment installed → Track warranty period → 30 days before expiry → Offer extended warranty →
									Auto-follow-up
								</p>
								<div className="flex items-center gap-1 text-accent-foreground text-xs dark:text-accent-foreground">
					...
					<div className="rounded-2xl border border-primary/10 bg-gradient-to-br from-primary/5 to-transparent p-8">
						...
						<div className="mx-auto max-w-3xl space-y-3 text-left text-muted-foreground">
							<div className="flex items-start gap-3">
								...
								<p className="text-sm">
									<span className="font-medium text-foreground">AI-Powered Creation:</span> Just tell the AI what you
									want automated - it creates the workflow for you in seconds, no coding or complex setup
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Smart Dispatch & Scheduling:</span> AI automatically
									assigns jobs to the best technician, optimizes routes, and manages your schedule
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Financial Automation:</span> Auto-invoice, payment
									reminders, collections, and reconciliation - get paid faster with zero manual work
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">24/7 AI Phone System:</span> AI handles incoming calls,
									books appointments, answers questions, and captures leads - never miss business again
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Custom Workflows:</span> Visual drag-and-drop builder to
									create automations specific to your business processes and requirements
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Team Management:</span> Automated time tracking, payroll
									processing, performance monitoring, and task assignment
								</p>
							</div>
						</div>
					</div>
					...
					{/* Quick Wins */}
					<div>
						<h2 className="mb-6 font-semibold text-2xl">Quick Wins You&apos;ll Get</h2>
						<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
							<div className="rounded-xl border border-success/20 bg-gradient-to-br from-green-500/10 to-transparent p-4 text-center">
								<div className="mb-2 font-bold text-3xl text-success dark:text-success">60%</div>
								<p className="text-muted-foreground text-sm">Less time on scheduling</p>
							</div>

							<div className="rounded-xl border border-primary/20 bg-gradient-to-br from-blue-500/10 to-transparent p-4 text-center">
								<div className="mb-2 font-bold text-3xl text-primary dark:text-primary">3x</div>
							...
							<div className="rounded-xl border border-border/20 bg-gradient-to-br from-purple-500/10 to-transparent p-4 text-center">
								<div className="mb-2 font-bold text-3xl text-accent-foreground dark:text-accent-foreground">30%</div>
								<p className="text-muted-foreground text-sm">Fewer missed appointments</p>
							</div>

							<div className="rounded-xl border border-warning/20 bg-gradient-to-br from-orange-500/10 to-transparent p-4 text-center">
								<div className="mb-2 font-bold text-3xl text-warning dark:text-warning">24/7</div>
								<p className="text-muted-foreground text-sm">Never miss a lead</p>
							</div>
						</div>
					</div>
				</div>

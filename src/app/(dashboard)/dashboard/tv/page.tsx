...
export default function TVDisplayPage() {
  ...
  const goalProgress =
    (widgetData.companyGoals.currentRevenue /
      widgetData.companyGoals.monthlyRevenue) *
    100;
        ...
        return (
          <>
            <Card className="shrink-0">
              ...
              <CardContent>
                <div className="font-bold text-2xl">
                  {managerData.techsOnDuty}
                </div>
                <p className="text-muted-foreground text-xs">
                  {managerData.techsAvailable} available now
                </p>
              </CardContent>
            </Card>
        ...
        return (
          <>
            <Card className="shrink-0">
              ...
              <CardContent>
                <div className="font-bold text-2xl">
                  {CURRENCY_FORMATTER.format(ownerData.monthlyProfit)}
                </div>
                <p className="text-muted-foreground text-xs">
                  {ownerData.profitMargin}% margin
                </p>
              </CardContent>
            </Card>
            ...
            <div className="grid shrink-0 grid-cols-2 gap-2">
              <Card>
                ...
                <CardContent>
                  <div className="font-bold text-2xl">
                    {CURRENCY_FORMATTER.format(ownerData.cashFlow)}
                  </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="font-bold text-2xl">
                    {CURRENCY_FORMATTER.format(ownerData.arAging)}
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between rounded bg-muted p-2">
                    ...
                    <span className="font-bold text-sm">
                      {CURRENCY_FORMATTER.format(ownerData.payrollCosts)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between rounded bg-muted p-2">
                    <span className="font-medium text-sm">Materials</span>
                    <span className="font-bold text-sm">
                      {CURRENCY_FORMATTER.format(ownerData.materialCosts)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between rounded bg-muted p-2">
                    <span className="font-medium text-sm">Overhead</span>
                    <span className="font-bold text-sm">
                      {CURRENCY_FORMATTER.format(ownerData.overhead)}
                    </span>
                  </div>
                  <Separator />
          ...
          <>
            ...
            <div className="grid shrink-0 grid-cols-2 gap-2">
              <Card>
                ...
                <CardContent>
                  <div className="font-bold text-2xl">
                    {NUMBER_FORMATTER.format(widgetData.jobsCompleted.total)}
                  </div>
                  <p className="text-muted-foreground text-xs">
                    +{widgetData.jobsCompleted.change}% from last period
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="font-bold text-2xl">
                    {widgetData.customerRating.rating}
                  </div>
                  <p className="text-muted-foreground text-xs">
                    +{widgetData.customerRating.change}% from last period
                  </p>
                </CardContent>
              </Card>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-foreground text-xs">
                        {(
                          (widgetData.companyGoals.currentAvgTicket /
                            widgetData.companyGoals.avgTicketGoal) *
                          100
                        ).toFixed(0)}
                        %
                      </span>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-foreground text-xs">
                        {(
                          (widgetData.companyGoals.currentRating /
                            widgetData.companyGoals.customerRatingGoal) *
                          100
                        ).toFixed(0)}
                        %
                      </span>
                  ...
                  <div className="grid grid-cols-3 gap-2 pt-2">
                    <div className="space-y-1">
                      ...
                      <div className="font-bold text-foreground text-sm">
                        {CURRENCY_FORMATTER.format(
                          widgetData.dailyStats.revenue
                        )}
                      </div>
                      <div className="text-[10px] text-muted-foreground">
                        {widgetData.dailyStats.jobs} jobs
                      </div>
                    </div>
                    <div className="space-y-1">
                      <div className="font-medium text-[10px] text-muted-foreground">
                      ...
                      <div className="font-bold text-foreground text-sm">
                        {CURRENCY_FORMATTER.format(
                          widgetData.weeklyStats.revenue
                        )}
                      </div>
                      <div className="text-[10px] text-muted-foreground">
                        {widgetData.weeklyStats.jobs} jobs
                      </div>
                    </div>
                    <div className="space-y-1">
                      <div className="font-medium text-[10px] text-muted-foreground">
                      ...
                      <div className="font-bold text-foreground text-sm">
                        {CURRENCY_FORMATTER.format(
                          widgetData.monthlyStats.revenue
                        )}
                      </div>
                      <div className="text-[10px] text-muted-foreground">
                        {widgetData.monthlyStats.jobs} jobs
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <header className="flex shrink-0 items-center justify-between rounded-lg border bg-card px-4 py-2">
          <div className="flex items-center gap-3">
            <div className="flex size-10 items-center justify-center rounded-lg bg-primary">
              ...
              {currentView === "manager" && (
                <UserCog className="size-6 text-primary-foreground" />
              )}
              {currentView === "owner" && (
              ...
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-muted-foreground text-xs">
                    Auto-rotates every{" "}
                    {DEFAULT_SLIDE_SETTINGS.rotationInterval / 1000}s
                  </span>
                </div>
                <Badge
                  className="gap-1.5"
                  variant={isManuallyPaused ? "destructive" : "secondary"}
                >
                  {isManuallyPaused ? (
                    <>
            ...
            <div className="grid shrink-0 grid-cols-4 gap-3">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-muted-foreground text-xs">
                    {widgetData.dailyStats.jobs} jobs completed
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-muted-foreground text-xs">
                    {widgetData.weeklyStats.jobs} jobs completed
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="font-bold text-2xl">
                    {CURRENCY_FORMATTER.format(widgetData.avgTicket.value)}
                  </div>
                  <p className="text-muted-foreground text-xs">
                    +{widgetData.avgTicket.change}% from last period
                  </p>
                </CardContent>
              </Card>
            ...
            <Card className="pointer-events-auto">
              <CardContent className="p-3">
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <Badge
                      className="bg-secondary px-2 py-1 font-mono text-secondary-foreground"
                      variant="outline"
                    >
                      ← →
                    </Badge>
        ...
        <Dialog onOpenChange={setShowViewDialog} open={showViewDialog}>
          <DialogContent className="sm:max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Select a view optimized for different roles or exit to dashboard
              </DialogDescription>
            </DialogHeader>
            <div className="grid grid-cols-2 gap-4 py-4">
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <div className="mt-1 text-muted-foreground text-xs">
                    General performance metrics for all staff
                  </div>
                </div>
              </Button>
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <div className="mt-1 text-muted-foreground text-xs">
                    Call metrics, customer service stats
                  </div>
                </div>
              </Button>
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <div className="mt-1 text-muted-foreground text-xs">
                    Team performance, scheduling, operations
                  </div>
                </div>
              </Button>
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <div className="mt-1 text-muted-foreground text-xs">
                    Financial overview, KPIs, growth metrics
                  </div>
                </div>
              </Button>
            </div>

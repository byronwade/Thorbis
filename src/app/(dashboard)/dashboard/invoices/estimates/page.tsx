/**
 * Invoices > Estimates Page - Server Component
 *
	...
	return (
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">Manage service estimates, quotes, and proposal tracking</p>
			</div>
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Total Estimates</CardTitle>
						<svg
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
				<Card className="col-span-4">
					<CardHeader>
						...
						<CardDescription>Latest estimates and proposal status</CardDescription>
					</CardHeader>
					<CardContent>
							...
							{[
								...
								<div className="flex items-center gap-4 rounded-lg border p-4" key={index}>
									<div className="flex size-12 items-center justify-center rounded-full bg-accent">
										<span className="font-medium text-sm">{estimate.estimateId}</span>
									</div>
									<div className="flex-1 space-y-1">
										<div className="flex items-center gap-2">
											<p className="font-medium text-sm leading-none">{estimate.customer}</p>
											<span
										...
										<p className="text-muted-foreground text-sm">{estimate.services}</p>
						...
						<div className="space-y-4">
							...
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									...
									<p className="text-muted-foreground text-xs">Time to decision</p>
								</div>
								<div className="text-right">
									<p className="font-bold text-sm">3.2 days</p>
									<p className="text-muted-foreground text-xs">-0.5 days from last month</p>
								</div>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
							...
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									...
									<p className="text-muted-foreground text-xs">From pending estimates</p>
								</div>
								<div className="text-right">
							...
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									...
									<p className="text-muted-foreground text-xs">Customer engagement</p>
								</div>
								<div className="text-right">

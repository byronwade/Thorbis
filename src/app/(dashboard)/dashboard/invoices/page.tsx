...
export default async function InvoicesPage() {
  ...
  const { data: invoicesData, error } = await supabase
    ...
    .limit(10_000); // Fetch all invoices (increase if you have more)
  ...
  console.log(
    "📊 First 3 invoice numbers:",
    invoicesData?.slice(0, 3).map((i: any) => i.invoice_number)
  );
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Stats Cards */}
      <div className="border-border/50 border-b bg-background/95 px-4 py-4 backdrop-blur supports-[backdrop-filter]:bg-background/60">

/**
 * Invoices > Create Page - Server Component
 *
	...
	return (
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">Create new invoices, manage billing details, and process payments</p>
			</div>
						...
						<div className="space-y-4">
							<div className="grid gap-4 md:grid-cols-2">
								...
								<div>
									...
									<input className="w-full rounded-md border p-2" defaultValue="2024-01-25" type="date" />
								</div>
							</div>

							<div>
								<label className="font-medium text-sm">Service Description</label>
								<textarea
							...
							<div className="grid gap-4 md:grid-cols-3">
								...
								<div>
									...
									<input className="w-full rounded-md border p-2" placeholder="2.5" type="number" />
								</div>
								<div>
									<label className="font-medium text-sm">Rate ($/hr)</label>
									<input className="w-full rounded-md border p-2" placeholder="75" type="number" />
								</div>
							</div>
							...
							<div className="grid gap-4 md:grid-cols-2">
								<div>
									...
									<input className="w-full rounded-md border p-2" placeholder="50.00" type="number" />
								</div>
								<div>
									<label className="font-medium text-sm">Total Amount</label>
									<input className="w-full rounded-md border p-2" placeholder="237.50" readOnly type="number" />
								</div>
							</div>
							...
							<div className="flex gap-2">
								<button className="rounded-md bg-primary px-4 py-2 text-primary-foreground">Create Invoice</button>
								<button className="rounded-md border px-4 py-2">Save as Draft</button>
							</div>
						</div>
					</CardContent>
				</Card>
						...
						<div className="space-y-4">
							<div className="flex items-center gap-4 rounded-lg bg-accent p-3">
								...
								<div>
									...
									<p className="text-muted-foreground text-xs">Create from scratch</p>
								</div>
							</div>
							<div className="flex items-center gap-4 rounded-lg bg-accent p-3">
								<div className="flex size-9 items-center justify-center rounded-full bg-primary text-primary-foreground">
								...
								<div>
									...
									<p className="text-muted-foreground text-xs">Use existing template</p>
								</div>
							</div>
							<div className="flex items-center gap-4 rounded-lg bg-accent p-3">
								<div className="flex size-9 items-center justify-center rounded-full bg-primary text-primary-foreground">
								...
								<div>
									...
									<p className="text-muted-foreground text-xs">Create from completed job</p>
								</div>
							</div>
							<div className="flex items-center gap-4 rounded-lg bg-accent p-3">
								<div className="flex size-9 items-center justify-center rounded-full bg-primary text-primary-foreground">
								...
								<div>
									...
									<p className="text-muted-foreground text-xs">Set up recurring billing</p>
								</div>
							</div>
						</div>
					</CardContent>

	...
	return (
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">Loans, lines of credit, and business funding options</p>
			</div>
			...
			<div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Credit Line Available</CardTitle>
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Monthly Payments</CardTitle>

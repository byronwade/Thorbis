...
import { Bell, Building2, Calendar, Clock, CreditCard, FileText, Settings, Shield, Users } from "lucide-react";
	...
	return (
		<div className="space-y-6">
			...
			<div>
				...
				<p className="text-muted-foreground">Configure payroll preferences and company settings</p>
			</div>

	...
	return (
		<div className="space-y-6">
			...
			<div>
				...
				<p className="text-muted-foreground">Generate and download payroll analytics and reports</p>
			</div>
			...
			<div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
				<Card>
					...
					<CardContent>
						...
						<p className="text-muted-foreground text-xs">Available report types</p>
					</CardContent>
				</Card>
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
					...
					<div className="space-y-4" key={category.title}>
						...
						<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
							{category.reports.map((report) => {
								...
								return (
									<Card className="transition-all hover:border-primary/50 hover:shadow-md" key={report.name}>
										<CardHeader>
						...
						<div className="flex items-center justify-between rounded-lg border p-4">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-muted-foreground text-sm">Every 2nd Friday at 9:00 AM</p>
								</div>
							</div>
						...
						<div className="flex items-center justify-between rounded-lg border p-4">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-muted-foreground text-sm">1st of every month at 8:00 AM</p>
								</div>
							</div>
							<Button size="sm" variant="ghost">
								Edit
						...
						<div className="flex items-center justify-between rounded-lg border p-4">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-muted-foreground text-sm">First day of quarter at 9:00 AM</p>
								</div>
							</div>
							<Button size="sm" variant="ghost">
								Edit

	...
	return (
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">Manage technician availability, time off, and scheduling preferences</p>
			</div>
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Available Today</CardTitle>
						<svg
				...
				<Card>
					...
					<CardContent>
						...
						<p className="text-muted-foreground text-xs">Expected back tomorrow</p>
					</CardContent>
				</Card>

				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Utilization Rate</CardTitle>
						<svg
							className="size-4 text-muted-foreground"
							fill="none"
							stroke="currentColor"
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
				<Card className="col-span-4">
					<CardHeader>
						...
						<CardDescription>Current availability status and schedule preferences</CardDescription>
					</CardHeader>
					<CardContent>
							...
							{[
								...
								<div className="flex items-center gap-4 rounded-lg border p-4" key={index}>
									...
									<div className="flex-1 space-y-1">
										...
										<p className="text-muted-foreground text-sm">Skills: {tech.skills.join(", ")}</p>
									</div>
									<div className="text-right">
										<p className="font-medium text-sm">{tech.workload}</p>
										<p className="text-muted-foreground text-xs">Next: {tech.nextAvailable}</p>
									</div>
								</div>
							))}
						</div>

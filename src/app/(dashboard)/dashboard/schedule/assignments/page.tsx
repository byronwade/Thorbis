		...
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">
					Manage job assignments, technician allocation, and workload distribution
				</p>
			</div>
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				...
				<Card>
					...
					<CardContent>
						...
						<p className="text-muted-foreground text-xs">6 pending assignment</p>
					</CardContent>
				</Card>
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
				<Card className="col-span-4">
					<CardHeader>
						...
						<CardDescription>Active job assignments and technician workload</CardDescription>
					</CardHeader>
					<CardContent>
							...
							{[
								...
								<div className="flex items-center gap-4 rounded-lg border p-4" key={index}>
									<div className="flex size-12 items-center justify-center rounded-full bg-accent">
										<span className="font-medium text-sm">{assignment.jobId}</span>
									</div>
									<div className="flex-1 space-y-1">
										<div className="flex items-center gap-2">
											<p className="font-medium text-sm leading-none">{assignment.customer}</p>
											<span
										...
										<p className="text-muted-foreground text-sm">{assignment.service}</p>
										<p className="text-muted-foreground text-sm">{assignment.location}</p>
									</div>
									<div className="text-right">
										<p className="font-medium text-sm">{assignment.technician}</p>
										<p className="text-muted-foreground text-xs">ETA: {assignment.eta}</p>
									</div>
								</div>
							))}
						</div>
				...
				<Card className="col-span-3">
					<CardHeader>
						...
						<CardDescription>Workload distribution and performance</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="space-y-4">
							...
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									...
									<p className="text-muted-foreground text-xs">Lead Technician</p>
								</div>
								<div className="text-right">

/**
 * Schedule > Technicians Page - Server Component
 *
...
export default function TechniciansPage() {
	return (
		<div className="space-y-6">
			<div>
				<h1 className="font-bold text-3xl tracking-tight">Technician Schedules</h1>
				<p className="text-muted-foreground">Manage technician schedules, availability, and workload</p>
			</div>
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Total Technicians</CardTitle>
						<svg
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Average Utilization</CardTitle>
						<svg
							className="size-4 text-muted-foreground"
							fill="none"
							stroke="currentColor"
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Overtime Hours</CardTitle>
						<svg
							className="size-4 text-muted-foreground"
							fill="none"
							stroke="currentColor"
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
				<Card className="col-span-4">
					<CardHeader>
						...
						<CardDescription>Current technician schedules and assignments</CardDescription>
					</CardHeader>
					<CardContent>
							...
							{[
								...
								<div className="flex items-center gap-4 rounded-lg border p-4" key={index}>
									...
									<div className="flex-1 space-y-1">
										...
										<p className="text-muted-foreground text-sm">{tech.shift}</p>
										<p className="text-muted-foreground text-sm">{tech.currentJob}</p>
									</div>
									<div className="text-right">
										<p className="font-medium text-sm">Next Job</p>
										<p className="text-muted-foreground text-xs">{tech.nextJob}</p>
									</div>
								</div>
							))}
						</div>
						...
						<div className="space-y-4">
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									...
									<p className="text-muted-foreground text-xs">8 technicians scheduled</p>
								</div>
								<div className="text-right">
									<p className="font-bold text-sm">12 jobs</p>
									<p className="text-muted-foreground text-xs">8:00 AM - 6:00 PM</p>
								</div>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									<p className="font-medium text-sm">Tuesday</p>
									<p className="text-muted-foreground text-xs">10 technicians scheduled</p>
								</div>
								<div className="text-right">
									<p className="font-bold text-sm">15 jobs</p>
									<p className="text-muted-foreground text-xs">7:30 AM - 7:00 PM</p>
								</div>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									<p className="font-medium text-sm">Wednesday</p>
									<p className="text-muted-foreground text-xs">9 technicians scheduled</p>
								</div>
								<div className="text-right">
									<p className="font-bold text-sm">13 jobs</p>
									<p className="text-muted-foreground text-xs">8:00 AM - 6:30 PM</p>
								</div>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									<p className="font-medium text-sm">Thursday</p>
									<p className="text-muted-foreground text-xs">11 technicians scheduled</p>
								</div>
								<div className="text-right">
									<p className="font-bold text-sm">18 jobs</p>
									<p className="text-muted-foreground text-xs">7:00 AM - 8:00 PM</p>
								</div>
							</div>
							<div className="flex items-center justify-between rounded-lg bg-accent p-3">
								<div>
									<p className="font-medium text-sm">Friday</p>
									<p className="text-muted-foreground text-xs">7 technicians scheduled</p>
								</div>
								<div className="text-right">
									<p className="font-bold text-sm">10 jobs</p>
									<p className="text-muted-foreground text-xs">8:00 AM - 5:00 PM</p>
								</div>
							</div>
						</div>
					</CardContent>

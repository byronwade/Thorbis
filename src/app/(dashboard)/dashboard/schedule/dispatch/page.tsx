	...
	return (
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">Real-time view of technician locations and job assignments</p>
			</div>
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Available Techs</CardTitle>
						<svg
							className="size-4 text-muted-foreground"
							fill="none"
							stroke="currentColor"
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="font-medium text-sm">Pending Dispatch</CardTitle>
						<svg
							className="size-4 text-muted-foreground"
							fill="none"
							stroke="currentColor"
				...
				<Card>
					...
					<CardContent>
						...
						<p className="text-muted-foreground text-xs">-2min from yesterday</p>
					</CardContent>
				</Card>
			</div>
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
				<Card className="col-span-4">
					<CardHeader>
						...
						<CardDescription>Real-time location and availability of technicians</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="space-y-4">
							{[
								...
								<div className="flex items-center gap-4 rounded-lg border p-3" key={index}>
									...
									<div className="flex-1 space-y-1">
										...
										<p className="text-muted-foreground text-sm">{tech.location}</p>
									</div>
						...
						<div className="space-y-4">
							{[
								...
								<div className="flex items-center gap-4 rounded-lg border p-3" key={index}>
									...
									<div className="flex-1 space-y-1">
										<p className="font-medium text-sm leading-none">{job.customer}</p>
										<p className="text-muted-foreground text-sm">{job.service}</p>
									</div>
									<div className="text-right">
										<p

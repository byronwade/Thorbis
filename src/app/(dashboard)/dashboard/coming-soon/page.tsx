				...
				<div className="space-y-8">
					...
					<div className="space-y-4">
						...
						<p className="mx-auto max-w-3xl text-foreground/60 text-xl leading-relaxed">
							Powerful new features coming to Thorbis - from AI automation and intelligent calling to comprehensive
							payroll, training, and financial management.
						</p>
					</div>
				</div>
				...
				<div className="space-y-16 pt-8">
					...
					<div className="space-y-8">
						<div className="space-y-2">
							...
							<p className="text-muted-foreground">Complete system control through natural conversation</p>
						</div>
					...
					<div className="space-y-8">
						...
						<div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
							<div className="rounded-xl border border-primary/10 bg-gradient-to-br from-cyan-500/5 to-transparent p-6 text-left">
								...
								<p className="text-muted-foreground text-sm">
									AI answers every call, books appointments, quotes pricing, and escalates when needed
								</p>
							</div>
							...
							<div className="rounded-xl border border-primary/10 bg-gradient-to-br from-blue-500/5 to-transparent p-6 text-left">
								...
								<p className="text-muted-foreground text-sm">
									AI calls customers with quotes, appointment reminders, and payment collections automatically
								</p>
							</div>
							...
							<div className="rounded-xl border border-primary/10 bg-gradient-to-br from-purple-500/5 to-transparent p-6 text-left">
								...
								<p className="text-muted-foreground text-sm">
									Automated calling campaigns for seasonal services, warranty renewals, and maintenance
								</p>
							</div>
						</div>
					</div>
					...
					<div className="space-y-8">
						<div className="space-y-2">
							...
							<p className="text-muted-foreground">Complete payroll solution with time tracking and compliance</p>
						</div>
						...
						<div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
							<div className="flex flex-col items-center gap-2 rounded-xl border border-primary/10 bg-gradient-to-br from-primary/5 to-transparent p-5">
								...
								<span className="text-center text-muted-foreground text-xs">Profiles, roles & pay rates</span>
							</div>
							...
							<div className="flex flex-col items-center gap-2 rounded-xl border border-primary/10 bg-gradient-to-br from-primary/5 to-transparent p-5">
								...
								<span className="text-center text-muted-foreground text-xs">Timesheets & approvals</span>
							</div>
							...
							<div className="flex flex-col items-center gap-2 rounded-xl border border-primary/10 bg-gradient-to-br from-primary/5 to-transparent p-5">
								...
								<span className="text-center text-muted-foreground text-xs">Automated processing</span>
							</div>
							...
							<div className="flex flex-col items-center gap-2 rounded-xl border border-primary/10 bg-gradient-to-br from-primary/5 to-transparent p-5">
								...
								<span className="text-center text-muted-foreground text-xs">W-2s, 1099s & reporting</span>
							</div>
						</div>
					</div>
					...
					<div className="space-y-8">
						<div className="space-y-2">
							...
							<p className="text-muted-foreground">Business loans and consumer financing - increase close rates</p>
						</div>
					...
					<div className="space-y-8">
						<div className="space-y-2">
							...
							<p className="text-muted-foreground">Lead management, reviews, campaigns, and multi-channel marketing</p>
						</div>
						...
						<div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
							<div className="rounded-xl border border-primary/10 bg-gradient-to-br from-pink-500/5 to-transparent p-5 text-left">
								...
								<p className="text-muted-foreground text-sm">Capture, score, and nurture leads automatically</p>
							</div>
							...
							<div className="rounded-xl border border-primary/10 bg-gradient-to-br from-yellow-500/5 to-transparent p-5 text-left">
								...
								<p className="text-muted-foreground text-sm">Monitor and respond to Google, Facebook, Yelp reviews</p>
							</div>
							...
							<div className="rounded-xl border border-primary/10 bg-gradient-to-br from-blue-500/5 to-transparent p-5 text-left">
								...
								<p className="text-muted-foreground text-sm">Multi-channel campaigns via email, SMS, and direct mail</p>
							</div>
							...
							<div className="rounded-xl border border-primary/10 bg-gradient-to-br from-green-500/5 to-transparent p-5 text-left">
								...
								<p className="text-muted-foreground text-sm">Track ROI, conversion rates, and campaign performance</p>
							</div>
						</div>
					</div>
					...
					<div className="space-y-8">
						...
						<div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
							<div className="rounded-xl border border-primary/10 bg-gradient-to-br from-blue-500/5 to-transparent p-5 text-left">
								...
								<p className="text-muted-foreground text-sm">Master Thorbis with video tutorials and guides</p>
							</div>
							...
							<div className="rounded-xl border border-primary/10 bg-gradient-to-br from-green-500/5 to-transparent p-5 text-left">
								...
								<p className="text-muted-foreground text-sm">Upload your own videos and create custom curricula</p>
							</div>
						</div>
					</div>
					...
					<div className="space-y-8">
						<div className="space-y-2">
							...
							<p className="text-muted-foreground">Real-time dashboards, custom reports, and business intelligence</p>
						</div>
						...
						<div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
							<div className="flex flex-col items-center gap-2 rounded-xl border border-primary/10 bg-gradient-to-br from-primary/5 to-transparent p-5">
								...
								<span className="text-center text-muted-foreground text-xs">KPIs, trends & forecasting</span>
							</div>
							...
							<div className="flex flex-col items-center gap-2 rounded-xl border border-primary/10 bg-gradient-to-br from-primary/5 to-transparent p-5">
								...
								<span className="text-center text-muted-foreground text-xs">Build & save reports</span>
							</div>
							...
							<div className="flex flex-col items-center gap-2 rounded-xl border border-primary/10 bg-gradient-to-br from-primary/5 to-transparent p-5">
								...
								<span className="text-center text-muted-foreground text-xs">Charts, graphs & dashboards</span>
							</div>
						</div>
					</div>
					...
					<div className="space-y-8">
						<div className="space-y-2">
							...
							<p className="text-muted-foreground">Track stock, manage vendors, and automate purchase orders</p>
						</div>
					...
					<div className="rounded-2xl border border-primary/10 bg-gradient-to-br from-primary/5 to-transparent p-8">
						...
						<p className="mx-auto max-w-2xl text-foreground/60 leading-relaxed">
							These features are in active development and will be rolling out progressively. In the meantime, explore
							the platform and reach out if you have questions or need assistance.
						</p>

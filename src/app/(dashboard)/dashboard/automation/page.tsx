			...
			<div className="relative w-full max-w-6xl space-y-12 text-center">
				...
				<div className="space-y-4">
					...
					<p className="mx-auto max-w-3xl text-foreground/60 text-xl leading-relaxed">
						Intelligent automation that runs your business on autopilot - from first call to final payment, powered by
					...
					<div>
						...
						<div className="rounded-2xl border border-border/20 bg-gradient-to-br from-pink-500/10 to-transparent p-8">
							...
							<div className="flex flex-wrap gap-2 text-xs">
								<span className="rounded-full bg-accent/10 px-3 py-1">50+ Templates</span>
								<span className="rounded-full bg-accent/10 px-3 py-1">Zapier Integration</span>
								<span className="rounded-full bg-accent/10 px-3 py-1">2000+ App Connections</span>
								<span className="rounded-full bg-accent/10 px-3 py-1">No Code Required</span>
							</div>
						</div>
					</div>
					...
					<div className="rounded-2xl border border-primary/10 bg-gradient-to-br from-primary/5 to-transparent p-8">
						...
						<div className="mx-auto max-w-3xl space-y-3 text-left text-muted-foreground">
							<div className="flex items-start gap-3">
								...
								<p className="text-sm">
									<span className="font-medium text-foreground">AI-Powered Intelligence:</span> Natural language
									commands to run reports, dispatch technicians, and automate decisions - like having a virtual
									operations manager
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Smart Job Assignment:</span> Automatically match jobs to
									the best technician based on skills, certifications, location, and real-time availability
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Auto-Billing & Collections:</span> Generate invoices
									instantly, auto-charge cards on file, and send escalating payment reminders - improve cash flow by 40%
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">24/7 Customer Communication:</span> AI answers phones,
									books appointments, sends SMS reminders, and follows up after jobs - never miss a lead
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Custom Workflow Builder:</span> Visual drag-and-drop
									interface to create any automation with triggers, conditions, and actions - no coding required
								</p>
							</div>
							<div className="flex items-start gap-3">
								<CheckCircle2 className="mt-0.5 size-5 shrink-0 text-success dark:text-success" />
								<p className="text-sm">
									<span className="font-medium text-foreground">Integration Ecosystem:</span> Connect with 2000+ apps
									via Zapier, QuickBooks, Stripe, Twilio, and more - your entire business connected
								</p>
							</div>
						</div>
					</div>

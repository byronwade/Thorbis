...
import { PurchaseOrdersTable, type PurchaseOrder } from "@/components/work/purchase-orders-table";
...
export default function PurchaseOrdersPage() {
	...
	const pending = mockPOs.filter((po) => po.status === "pending_approval").length;
	...
	return (
		<div className="flex h-full flex-col">
			...
			<div className="flex-1 overflow-hidden">
				<PurchaseOrdersTable orders={mockPOs} itemsPerPage={50} />
			</div>
		</div>
	);
}

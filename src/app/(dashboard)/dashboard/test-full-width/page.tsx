		...
		<div className="flex h-full flex-col">
			...
			<div className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
				<div className="flex h-14 items-center px-6">
					...
					<div className="ml-auto text-muted-foreground text-sm">No padding • No max-width • No toolbar</div>
				</div>
			</div>
			...
			<div className="flex flex-1 overflow-hidden">
				...
				<div className="flex flex-1 items-center justify-center bg-gradient-to-br from-primary/5 to-primary/10">
					<div className="max-w-2xl space-y-4 p-8 text-center">
						...
						<p className="text-lg text-muted-foreground">
							This page uses the full viewport width with no container constraints. Perfect for dashboards,
							communication tools, and data-heavy interfaces.
						</p>
				...
				<div className="w-64 border-l bg-muted/10 p-4">
					...
					<p className="text-muted-foreground text-xs">
						The content takes up 100% of the available width. No padding or gap is applied by the layout, allowing the
						page to manage its own spacing.
					</p>
				</div>
			</div>
		</div>

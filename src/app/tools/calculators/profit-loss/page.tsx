...
export default function ProfitLossCalculator() {
	...
	const totalOperatingExpenses =
		rentNum + insuranceNum + utilitiesNum + marketingNum + adminNum + suppliesNum + vehicleNum + otherNum;
			...
			<div className="space-y-4">
				<div className="flex items-center gap-3">
					...
					<div>
						...
						<p className="mt-1 text-muted-foreground">Track revenue, expenses, and calculate your net profit margins</p>
					</div>
				</div>
			</div>
					...
					<Card>
						...
						<CardContent className="space-y-4">
							<div className="space-y-2">
								...
								<Input id="materials" onChange={(e) => setMaterials(e.target.value)} type="number" value={materials} />
							</div>
							<div className="space-y-2">
								<Label htmlFor="labor">Direct Labor Costs ($)</Label>
								<Input id="labor" onChange={(e) => setDirectLabor(e.target.value)} type="number" value={directLabor} />
							</div>
							<div className="space-y-2">
						...
						<CardContent className="space-y-4">
							<div className="grid grid-cols-2 gap-4">
								<div className="space-y-2">
									...
									<Input id="rent" onChange={(e) => setRent(e.target.value)} type="number" value={rent} />
								</div>
								<div className="space-y-2">
						...
						<CardContent>
							<div className="space-y-4">
								<div>
									...
									<p className={`font-bold text-5xl ${netProfit >= 0 ? "text-success" : "text-destructive"}`}>
								...
								<div className="grid grid-cols-2 gap-4">
									<div>
										...
										<p className={`font-semibold text-2xl ${netMargin >= 0 ? "text-success" : "text-destructive"}`}>
											{netMargin.toFixed(1)}%
										</p>
									</div>
									<div>

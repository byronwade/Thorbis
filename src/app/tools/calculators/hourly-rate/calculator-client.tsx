					...
					<div className="mx-auto max-w-5xl space-y-12">
						...
						<section className="scroll-mt-24" id="capacity">
							<div className="mb-6">
								...
								<p className="mt-2 text-muted-foreground text-sm">Define your working hours and billable capacity</p>
							</div>
						...
						<section className="scroll-mt-24 space-y-6" id="expenses">
							...
							<div className="rounded-lg bg-background p-6">
								<div className="mb-4">
									...
									<p className="text-muted-foreground text-sm">Annual business expenses and hourly breakdown</p>
								</div>
								<div className="space-y-4">
									{/* Personnel */}
									<div>
										<h3 className="mb-3 font-semibold text-foreground text-sm">Personnel Costs</h3>
									...
									{/* Insurance & Benefits */}
									<div>
										<h3 className="mb-3 font-semibold text-foreground text-sm">Insurance & Benefits</h3>
										<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
											<div className="space-y-2">
												<LabelWithTooltip
									...
									{/* Vehicle Expenses */}
									<div>
										<h3 className="mb-3 font-semibold text-foreground text-sm">Vehicle Expenses</h3>
										<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
											<div className="space-y-2">
												<LabelWithTooltip
													htmlFor="vehicleFuel"
									...
									{/* Office & Operations */}
									<div>
										<h3 className="mb-3 font-semibold text-foreground text-sm">Office & Operations</h3>
										<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
											<div className="space-y-2">
												<LabelWithTooltip
													htmlFor="rentLease"
									...
									<div>
										<h3 className="mb-3 font-semibold text-foreground text-sm">Marketing & Professional Services</h3>
										<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
											<div className="space-y-2">
												<LabelWithTooltip
									...
									{/* Other Expenses */}
									<div>
										<h3 className="mb-3 font-semibold text-foreground text-sm">Other Expenses</h3>
										<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
											<div className="space-y-2">
												<LabelWithTooltip
							...
							<div className="rounded-lg bg-background p-6">
								<div className="mb-4 flex items-center gap-3">
									...
									<div>
										<h3 className="font-semibold text-lg">12-Month Growth Expenses</h3>
										<p className="text-muted-foreground text-sm">Investment in business growth and expansion</p>
									</div>
								</div>
						...
						<section className="scroll-mt-24" id="overview">
							...
							<div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
								<div className="rounded-lg bg-muted/30 p-4">
									<p className="mb-2 font-medium text-muted-foreground text-xs">Your Hourly Rate</p>
									...
									<p className="mt-1 text-muted-foreground text-xs">With {inputs.profitPercent}% profit margin</p>
								</div>

								<div className="rounded-lg bg-muted/30 p-4">
									<p className="mb-2 font-medium text-muted-foreground text-xs">Annual Billable Hours</p>
									<div className="font-bold text-2xl">{formatNumber(calculations.annualBillableHours)}</div>
								...
								<div className="rounded-lg bg-muted/30 p-4">
									<p className="mb-2 font-medium text-muted-foreground text-xs">Total Annual Expenses</p>
									<div className="font-bold text-2xl">{formatCurrency(calculations.totalExpensesAnnual)}</div>
									<p className="mt-1 text-muted-foreground text-xs">{formatCurrency(calculations.dailyExpense)}/day</p>
								</div>

								<div className="rounded-lg bg-muted/30 p-4">
									<p className="mb-2 font-medium text-muted-foreground text-xs">Annual Revenue Target</p>
									<div className="font-bold text-2xl text-green-600 dark:text-green-500">
										{Number.isFinite(calculations.honestHourlyRate)
											? formatCurrency(calculations.honestHourlyRate * calculations.annualBillableHours)
											: "—"}
									</div>
									<p className="mt-1 text-muted-foreground text-xs">At full capacity</p>
								</div>
							</div>
								...
								<div className="space-y-4">
									<div className="flex items-center justify-between border-border/50 border-b pb-3">
										...
										<div className="text-right">
											<p className="font-bold text-xl">{formatCurrency(calculations.totalOperatingAnnual)}</p>
									...
									<div className="flex items-center justify-between border-border/50 border-b pb-3">
										...
										<div className="text-right">
											<p className="font-bold text-xl">{formatCurrency(calculations.totalGrowthAnnual)}</p>
											<p className="text-muted-foreground text-xs">
									...
									<div className="flex items-center justify-between pt-2">
										...
										<div className="text-right">
											<p className="font-bold text-2xl">{formatCurrency(calculations.totalExpensesAnnual)}</p>
							...
							<div className="grid gap-6 sm:grid-cols-2">
								<div className="rounded-lg bg-background p-6">
									<div className="mb-4 flex items-center gap-2">
										...
										<h3 className="font-semibold text-base">Break-Even Analysis</h3>
									</div>
								...
								<div className="rounded-lg bg-background p-6">
									<div className="mb-4 flex items-center gap-2">
										<TrendingUp className="h-5 w-5" />
										<h3 className="font-semibold text-base">Profit Projections</h3>
									</div>
									<div className="space-y-3">
										<div>
										...
										<Tooltip>
											<TooltipTrigger asChild>
												<div className="cursor-help">
													...
													<p className="mt-2 font-semibold text-2xl">{formatCurrency(calculations.dailyExpense)}</p>
													<p className="mt-1 text-muted-foreground text-xs">Per working day</p>
												</div>
											</TooltipTrigger>
											<TooltipContent>
												<p className="text-xs">
										...
										<Tooltip>
											<TooltipTrigger asChild>
												<div className="cursor-help">
													...
													<p className="mt-1 text-muted-foreground text-xs">Minimum to cover costs</p>
												</div>
											</TooltipTrigger>
											<TooltipContent>
												<p className="text-xs">
										...
										<Tooltip>
											<TooltipTrigger asChild>
												<div className="cursor-help">
													...
													<p className="mt-1 text-muted-foreground text-xs">Average sold per day</p>
												</div>
											</TooltipTrigger>
											<TooltipContent>
												<p className="text-xs">
										...
										<Tooltip>
											<TooltipTrigger asChild>
												<div className="cursor-help">
													...
													<p className="mt-1 text-muted-foreground text-xs">Target with profit margin</p>
												</div>
											</TooltipTrigger>
											<TooltipContent>
												<p className="text-xs">
								...
								<div className="mt-6 rounded-lg bg-muted/30 p-6">
									<div className="flex items-start gap-3">
										...
										<div className="flex-1">
											<h4 className="mb-2 font-semibold text-foreground">Understanding Your Daily Numbers</h4>
									...
									<div className="overflow-hidden rounded-lg bg-muted/30">
										<table className="w-full">
											<thead className="bg-muted/50">
												<tr>
													<th className="px-4 py-3 text-left font-medium text-sm">Time Period</th>
													<th className="px-4 py-3 text-right font-medium text-sm">Expenses</th>
													<th className="px-4 py-3 text-right font-medium text-sm">Revenue (Full Capacity)</th>
													<th className="px-4 py-3 text-right font-medium text-sm">Profit</th>
													<th className="px-4 py-3 text-right font-medium text-sm">Profit Margin</th>
												</tr>
											</thead>
											<tbody className="divide-y divide-border/30">
												<tr className="hover:bg-muted/20">
													<td className="px-4 py-3 font-medium text-sm">Per Hour</td>
												...
												<tr className="hover:bg-muted/20">
													<td className="px-4 py-3 font-medium text-sm">Per Day</td>
													<td className="px-4 py-3 text-right text-sm">{formatCurrency(calculations.dailyExpense)}</td>
													<td className="px-4 py-3 text-right font-medium text-green-600 text-sm dark:text-green-500">
														{Number.isFinite(calculations.dailyRevenueCapacity)
															? formatCurrency(calculations.dailyRevenueCapacity)
															: "—"}
												...
												<tr className="hover:bg-muted/20">
													<td className="px-4 py-3 font-medium text-sm">Per Week</td>
													<td className="px-4 py-3 text-right text-sm">
														{formatCurrency(calculations.totalExpensesAnnual / 52)}
													</td>
													<td className="px-4 py-3 text-right font-medium text-green-600 text-sm dark:text-green-500">
														{Number.isFinite(calculations.honestHourlyRate)
															? formatCurrency((calculations.honestHourlyRate * calculations.annualBillableHours) / 52)
															: "—"}
													</td>
													<td className="px-4 py-3 text-right text-green-600 text-sm dark:text-green-500">
														{Number.isFinite(calculations.honestHourlyRate)
												...
												<tr className="hover:bg-muted/20">
													<td className="px-4 py-3 font-medium text-sm">Per Month</td>
													<td className="px-4 py-3 text-right text-sm">
														{formatCurrency(calculations.totalExpensesAnnual / 12)}
													</td>
													<td className="px-4 py-3 text-right font-medium text-green-600 text-sm dark:text-green-500">
														{Number.isFinite(calculations.honestHourlyRate)
															? formatCurrency((calculations.honestHourlyRate * calculations.annualBillableHours) / 12)
															: "—"}
													</td>
													<td className="px-4 py-3 text-right text-green-600 text-sm dark:text-green-500">
														{Number.isFinite(calculations.honestHourlyRate)

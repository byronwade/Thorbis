			...
			<div className="space-y-4">
				<div className="flex items-center gap-3">
					<div className="flex size-12 items-center justify-center rounded-xl bg-gradient-to-br from-green-500/15 to-green-500/5">
						<BadgeCheck className="text-success dark:text-success size-6" />
					</div>
					<div>
				...
				<CardContent className="space-y-3">
					...
					<div className="grid gap-3 sm:grid-cols-2">
						<div className="flex items-start gap-2">
							...
							<div>
								<p className="text-sm font-semibold">Top of Search Results</p>
						...
						<div className="flex items-start gap-2">
							<CheckCircle className="text-success mt-0.5 size-4 shrink-0" />
							<div>
								<p className="text-sm font-semibold">Pay Per Lead Only</p>
								<p className="text-muted-foreground text-xs">
						...
						<div className="flex items-start gap-2">
							<CheckCircle className="text-success mt-0.5 size-4 shrink-0" />
							<div>
								<p className="text-sm font-semibold">Google Screened Badge</p>
								<p className="text-muted-foreground text-xs">
						...
						<div className="flex items-start gap-2">
							<CheckCircle className="text-success mt-0.5 size-4 shrink-0" />
							<div>
								<p className="text-sm font-semibold">Higher Conversion Rates</p>
								<p className="text-muted-foreground text-xs">
			...
			<Card>
				...
				<CardContent>
					<div className="space-y-4">
						...
						<div className="space-y-2">
							<h4 className="text-sm font-semibold">Available Trades:</h4>
						...
						<div className="space-y-2">
							<h4 className="text-sm font-semibold">Setup Timeline:</h4>
							<ul className="text-muted-foreground ml-4 list-disc space-y-1 text-sm">
			...
			<div className="grid gap-4 md:grid-cols-2">
					...
					<CardContent>
						<div className="space-y-3">
							<div className="flex justify-between border-b pb-2">
								...
								<span className="text-sm font-semibold">$25-$45</span>
							</div>
							<div className="flex justify-between border-b pb-2">
								<span className="text-sm">Plumbing</span>
								<span className="text-sm font-semibold">$20-$40</span>
							</div>
							<div className="flex justify-between border-b pb-2">
								<span className="text-sm">Electrical</span>
								<span className="text-sm font-semibold">$30-$50</span>
							</div>
							<div className="flex justify-between border-b pb-2">
							...
							<div className="flex justify-between">
								...
								<span className="text-sm font-semibold">+20-30%</span>
							</div>
						</div>
				...
				<Card>
					...
					<CardContent>
						<div className="space-y-3">
							<div>
								<p className="text-sm font-semibold">Average Conversion Rate</p>
								<p className="text-success text-2xl font-bold">30-40%</p>
								<p className="text-muted-foreground text-xs">
									Of leads that contact you become paying customers
								</p>
							</div>
							<div>
								<p className="text-sm font-semibold">Average ROI</p>
								<p className="text-success text-2xl font-bold">3-5x</p>
								<p className="text-muted-foreground text-xs">

...
import { Search, MapPin, Star, Phone, Clock, Image, MessageSquare, TrendingUp, CheckCircle, AlertCircle, ExternalLink } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <Card className="border-blue-500/20 bg-gradient-to-br from-blue-500/10 to-transparent">
        ...
        <CardContent className="space-y-3">
          <p className="text-sm">
            Google Business Profile (formerly Google My Business) is the #1 most important online marketing tool for local trade businesses.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-sm">
                  Go to <Link href="https://business.google.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">business.google.com</Link> and search for your business name.
                  If it exists, claim it. If not, create a new listing.
                </p>
                <p className="text-muted-foreground text-sm">
                  Google will verify your business via postcard (5-7 days), phone, email, or instant verification if eligible.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-2">
                ...
                <ul className="ml-4 space-y-1 text-muted-foreground text-sm list-disc">
                  <li><strong>Business name, address, phone</strong> (NAP - must match your website)</li>
                  <li><strong>Category:</strong> Select primary (HVAC, Plumbing, Electrician) + 9 additional categories</li>
                  <li><strong>Service areas:</strong> List all cities/zip codes you serve</li>
                  <li><strong>Hours:</strong> Regular hours + special hours (holidays)</li>
                  <li><strong>Website & booking link</strong></li>
                  <li><strong>Business description</strong> (750 characters max)</li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-2">
                ...
                <ul className="ml-4 space-y-1 text-muted-foreground text-sm list-disc">
                  <li><strong>Logo:</strong> Square, 250x250px minimum</li>
                  <li><strong>Cover photo:</strong> 1024x576px, showcases your work</li>
                  <li><strong>Team photos:</strong> Your technicians, trucks, uniforms</li>
                  <li><strong>Work photos:</strong> Before/after, completed projects (20-50 photos)</li>
                  <li><strong>Interior/exterior:</strong> Office, shop, warehouse</li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <div className="flex size-8 shrink-0 items-center justify-center rounded-full bg-primary/10 font-bold text-primary">5</div>
              <div className="space-y-2">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardContent className="text-sm">
            <p className="text-muted-foreground">
              Customers can ask questions directly on your profile. Monitor and answer within 24 hours.
              Seed with FAQs like "Do you offer emergency service?" and "What areas do you serve?"
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="text-sm">
            <p className="text-muted-foreground">
              Mobile users can call directly from your profile. Track call volume in insights.
              Make sure your phone number is correct and answered during business hours.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="text-sm">
            <p className="text-muted-foreground">
              Customers get directions to your location. For service area businesses, hide your address
              and show service cities instead (better for privacy and broader reach).
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="text-sm">
            <p className="text-muted-foreground">
              Share updates, promotions, completed projects as posts. Photos stay for 7 days, events show until the date passes.
        ...
        <Card>
          ...
          <CardContent className="text-sm">
            <p className="text-muted-foreground">
              Get notifications for new reviews. Responding increases trust and shows you care.
              Use templates for faster responses but personalize each one.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="text-sm">
            <p className="text-muted-foreground">
              Add attributes like "24/7 Emergency Service", "Licensed & Insured", "Free Estimates".
              Update special hours for holidays to avoid frustrated customers.
            </p>
          </CardContent>
        </Card>
      </div>

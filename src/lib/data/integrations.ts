...
export const integrations: Integration[] = [
	// Accounting
	{
		...
		description: "Sync invoices, payments, and customer data with QuickBooks Online for seamless accounting.",
		category: "accounting",
	...
	},
	{
		id: "wisetack",
		name: "Wisetack",
		description: "Offer consumer financing options to increase job approval rates and ticket sizes.",
		category: "payment",

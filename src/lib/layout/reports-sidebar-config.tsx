...
export const REPORT_BUILDER_CATEGORIES = [
	...
	{ id: "operations", label: "Operations", icon: Briefcase, color: "bg-blue-500" },
...
export const CHART_TYPES = [
	...
	{ id: "bar", label: "Bar Chart", icon: BarChart3, description: "Best for comparisons" },
	{ id: "pie", label: "Pie Chart", icon: PieChart, description: "Best for distributions" },
	{ id: "area", label: "Area Chart", icon: TrendingUp, description: "Best for cumulative data" },
];

...
export const estimateImportSchema = z.object({
	customer_id: uuidSchema.optional(),
	customer_name: z.string().min(1, "Customer name is required").optional(),
	estimate_number: z.string().min(1, "Estimate number is required").max(50, "Estimate number is too long"),
	date: dateSchema,
...
export const contractImportSchema = z.object({
	customer_id: uuidSchema.optional(),
	customer_name: z.string().min(1, "Customer name is required").optional(),
	contract_number: z.string().min(1, "Contract number is required").max(50, "Contract number is too long"),
...
export const equipmentImportSchema = z.object({
	equipment_name: z.string().min(1, "Equipment name is required").max(200, "Equipment name is too long"),

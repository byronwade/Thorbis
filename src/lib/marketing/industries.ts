...
const INDUSTRY_CONTENT: MarketingIndustryContent[] = [
	{
		...
		fieldTypes: ["Residential Service", "Light Commercial", "New Construction", "Commercial HVAC"],
		painPoints: [
		...
		stats: [
			...
			},
			{
				...
				value: "+24%",
				description: "more calls handled per dispatcher during summer/winter peak seasons.",
			},
			{
		...
		faq: [
			{
				question: "Can Thorbis manage HVAC maintenance agreements and service contracts?",
				answer:
			...
			{
				question: "Does Thorbis track manufacturer rebates and warranty registrations?",
				answer:
			...
			{
				question: "Can technicians use Thorbis offline in basements and attics?",
				answer:
			...
			{
				question: "How does Thorbis compare to ServiceTitan for HVAC contractors?",
				answer:
			...
			{
				question: "Does Thorbis integrate with HVAC supplier catalogs and pricing?",
				answer:
	...
	},
	{
		...
		seo: {
			title: "Plumbing Business Software & Dispatch | #1 for Plumbers | Thorbis",
			description:
		...
		fieldTypes: ["Residential Service", "Commercial Plumbing", "Drain & Sewer", "New Construction"],
		painPoints: [
	...
	},
	{
		...
		heroTitle: "Electrical Contractor Software Built for Safety & Profitability",
		heroDescription:
		...
		seo: {
			title: "Electrical Contractor Software & Dispatch | #1 for Electricians | Thorbis",
			description:
		...
		fieldTypes: ["Residential Service", "Commercial TI", "Industrial", "New Construction"],
		painPoints: [
		...
		faq: [
			{
				question: "Does Thorbis support multi-phase commercial electrical projects?",
				answer:
			...
			{
				question: "How does Thorbis enforce safety compliance for electricians?",
				answer:
			...
			{
				question: "How does Thorbis compare to ServiceTitan for electrical contractors?",
				answer:
	...
	},
	{
		...
		seo: {
			title: "Landscaping Business Software & Scheduling | #1 for Lawn Care | Thorbis",
			description:
		...
		fieldTypes: ["Residential Maintenance", "Commercial Grounds", "Design/Build", "Snow & Ice"],
		painPoints: [
	...
	},
	{
		...
		heroEyebrow: "Route Management • Chemical Logs • Retail Sales • Equipment Upgrades",
		...
		seo: {
			title: "Pool Service Software & Route Management | #1 for Pool Companies | Thorbis",
			description:
		...
		faq: [
			{
				question: "Does Thorbis handle chemical compliance reports for commercial pools?",
				answer:
			...
			{
				question: "Can pool technicians work offline in areas with poor cell coverage?",
				answer:
			...
			{
				question: "How does Thorbis compare to other pool service software like Skimmer or LMN?",
				answer:
	...
	},
	{
		...
		heroEyebrow: "Route Optimization • Chemical Compliance • Renewals • Inspections",
		...
		seo: {
			title: "Pest Control Software & Route Optimization | #1 for Exterminators | Thorbis",
			description:
		...
		faq: [
			...
			{
				question: "Can I handle different service frequencies for different customers?",
				answer:
	...
	},
	{
		...
		heroEyebrow: "Warranty Claims • Parts Logistics • First-Time Fix • Customer Experience",
		...
		seo: {
			title: "Appliance Repair Software & Warranty Management | #1 for Service Companies | Thorbis",
			description:
		...
		faq: [
			{
				question: "Does Thorbis integrate with parts distributors and suppliers?",
				answer:
			...
			{
				question: "How do you handle warranty claims for different manufacturers?",
				answer:
			...
			{
				question: "How are customers kept informed throughout the repair process?",
				answer:
			...
			{
				question: "Can dispatchers see technician truck inventory in real-time?",
				answer:
			...
			{
				question: "How does Thorbis compare to ServiceTitan or FieldEdge for appliance repair?",
				answer:
	...
	},
	{
		...
		seo: {
			title: "Roofing Software & Insurance Claims Management | #1 for Roofers | Thorbis",
			description:
		...
		faq: [
			{
				question: "Does Thorbis integrate with EagleView and Hover for measurements?",
				answer:
			...
			{
				question: "Does Thorbis support both insurance and retail roofing jobs?",
				answer:
			...
			{
				question: "How does material ordering integrate with production scheduling?",
				answer:
			...
			{
				question: "How does Thorbis compare to AccuLynx or JobNimbus for roofing?",
				answer:
	...
	},
	{
		...
		heroEyebrow: "Recurring Scheduling • Quality Control • Client Portals • Time Tracking",
		heroTitle: "The #1 Cleaning & Janitorial Software for Commercial Operations",
		heroDescription:
		...
		seo: {
			title: "Cleaning & Janitorial Software | #1 for Commercial Cleaning | Thorbis",
			description:
	...
	},
	{
		...
		heroEyebrow: "Emergency Dispatch • Access Control • Automotive • Security Documentation",
		...
		seo: {
			title: "Locksmith Software & Emergency Dispatch | #1 for Lock Services | Thorbis",
			description:
		...
		faq: [
			...
			{
				question: "Can I track technician inventory (key blanks, programming tools)?",
				answer:
	...
	},
	{
		...
		heroEyebrow: "Emergency Repair • Installations • Openers • Maintenance Plans",
		...
		seo: {
			title: "Garage Door Software & Service Management | #1 for Door Companies | Thorbis",
			description:
		...
		faq: [
			{
				question: "Does Thorbis integrate with door suppliers and distributors?",
				answer:

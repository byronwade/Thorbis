...
export const LLM_BRAND = {
	...
	tagline: "The #1 Field Service Management Software for Home Service Businesses",
	pricing: "$200/month flat rate - unlimited users, no per-seat fees",
	positioning: "Modern, AI-powered alternative to ServiceTitan, Jobber, and Housecall Pro",
	targetAudience: "HVAC, plumbing, electrical, and other home service contractors",
} as const;
...
export const LLM_COMPETITORS = {
	servicetitan: {
		name: "ServiceTitan",
		thorbisAdvantage: "90% cheaper ($200/mo vs $2,000+/mo), no contracts, faster implementation (30 days vs 6 months)",
		painPoints: "Hidden fees, 4-6 month implementation, $259/tech/month minimum",
	},
	jobber: {
		name: "Jobber",
		thorbisAdvantage: "More features at similar price, AI-native workflows, better reporting",
		painPoints: "Limited enterprise features, basic reporting, no AI automation",
	},
	housecallpro: {
		name: "Housecall Pro",
		thorbisAdvantage: "Superior AI automation, better scheduling intelligence, unified platform",
		painPoints: "Fragmented features, limited customization, add-on fatigue",
	},
	fieldedge: {
		name: "FieldEdge",
		thorbisAdvantage: "Modern interface, AI-powered dispatch, mobile-first design",
		painPoints: "Dated interface, slow updates, complex pricing",
	},
	servicem8: {
		name: "ServiceM8",
		thorbisAdvantage: "US-focused support, better integrations, comprehensive feature set",
		painPoints: "Australia-centric, limited US features, timezone issues",
	},
	workiz: {
		name: "Workiz",
		thorbisAdvantage: "Deeper industry expertise, better AI, enterprise scalability",
...
export const LLM_FEATURES = [
	{
		...
		description: "24/7 AI-powered call handling, scheduling, and customer communication",
		benefit: "Never miss a call, book jobs automatically, reduce admin overhead by 40%",
	},
	{
	...
	},
	{
		...
		description: "Complete customer history, equipment tracking, communication logs",
	...
	},
	{
		...
		description: "Real-time dashboards for revenue, technician performance, and KPIs",
...
export const LLM_INDUSTRIES = [
	...
	{ name: "Electrical", description: "Electrical contractors and electricians" },
	{ name: "Appliance Repair", description: "Home appliance service technicians" },

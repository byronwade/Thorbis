...
export type ServiceType = "emergency" | "routine" | "preventive" | "warranty" | "installation";
 ...
 */
function extractCategories(title: string, notes?: string | null): JobCategory[] {
...
export function autoTagJob(job: {
	...
	const generatedTitle = generateTitle(job.customerName, job.notes, job.jobType);

      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableHeader}>
            ...
            <Text style={[styles.tableHeaderCell, styles.colQty, styles.tableCellRight]}>
              Qty
            </Text>
          ...
          {lineItems.map((item: any, index: number) => (
            <View key={index} style={styles.tableRow}>
              ...
              <Text
                style={[styles.tableCell, styles.colAmount, styles.tableCellRight, styles.tableCellBold]}
              >

...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://togejqdwggezkxahomeh.supabase.co';
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRvZ2VqcWR3Z2dlemt4YWhvbWVoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MTcyMDI5NSwiZXhwIjoyMDc3Mjk2Mjk1fQ.AYOqqzsx3hqzfVa9knQtW6fVnH1K7z-YlmYyBKLCO7E';
